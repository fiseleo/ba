...
public struct InformationStrategyObjectExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.InformationStrategyObjectExcel> CreateInformationStrategyObjectExcel(FlatBufferBuilder builder,
      long Id = 0,
      long StageId = 0,
  ...
  public static Offset<FlatData.InformationStrategyObjectExcel> EndInformationStrategyObjectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.InformationStrategyObjectExcel>(o);
  }
  ...
  public void UnPackTo(InformationStrategyObjectExcelT _o) {
    ...
    _o.PageName = this.PageName;
    _o.LocalizeCodeId = this.LocalizeCodeId;
  }
  public static Offset<FlatData.InformationStrategyObjectExcel> Pack(FlatBufferBuilder builder, InformationStrategyObjectExcelT _o) {
    if (_o == null) return default(Offset<FlatData.InformationStrategyObjectExcel>);
