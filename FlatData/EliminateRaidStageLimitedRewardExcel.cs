...
public struct EliminateRaidStageLimitedRewardExcel : IFlatbufferObject
{
  ...
  public FlatData.ParcelType LimitedRewardParcelType(int j) { int o = __p.__offset(6); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatData.ParcelType)0; }
  public int LimitedRewardParcelTypeLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatData.ParcelType> GetLimitedRewardParcelTypeBytes() { return __p.__vector_as_span<FlatData.ParcelType>(6, 4); }
#else
  public ArraySegment<byte>? GetLimitedRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public FlatData.ParcelType[] GetLimitedRewardParcelTypeArray() { int o = __p.__offset(6); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatData.ParcelType[] a = new FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<FlatData.EliminateRaidStageLimitedRewardExcel> CreateEliminateRaidStageLimitedRewardExcel(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateLimitedRewardParcelTypeVector(FlatBufferBuilder builder, FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateLimitedRewardParcelTypeVectorBlock(FlatBufferBuilder builder, FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateLimitedRewardParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatData.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateLimitedRewardParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatData.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<FlatData.EliminateRaidStageLimitedRewardExcel> EndEliminateRaidStageLimitedRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EliminateRaidStageLimitedRewardExcel>(o);
  }
  ...
  public void UnPackTo(EliminateRaidStageLimitedRewardExcelT _o) {
    _o.LimitedRewardId = this.LimitedRewardId;
    _o.LimitedRewardParcelType = new List<FlatData.ParcelType>();
    for (var _j = 0; _j < this.LimitedRewardParcelTypeLength; ++_j) {_o.LimitedRewardParcelType.Add(this.LimitedRewardParcelType(_j));}
    _o.LimitedRewardParcelUniqueId = new List<long>();
    for (var _j = 0; _j < this.LimitedRewardParcelUniqueIdLength; ++_j) {_o.LimitedRewardParcelUniqueId.Add(this.LimitedRewardParcelUniqueId(_j));}
    _o.LimitedRewardAmount = new List<long>();
    for (var _j = 0; _j < this.LimitedRewardAmountLength; ++_j) {_o.LimitedRewardAmount.Add(this.LimitedRewardAmount(_j));}
  }
  public static Offset<FlatData.EliminateRaidStageLimitedRewardExcel> Pack(FlatBufferBuilder builder, EliminateRaidStageLimitedRewardExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EliminateRaidStageLimitedRewardExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("LimitedRewardId")]
  public long LimitedRewardId { get; set; }
  [Newtonsoft.Json.JsonProperty("LimitedRewardParcelType")]
  public List<FlatData.ParcelType> LimitedRewardParcelType { get; set; }
  [Newtonsoft.Json.JsonProperty("LimitedRewardParcelUniqueId")]
  public List<long> LimitedRewardParcelUniqueId { get; set; }
  [Newtonsoft.Json.JsonProperty("LimitedRewardAmount")]
...
static public class EliminateRaidStageLimitedRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 6 /*LimitedRewardParcelType*/, 4 /*FlatData.ParcelType*/, false)
