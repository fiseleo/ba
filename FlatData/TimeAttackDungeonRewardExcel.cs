...
public struct TimeAttackDungeonRewardExcel : IFlatbufferObject
{
  ...
  public FlatData.TimeAttackDungeonRewardType RewardType(int j) { int o = __p.__offset(8); return o != 0 ? (FlatData.TimeAttackDungeonRewardType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatData.TimeAttackDungeonRewardType)0; }
  public int RewardTypeLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatData.TimeAttackDungeonRewardType> GetRewardTypeBytes() { return __p.__vector_as_span<FlatData.TimeAttackDungeonRewardType>(8, 4); }
#else
  public ArraySegment<byte>? GetRewardTypeBytes() { return __p.__vector_as_arraysegment(8); }
#endif
  public FlatData.TimeAttackDungeonRewardType[] GetRewardTypeArray() { int o = __p.__offset(8); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatData.TimeAttackDungeonRewardType[] a = new FlatData.TimeAttackDungeonRewardType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatData.TimeAttackDungeonRewardType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<FlatData.TimeAttackDungeonRewardExcel> CreateTimeAttackDungeonRewardExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static VectorOffset CreateRewardTypeVector(FlatBufferBuilder builder, FlatData.TimeAttackDungeonRewardType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateRewardTypeVectorBlock(FlatBufferBuilder builder, FlatData.TimeAttackDungeonRewardType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRewardTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatData.TimeAttackDungeonRewardType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRewardTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatData.TimeAttackDungeonRewardType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<FlatData.TimeAttackDungeonRewardExcel> EndTimeAttackDungeonRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.TimeAttackDungeonRewardExcel>(o);
  }
  ...
  public void UnPackTo(TimeAttackDungeonRewardExcelT _o) {
    _o.Id = this.Id;
    _o.RewardMaxPoint = this.RewardMaxPoint;
    _o.RewardType = new List<FlatData.TimeAttackDungeonRewardType>();
    for (var _j = 0; _j < this.RewardTypeLength; ++_j) {_o.RewardType.Add(this.RewardType(_j));}
    _o.RewardMinPoint = new List<long>();
    for (var _j = 0; _j < this.RewardMinPointLength; ++_j) {_o.RewardMinPoint.Add(this.RewardMinPoint(_j));}
    ...
    for (var _j = 0; _j < this.RewardParcelDefaultAmountLength; ++_j) {_o.RewardParcelDefaultAmount.Add(this.RewardParcelDefaultAmount(_j));}
    _o.RewardParcelMaxAmount = new List<long>();
    for (var _j = 0; _j < this.RewardParcelMaxAmountLength; ++_j) {_o.RewardParcelMaxAmount.Add(this.RewardParcelMaxAmount(_j));}
  }
  public static Offset<FlatData.TimeAttackDungeonRewardExcel> Pack(FlatBufferBuilder builder, TimeAttackDungeonRewardExcelT _o) {
    if (_o == null) return default(Offset<FlatData.TimeAttackDungeonRewardExcel>);
...
public class TimeAttackDungeonRewardExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("RewardMaxPoint")]
  public long RewardMaxPoint { get; set; }
  [Newtonsoft.Json.JsonProperty("RewardType")]
  public List<FlatData.TimeAttackDungeonRewardType> RewardType { get; set; }
  [Newtonsoft.Json.JsonProperty("RewardMinPoint")]
  ...
  [Newtonsoft.Json.JsonProperty("RewardParcelDefaultAmount")]
  public List<long> RewardParcelDefaultAmount { get; set; }
  [Newtonsoft.Json.JsonProperty("RewardParcelMaxAmount")]
...
static public class TimeAttackDungeonRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 8 /*RewardType*/, 4 /*FlatData.TimeAttackDungeonRewardType*/, false)
