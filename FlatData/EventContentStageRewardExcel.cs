...
public struct EventContentStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.EventContentStageRewardExcel> CreateEventContentStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<FlatData.EventContentStageRewardExcel> EndEventContentStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentStageRewardExcel>(o);
  }
  ...
  public static Offset<FlatData.EventContentStageRewardExcel> Pack(FlatBufferBuilder builder, EventContentStageRewardExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EventContentStageRewardExcel>);
