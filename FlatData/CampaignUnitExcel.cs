...
public struct CampaignUnitExcel : IFlatbufferObject
{
  ...
  public FlatData.StrategyAIType AIMoveType { get { int o = __p.__offset(22); return o != 0 ? (FlatData.StrategyAIType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.StrategyAIType.None; } }
  public FlatData.HexaUnitGrade Grade { get { int o = __p.__offset(24); return o != 0 ? (FlatData.HexaUnitGrade)__p.bb.GetInt(o + __p.bb_pos) : FlatData.HexaUnitGrade.Grade1; } }
  public FlatData.TacticEnvironment EnvironmentType { get { int o = __p.__offset(26); return o != 0 ? (FlatData.TacticEnvironment)__p.bb.GetInt(o + __p.bb_pos) : FlatData.TacticEnvironment.None; } }
  ...
  public static Offset<FlatData.CampaignUnitExcel> CreateCampaignUnitExcel(FlatBufferBuilder builder,
      long Id = 0,
      uint Key = 0,
      ...
      long GroundId = 0,
      int MoveRange = 0,
      FlatData.StrategyAIType AIMoveType = FlatData.StrategyAIType.None,
      FlatData.HexaUnitGrade Grade = FlatData.HexaUnitGrade.Grade1,
      FlatData.TacticEnvironment EnvironmentType = FlatData.TacticEnvironment.None,
      float Scale = 0.0f,
  ...
  public static void AddAIMoveType(FlatBufferBuilder builder, FlatData.StrategyAIType aIMoveType) { builder.AddInt(9, (int)aIMoveType, 0); }
  public static void AddGrade(FlatBufferBuilder builder, FlatData.HexaUnitGrade grade) { builder.AddInt(10, (int)grade, 0); }
  public static void AddEnvironmentType(FlatBufferBuilder builder, FlatData.TacticEnvironment environmentType) { builder.AddInt(11, (int)environmentType, 0); }
  ...
  public static Offset<FlatData.CampaignUnitExcel> EndCampaignUnitExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.CampaignUnitExcel>(o);
  }
  ...
  public void UnPackTo(CampaignUnitExcelT _o) {
    ...
    _o.MoveRange = this.MoveRange;
    _o.AIMoveType = this.AIMoveType;
    _o.Grade = this.Grade;
    _o.EnvironmentType = this.EnvironmentType;
    _o.Scale = this.Scale;
    _o.IsTacticSkip = this.IsTacticSkip;
  }
  public static Offset<FlatData.CampaignUnitExcel> Pack(FlatBufferBuilder builder, CampaignUnitExcelT _o) {
    if (_o == null) return default(Offset<FlatData.CampaignUnitExcel>);
...
public class CampaignUnitExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("MoveRange")]
  public int MoveRange { get; set; }
  [Newtonsoft.Json.JsonProperty("AIMoveType")]
  public FlatData.StrategyAIType AIMoveType { get; set; }
  [Newtonsoft.Json.JsonProperty("Grade")]
  public FlatData.HexaUnitGrade Grade { get; set; }
  [Newtonsoft.Json.JsonProperty("EnvironmentType")]
  public FlatData.TacticEnvironment EnvironmentType { get; set; }
  ...
  public CampaignUnitExcelT() {
    ...
    this.GroundId = 0;
    this.MoveRange = 0;
    this.AIMoveType = FlatData.StrategyAIType.None;
    this.Grade = FlatData.HexaUnitGrade.Grade1;
    this.EnvironmentType = FlatData.TacticEnvironment.None;
    this.Scale = 0.0f;
...
static public class CampaignUnitExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*AIMoveType*/, 4 /*FlatData.StrategyAIType*/, 4, false)
      && verifier.VerifyField(tablePos, 24 /*Grade*/, 4 /*FlatData.HexaUnitGrade*/, 4, false)
      && verifier.VerifyField(tablePos, 26 /*EnvironmentType*/, 4 /*FlatData.TacticEnvironment*/, 4, false)
