...
public struct TacticSimulatorSettingExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(TacticSimulatorSettingExcelT _o) {
    ...
    _o.GetExp = this.GetExp;
    _o.GetStarGrade = this.GetStarGrade;
    _o.Equipment = this.Equipment;
  }
  public static Offset<FlatData.TacticSimulatorSettingExcel> Pack(FlatBufferBuilder builder, TacticSimulatorSettingExcelT _o) {
    if (_o == null) return default(Offset<FlatData.TacticSimulatorSettingExcel>);
...
public class TacticSimulatorSettingExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("GetExp")]
  public long GetExp { get; set; }
  [Newtonsoft.Json.JsonProperty("GetStarGrade")]
