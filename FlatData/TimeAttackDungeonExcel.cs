...
public struct TimeAttackDungeonExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.TimeAttackDungeonExcel> CreateTimeAttackDungeonExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatData.TimeAttackDungeonExcel> EndTimeAttackDungeonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.TimeAttackDungeonExcel>(o);
  }
  ...
  public static Offset<FlatData.TimeAttackDungeonExcel> Pack(FlatBufferBuilder builder, TimeAttackDungeonExcelT _o) {
    if (_o == null) return default(Offset<FlatData.TimeAttackDungeonExcel>);
