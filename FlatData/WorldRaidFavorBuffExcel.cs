...
public struct WorldRaidFavorBuffExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.WorldRaidFavorBuffExcel> CreateWorldRaidFavorBuffExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.WorldRaidFavorBuffExcel> EndWorldRaidFavorBuffExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.WorldRaidFavorBuffExcel>(o);
  }
  ...
  public void UnPackTo(WorldRaidFavorBuffExcelT _o) {
    _o.WorldRaidFavorRank = this.WorldRaidFavorRank;
    _o.WorldRaidFavorRankBonus = this.WorldRaidFavorRankBonus;
  }
  public static Offset<FlatData.WorldRaidFavorBuffExcel> Pack(FlatBufferBuilder builder, WorldRaidFavorBuffExcelT _o) {
    if (_o == null) return default(Offset<FlatData.WorldRaidFavorBuffExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("WorldRaidFavorRank")]
  public long WorldRaidFavorRank { get; set; }
  [Newtonsoft.Json.JsonProperty("WorldRaidFavorRankBonus")]
