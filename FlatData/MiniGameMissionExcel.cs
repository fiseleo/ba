...
public struct MiniGameMissionExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.MiniGameMissionExcel> Pack(FlatBufferBuilder builder, MiniGameMissionExcelT _o) {
    if (_o == null) return default(Offset<FlatData.MiniGameMissionExcel>);
