...
public struct OpenConditionExcel : IFlatbufferObject
{
  ...
  public FlatData.OpenConditionContent OpenConditionContentType { get { int o = __p.__offset(4); return o != 0 ? (FlatData.OpenConditionContent)__p.bb.GetInt(o + __p.bb_pos) : FlatData.OpenConditionContent.Shop; } }
  ...
  public FlatData.MultipleConditionCheckType MultipleConditionCheckType { get { int o = __p.__offset(24); return o != 0 ? (FlatData.MultipleConditionCheckType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.MultipleConditionCheckType.And; } }
  public FlatData.WeekDay OpenDayOfWeek { get { int o = __p.__offset(26); return o != 0 ? (FlatData.WeekDay)__p.bb.GetInt(o + __p.bb_pos) : FlatData.WeekDay.Sunday; } }
  public long OpenHour { get { int o = __p.__offset(28); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public FlatData.WeekDay CloseDayOfWeek { get { int o = __p.__offset(30); return o != 0 ? (FlatData.WeekDay)__p.bb.GetInt(o + __p.bb_pos) : FlatData.WeekDay.Sunday; } }
  ...
  public static Offset<FlatData.OpenConditionExcel> CreateOpenConditionExcel(FlatBufferBuilder builder,
      FlatData.OpenConditionContent OpenConditionContentType = FlatData.OpenConditionContent.Shop,
      ...
      FlatData.WeekDay OpenDayOfWeek = FlatData.WeekDay.Sunday,
      long OpenHour = 0,
      FlatData.WeekDay CloseDayOfWeek = FlatData.WeekDay.Sunday,
      long CloseHour = 0,
      long OpenedCafeId = 0,
  ...
  public static void AddOpenConditionContentType(FlatBufferBuilder builder, FlatData.OpenConditionContent openConditionContentType) { builder.AddInt(0, (int)openConditionContentType, 0); }
  ...
  public static void AddMultipleConditionCheckType(FlatBufferBuilder builder, FlatData.MultipleConditionCheckType multipleConditionCheckType) { builder.AddInt(10, (int)multipleConditionCheckType, 0); }
  public static void AddOpenDayOfWeek(FlatBufferBuilder builder, FlatData.WeekDay openDayOfWeek) { builder.AddInt(11, (int)openDayOfWeek, 0); }
  public static void AddOpenHour(FlatBufferBuilder builder, long openHour) { builder.AddLong(12, openHour, 0); }
  public static void AddCloseDayOfWeek(FlatBufferBuilder builder, FlatData.WeekDay closeDayOfWeek) { builder.AddInt(13, (int)closeDayOfWeek, 0); }
  ...
  public static Offset<FlatData.OpenConditionExcel> EndOpenConditionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.OpenConditionExcel>(o);
  }
  ...
  public void UnPackTo(OpenConditionExcelT _o) {
    ...
    for (var _j = 0; _j < this.LockUILength; ++_j) {_o.LockUI.Add(this.LockUI(_j));}
    _o.ShortcutPopupPriority = this.ShortcutPopupPriority;
    _o.ShortcutUIName = new List<string>();
    for (var _j = 0; _j < this.ShortcutUINameLength; ++_j) {_o.ShortcutUIName.Add(this.ShortcutUIName(_j));}
    _o.ShortcutParam = this.ShortcutParam;
    _o.Scene = this.Scene;
    _o.HideWhenLocked = this.HideWhenLocked;
    _o.AccountLevel = this.AccountLevel;
    _o.ScenarioModeId = this.ScenarioModeId;
    _o.CampaignStageId = this.CampaignStageId;
    _o.MultipleConditionCheckType = this.MultipleConditionCheckType;
    _o.OpenDayOfWeek = this.OpenDayOfWeek;
    _o.OpenHour = this.OpenHour;
    _o.CloseDayOfWeek = this.CloseDayOfWeek;
    _o.CloseHour = this.CloseHour;
    _o.OpenedCafeId = this.OpenedCafeId;
    _o.CafeIdforCafeRank = this.CafeIdforCafeRank;
    _o.CafeRank = this.CafeRank;
    _o.ContentsOpenShow = this.ContentsOpenShow;
    _o.ContentsOpenShortcutUI = this.ContentsOpenShortcutUI;
  }
  public static Offset<FlatData.OpenConditionExcel> Pack(FlatBufferBuilder builder, OpenConditionExcelT _o) {
    if (_o == null) return default(Offset<FlatData.OpenConditionExcel>);
...
public class OpenConditionExcelT
{
  ...
  public FlatData.OpenConditionContent OpenConditionContentType { get; set; }
  [Newtonsoft.Json.JsonProperty("LockUI")]
  public List<string> LockUI { get; set; }
  [Newtonsoft.Json.JsonProperty("ShortcutPopupPriority")]
  public long ShortcutPopupPriority { get; set; }
  [Newtonsoft.Json.JsonProperty("ShortcutUIName")]
  public List<string> ShortcutUIName { get; set; }
  [Newtonsoft.Json.JsonProperty("ShortcutParam")]
  public int ShortcutParam { get; set; }
  [Newtonsoft.Json.JsonProperty("Scene")]
  public string Scene { get; set; }
  [Newtonsoft.Json.JsonProperty("HideWhenLocked")]
  public bool HideWhenLocked { get; set; }
  [Newtonsoft.Json.JsonProperty("AccountLevel")]
  public long AccountLevel { get; set; }
  [Newtonsoft.Json.JsonProperty("ScenarioModeId")]
  public long ScenarioModeId { get; set; }
  [Newtonsoft.Json.JsonProperty("CampaignStageId")]
  ...
  [Newtonsoft.Json.JsonProperty("OpenDayOfWeek")]
  public FlatData.WeekDay OpenDayOfWeek { get; set; }
  [Newtonsoft.Json.JsonProperty("OpenHour")]
  public long OpenHour { get; set; }
  [Newtonsoft.Json.JsonProperty("CloseDayOfWeek")]
  public FlatData.WeekDay CloseDayOfWeek { get; set; }
  [Newtonsoft.Json.JsonProperty("CloseHour")]
  public long CloseHour { get; set; }
  [Newtonsoft.Json.JsonProperty("OpenedCafeId")]
  public long OpenedCafeId { get; set; }
  [Newtonsoft.Json.JsonProperty("CafeIdforCafeRank")]
  public long CafeIdforCafeRank { get; set; }
  [Newtonsoft.Json.JsonProperty("CafeRank")]
  public long CafeRank { get; set; }
  [Newtonsoft.Json.JsonProperty("ContentsOpenShow")]
  public bool ContentsOpenShow { get; set; }
  [Newtonsoft.Json.JsonProperty("ContentsOpenShortcutUI")]
  public string ContentsOpenShortcutUI { get; set; }

  public OpenConditionExcelT() {
    this.OpenConditionContentType = FlatData.OpenConditionContent.Shop;
    this.LockUI = null;
    ...
    this.OpenDayOfWeek = FlatData.WeekDay.Sunday;
    this.OpenHour = 0;
    this.CloseDayOfWeek = FlatData.WeekDay.Sunday;
    this.CloseHour = 0;
    this.OpenedCafeId = 0;
...
static public class OpenConditionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*OpenConditionContentType*/, 4 /*FlatData.OpenConditionContent*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 24 /*MultipleConditionCheckType*/, 4 /*FlatData.MultipleConditionCheckType*/, 4, false)
      && verifier.VerifyField(tablePos, 26 /*OpenDayOfWeek*/, 4 /*FlatData.WeekDay*/, 4, false)
      && verifier.VerifyField(tablePos, 28 /*OpenHour*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 30 /*CloseDayOfWeek*/, 4 /*FlatData.WeekDay*/, 4, false)
