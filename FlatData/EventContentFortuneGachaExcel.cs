...
public struct EventContentFortuneGachaExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.EventContentFortuneGachaExcel> CreateEventContentFortuneGachaExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.EventContentFortuneGachaExcel> EndEventContentFortuneGachaExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentFortuneGachaExcel>(o);
  }
  ...
  public static Offset<FlatData.EventContentFortuneGachaExcel> Pack(FlatBufferBuilder builder, EventContentFortuneGachaExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EventContentFortuneGachaExcel>);
