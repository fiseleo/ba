...
public struct WorldRaidStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.WorldRaidStageRewardExcel> CreateWorldRaidStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<FlatData.WorldRaidStageRewardExcel> EndWorldRaidStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.WorldRaidStageRewardExcel>(o);
  }
  ...
  public static Offset<FlatData.WorldRaidStageRewardExcel> Pack(FlatBufferBuilder builder, WorldRaidStageRewardExcelT _o) {
    if (_o == null) return default(Offset<FlatData.WorldRaidStageRewardExcel>);
