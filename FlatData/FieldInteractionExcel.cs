...
public struct FieldInteractionExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(FieldInteractionExcelT _o) {
    ...
    _o.ShowEmoji = this.ShowEmoji;
    _o.KeywordLocalize = this.KeywordLocalize;
    _o.FieldSeasonId = this.FieldSeasonId;
    _o.InteractionType = new List<FlatData.FieldInteractionType>();
    for (var _j = 0; _j < this.InteractionTypeLength; ++_j) {_o.InteractionType.Add(this.InteractionType(_j));}
    _o.InteractionId = new List<long>();
    for (var _j = 0; _j < this.InteractionIdLength; ++_j) {_o.InteractionId.Add(this.InteractionId(_j));}
    _o.ConditionClass = this.ConditionClass;
    _o.ConditionClassParameters = new List<long>();
    for (var _j = 0; _j < this.ConditionClassParametersLength; ++_j) {_o.ConditionClassParameters.Add(this.ConditionClassParameters(_j));}
    _o.OnceOnly = this.OnceOnly;
    _o.ConditionIndex = new List<long>();
    for (var _j = 0; _j < this.ConditionIndexLength; ++_j) {_o.ConditionIndex.Add(this.ConditionIndex(_j));}
    ...
    for (var _j = 0; _j < this.NegateConditionLength; ++_j) {_o.NegateCondition.Add(this.NegateCondition(_j));}
  }
  public static Offset<FlatData.FieldInteractionExcel> Pack(FlatBufferBuilder builder, FieldInteractionExcelT _o) {
    if (_o == null) return default(Offset<FlatData.FieldInteractionExcel>);
...
public class FieldInteractionExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("ShowEmoji")]
  public bool ShowEmoji { get; set; }
  [Newtonsoft.Json.JsonProperty("KeywordLocalize")]
  public string KeywordLocalize { get; set; }
  [Newtonsoft.Json.JsonProperty("FieldSeasonId")]
  public long FieldSeasonId { get; set; }
  [Newtonsoft.Json.JsonProperty("InteractionType")]
  public List<FlatData.FieldInteractionType> InteractionType { get; set; }
  [Newtonsoft.Json.JsonProperty("InteractionId")]
  public List<long> InteractionId { get; set; }
  [Newtonsoft.Json.JsonProperty("ConditionClass")]
  public FlatData.FieldConditionClass ConditionClass { get; set; }
  [Newtonsoft.Json.JsonProperty("ConditionClassParameters")]
  public List<long> ConditionClassParameters { get; set; }
  [Newtonsoft.Json.JsonProperty("OnceOnly")]
  public bool OnceOnly { get; set; }
  [Newtonsoft.Json.JsonProperty("ConditionIndex")]
  ...
  [Newtonsoft.Json.JsonProperty("NegateCondition")]
  ...
  public FieldInteractionExcelT() {
    ...
    this.ConditionClass = FlatData.FieldConditionClass.AndOr;
