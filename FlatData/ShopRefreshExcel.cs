...
public struct ShopRefreshExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ShopRefreshExcelT _o) {
    ...
    _o.IsBundle = this.IsBundle;
    _o.VisibleAmount = this.VisibleAmount;
  ...
  public static Offset<FlatData.ShopRefreshExcel> Pack(FlatBufferBuilder builder, ShopRefreshExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ShopRefreshExcel>);
...
public class ShopRefreshExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("IsBundle")]
  public bool IsBundle { get; set; }
  [Newtonsoft.Json.JsonProperty("VisibleAmount")]
