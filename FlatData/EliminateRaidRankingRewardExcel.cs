...
public struct EliminateRaidRankingRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.EliminateRaidRankingRewardExcel> Pack(FlatBufferBuilder builder, EliminateRaidRankingRewardExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EliminateRaidRankingRewardExcel>);
