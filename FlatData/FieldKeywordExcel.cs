...
public struct FieldKeywordExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.FieldKeywordExcel> CreateFieldKeywordExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<FlatData.FieldKeywordExcel> EndFieldKeywordExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.FieldKeywordExcel>(o);
  }
  ...
  public void UnPackTo(FieldKeywordExcelT _o) {
    ...
    _o.NameLocalizeKey = this.NameLocalizeKey;
    _o.DescriptionLocalizeKey = this.DescriptionLocalizeKey;
    _o.ImagePath = this.ImagePath;
  }
  public static Offset<FlatData.FieldKeywordExcel> Pack(FlatBufferBuilder builder, FieldKeywordExcelT _o) {
    if (_o == null) return default(Offset<FlatData.FieldKeywordExcel>);
...
public class FieldKeywordExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("NameLocalizeKey")]
  public string NameLocalizeKey { get; set; }
  [Newtonsoft.Json.JsonProperty("DescriptionLocalizeKey")]
