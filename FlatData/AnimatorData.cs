...
public struct AnimatorData : IFlatbufferObject
{
  ...
  public FlatData.AniStateData? DataList(int j) { int o = __p.__offset(8); return o != 0 ? (FlatData.AniStateData?)(new FlatData.AniStateData()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int DataListLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<FlatData.AnimatorData> CreateAnimatorData(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateDataListVector(FlatBufferBuilder builder, Offset<FlatData.AniStateData>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateDataListVectorBlock(FlatBufferBuilder builder, Offset<FlatData.AniStateData>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateDataListVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<FlatData.AniStateData>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateDataListVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<FlatData.AniStateData>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartDataListVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<FlatData.AnimatorData> EndAnimatorData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.AnimatorData>(o);
  }
  ...
  public void UnPackTo(AnimatorDataT _o) {
    _o.DefaultStateName = this.DefaultStateName;
    _o.Name = this.Name;
    _o.DataList = new List<FlatData.AniStateDataT>();
    for (var _j = 0; _j < this.DataListLength; ++_j) {_o.DataList.Add(this.DataList(_j).HasValue ? this.DataList(_j).Value.UnPack() : null);}
  }
  public static Offset<FlatData.AnimatorData> Pack(FlatBufferBuilder builder, AnimatorDataT _o) {
    if (_o == null) return default(Offset<FlatData.AnimatorData>);
    ...
    if (_o.DataList != null) {
      var __DataList = new Offset<FlatData.AniStateData>[_o.DataList.Count];
      for (var _j = 0; _j < __DataList.Length; ++_j) { __DataList[_j] = FlatData.AniStateData.Pack(builder, _o.DataList[_j]); }
...
{
  [Newtonsoft.Json.JsonProperty("DefaultStateName")]
  public string DefaultStateName { get; set; }
  [Newtonsoft.Json.JsonProperty("Name")]
  public string Name { get; set; }
  [Newtonsoft.Json.JsonProperty("DataList")]
  public List<FlatData.AniStateDataT> DataList { get; set; }
...
static public class AnimatorDataVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfTables(tablePos, 8 /*DataList*/, FlatData.AniStateDataVerify.Verify, false)
