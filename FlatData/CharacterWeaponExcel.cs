...
public struct CharacterWeaponExcel : IFlatbufferObject
{
  ...
  public FlatData.StatLevelUpType StatLevelUpType { get { int o = __p.__offset(10); return o != 0 ? (FlatData.StatLevelUpType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.StatLevelUpType.Standard; } }
  ...
  public FlatData.EquipmentOptionType StatType(int j) { int o = __p.__offset(32); return o != 0 ? (FlatData.EquipmentOptionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatData.EquipmentOptionType)0; }
  public int StatTypeLength { get { int o = __p.__offset(32); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatData.EquipmentOptionType> GetStatTypeBytes() { return __p.__vector_as_span<FlatData.EquipmentOptionType>(32, 4); }
#else
  public ArraySegment<byte>? GetStatTypeBytes() { return __p.__vector_as_arraysegment(32); }
#endif
  public FlatData.EquipmentOptionType[] GetStatTypeArray() { int o = __p.__offset(32); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatData.EquipmentOptionType[] a = new FlatData.EquipmentOptionType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatData.EquipmentOptionType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<FlatData.CharacterWeaponExcel> CreateCharacterWeaponExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddStatLevelUpType(FlatBufferBuilder builder, FlatData.StatLevelUpType statLevelUpType) { builder.AddInt(3, (int)statLevelUpType, 0); }
  ...
  public static Offset<FlatData.CharacterWeaponExcel> EndCharacterWeaponExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.CharacterWeaponExcel>(o);
  }
  ...
  public void UnPackTo(CharacterWeaponExcelT _o) {
    ...
    _o.HealPower = this.HealPower;
    _o.HealPower100 = this.HealPower100;
    _o.Unlock = new List<bool>();
    for (var _j = 0; _j < this.UnlockLength; ++_j) {_o.Unlock.Add(this.Unlock(_j));}
    _o.RecipeId = new List<long>();
    for (var _j = 0; _j < this.RecipeIdLength; ++_j) {_o.RecipeId.Add(this.RecipeId(_j));}
    _o.MaxLevel = new List<int>();
    for (var _j = 0; _j < this.MaxLevelLength; ++_j) {_o.MaxLevel.Add(this.MaxLevel(_j));}
    _o.LearnSkillSlot = new List<string>();
    for (var _j = 0; _j < this.LearnSkillSlotLength; ++_j) {_o.LearnSkillSlot.Add(this.LearnSkillSlot(_j));}
    ...
    for (var _j = 0; _j < this.StatValueLength; ++_j) {_o.StatValue.Add(this.StatValue(_j));}
  }
  public static Offset<FlatData.CharacterWeaponExcel> Pack(FlatBufferBuilder builder, CharacterWeaponExcelT _o) {
    if (_o == null) return default(Offset<FlatData.CharacterWeaponExcel>);
...
public class CharacterWeaponExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("SetRecipe")]
  ...
  [Newtonsoft.Json.JsonProperty("HealPower")]
  ...
  [Newtonsoft.Json.JsonProperty("StatValue")]
...
static public class CharacterWeaponExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*StatLevelUpType*/, 4 /*FlatData.StatLevelUpType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 32 /*StatType*/, 4 /*FlatData.EquipmentOptionType*/, false)
