...
public struct EquipmentLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.EquipmentLevelExcel> CreateEquipmentLevelExcel(FlatBufferBuilder builder,
      int Level = 0,
  ...
  public static Offset<FlatData.EquipmentLevelExcel> EndEquipmentLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EquipmentLevelExcel>(o);
  }
  ...
  public static Offset<FlatData.EquipmentLevelExcel> Pack(FlatBufferBuilder builder, EquipmentLevelExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EquipmentLevelExcel>);
