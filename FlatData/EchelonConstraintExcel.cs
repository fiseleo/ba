...
public struct EchelonConstraintExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EchelonConstraintExcelT _o) {
    ...
    _o.IsWhiteList = this.IsWhiteList;
    ...
    for (var _j = 0; _j < this.PersonalityIdLength; ++_j) {_o.PersonalityId.Add(this.PersonalityId(_j));}
    _o.WeaponType = this.WeaponType;
    _o.School = this.School;
    _o.Club = this.Club;
    _o.Role = this.Role;
  }
  public static Offset<FlatData.EchelonConstraintExcel> Pack(FlatBufferBuilder builder, EchelonConstraintExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EchelonConstraintExcel>);
...
public class EchelonConstraintExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("IsWhiteList")]
  ...
  public FlatData.TacticRole Role { get; set; }
  ...
  public EchelonConstraintExcelT() {
    ...
    this.Role = FlatData.TacticRole.None;
  }
}
