...
public struct CharacterSkillListExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CharacterSkillListExcelT _o) {
    ...
    _o.MinimumGradeCharacterWeapon = this.MinimumGradeCharacterWeapon;
    _o.MinimumTierCharacterGear = this.MinimumTierCharacterGear;
    _o.FormIndex = this.FormIndex;
    _o.IsRootMotion = this.IsRootMotion;
    _o.IsMoveLeftRight = this.IsMoveLeftRight;
    _o.UseRandomAnimation = this.UseRandomAnimation;
    _o.TSAInteractionId = this.TSAInteractionId;
    _o.NormalSkillGroupId = new List<string>();
    for (var _j = 0; _j < this.NormalSkillGroupIdLength; ++_j) {_o.NormalSkillGroupId.Add(this.NormalSkillGroupId(_j));}
    _o.NormalSkillTimeLineIndex = new List<int>();
    for (var _j = 0; _j < this.NormalSkillTimeLineIndexLength; ++_j) {_o.NormalSkillTimeLineIndex.Add(this.NormalSkillTimeLineIndex(_j));}
    _o.ExSkillGroupId = new List<string>();
    for (var _j = 0; _j < this.ExSkillGroupIdLength; ++_j) {_o.ExSkillGroupId.Add(this.ExSkillGroupId(_j));}
    _o.ExSkillTimeLineIndex = new List<int>();
    for (var _j = 0; _j < this.ExSkillTimeLineIndexLength; ++_j) {_o.ExSkillTimeLineIndex.Add(this.ExSkillTimeLineIndex(_j));}
    _o.PublicSkillGroupId = new List<string>();
    for (var _j = 0; _j < this.PublicSkillGroupIdLength; ++_j) {_o.PublicSkillGroupId.Add(this.PublicSkillGroupId(_j));}
    _o.PublicSkillTimeLineIndex = new List<int>();
    for (var _j = 0; _j < this.PublicSkillTimeLineIndexLength; ++_j) {_o.PublicSkillTimeLineIndex.Add(this.PublicSkillTimeLineIndex(_j));}
    _o.PassiveSkillGroupId = new List<string>();
    for (var _j = 0; _j < this.PassiveSkillGroupIdLength; ++_j) {_o.PassiveSkillGroupId.Add(this.PassiveSkillGroupId(_j));}
    _o.LeaderSkillGroupId = new List<string>();
    for (var _j = 0; _j < this.LeaderSkillGroupIdLength; ++_j) {_o.LeaderSkillGroupId.Add(this.LeaderSkillGroupId(_j));}
    _o.ExtraPassiveSkillGroupId = new List<string>();
    for (var _j = 0; _j < this.ExtraPassiveSkillGroupIdLength; ++_j) {_o.ExtraPassiveSkillGroupId.Add(this.ExtraPassiveSkillGroupId(_j));}
    _o.HiddenPassiveSkillGroupId = new List<string>();
    for (var _j = 0; _j < this.HiddenPassiveSkillGroupIdLength; ++_j) {_o.HiddenPassiveSkillGroupId.Add(this.HiddenPassiveSkillGroupId(_j));}
  }
  public static Offset<FlatData.CharacterSkillListExcel> Pack(FlatBufferBuilder builder, CharacterSkillListExcelT _o) {
    if (_o == null) return default(Offset<FlatData.CharacterSkillListExcel>);
...
public class CharacterSkillListExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("MinimumGradeCharacterWeapon")]
  public int MinimumGradeCharacterWeapon { get; set; }
  [Newtonsoft.Json.JsonProperty("MinimumTierCharacterGear")]
  public int MinimumTierCharacterGear { get; set; }
  [Newtonsoft.Json.JsonProperty("FormIndex")]
  public int FormIndex { get; set; }
  [Newtonsoft.Json.JsonProperty("IsRootMotion")]
  public bool IsRootMotion { get; set; }
  [Newtonsoft.Json.JsonProperty("IsMoveLeftRight")]
  public bool IsMoveLeftRight { get; set; }
  [Newtonsoft.Json.JsonProperty("UseRandomAnimation")]
  public bool UseRandomAnimation { get; set; }
  [Newtonsoft.Json.JsonProperty("TSAInteractionId")]
  public long TSAInteractionId { get; set; }
  [Newtonsoft.Json.JsonProperty("NormalSkillGroupId")]
  public List<string> NormalSkillGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("NormalSkillTimeLineIndex")]
  public List<int> NormalSkillTimeLineIndex { get; set; }
  [Newtonsoft.Json.JsonProperty("ExSkillGroupId")]
  public List<string> ExSkillGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("ExSkillTimeLineIndex")]
  public List<int> ExSkillTimeLineIndex { get; set; }
  [Newtonsoft.Json.JsonProperty("PublicSkillGroupId")]
  public List<string> PublicSkillGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("PublicSkillTimeLineIndex")]
  public List<int> PublicSkillTimeLineIndex { get; set; }
  [Newtonsoft.Json.JsonProperty("PassiveSkillGroupId")]
  public List<string> PassiveSkillGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("LeaderSkillGroupId")]
  public List<string> LeaderSkillGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("ExtraPassiveSkillGroupId")]
  public List<string> ExtraPassiveSkillGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("HiddenPassiveSkillGroupId")]
