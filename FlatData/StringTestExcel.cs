...
public struct StringTestExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.StringTestExcel> CreateStringTestExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.StringTestExcel> EndStringTestExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.StringTestExcel>(o);
  }
  ...
  public void UnPackTo(StringTestExcelT _o) {
    ...
    for (var _j = 0; _j < this.StringLength; ++_j) {_o.String.Add(this.String(_j));}
    _o.Sentence1 = this.Sentence1;
    _o.Script = this.Script;
  }
  public static Offset<FlatData.StringTestExcel> Pack(FlatBufferBuilder builder, StringTestExcelT _o) {
    if (_o == null) return default(Offset<FlatData.StringTestExcel>);
...
public class StringTestExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("Sentence1")]
  public string Sentence1 { get; set; }
  [Newtonsoft.Json.JsonProperty("Script")]
