...
public struct ShopRecruitExcel : IFlatbufferObject
{
  ...
  public FlatData.GachaDisplayTag DisplayTag { get { int o = __p.__offset(16); return o != 0 ? (FlatData.GachaDisplayTag)__p.bb.GetInt(o + __p.bb_pos) : FlatData.GachaDisplayTag.None; } }
  ...
  public FlatData.PurchaseCountResetType PurchaseCountResetType { get { int o = __p.__offset(40); return o != 0 ? (FlatData.PurchaseCountResetType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.PurchaseCountResetType.None; } }
  ...
  public static Offset<FlatData.ShopRecruitExcel> CreateShopRecruitExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      FlatData.GachaDisplayTag DisplayTag = FlatData.GachaDisplayTag.None,
      long DisplayOrder = 0,
      ...
      FlatData.PurchaseCountResetType PurchaseCountResetType = FlatData.PurchaseCountResetType.None,
      bool IsNewbie = false,
  ...
  public static void AddDisplayTag(FlatBufferBuilder builder, FlatData.GachaDisplayTag displayTag) { builder.AddInt(6, (int)displayTag, 0); }
  ...
  public static void AddPurchaseCountResetType(FlatBufferBuilder builder, FlatData.PurchaseCountResetType purchaseCountResetType) { builder.AddInt(18, (int)purchaseCountResetType, 0); }
  ...
  public static Offset<FlatData.ShopRecruitExcel> EndShopRecruitExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ShopRecruitExcel>(o);
  }
  ...
  public void UnPackTo(ShopRecruitExcelT _o) {
    ...
    _o.OneGachaGoodsId = this.OneGachaGoodsId;
    _o.TenGachaGoodsId = this.TenGachaGoodsId;
    _o.GoodsDevName = this.GoodsDevName;
    _o.DisplayTag = this.DisplayTag;
    _o.DisplayOrder = this.DisplayOrder;
    _o.GachaBannerPath = this.GachaBannerPath;
    _o.VideoId = new List<long>();
    for (var _j = 0; _j < this.VideoIdLength; ++_j) {_o.VideoId.Add(this.VideoId(_j));}
    _o.LinkedRobbyBannerId = this.LinkedRobbyBannerId;
    _o.InfoCharacterId = new List<long>();
    for (var _j = 0; _j < this.InfoCharacterIdLength; ++_j) {_o.InfoCharacterId.Add(this.InfoCharacterId(_j));}
    _o.SalePeriodFrom = this.SalePeriodFrom;
    _o.SalePeriodTo = this.SalePeriodTo;
    _o.RecruitCoinId = this.RecruitCoinId;
    _o.RecruitSellectionShopId = this.RecruitSellectionShopId;
    _o.PurchaseCooltimeMin = this.PurchaseCooltimeMin;
    _o.PurchaseCountLimit = this.PurchaseCountLimit;
    _o.PurchaseCountResetType = this.PurchaseCountResetType;
    _o.IsNewbie = this.IsNewbie;
    _o.IsSelectRecruit = this.IsSelectRecruit;
    _o.DirectPayInvisibleTokenId = this.DirectPayInvisibleTokenId;
    _o.DirectPayAndroidShopCashId = this.DirectPayAndroidShopCashId;
    _o.DirectPayAppleShopCashId = this.DirectPayAppleShopCashId;
  }
  public static Offset<FlatData.ShopRecruitExcel> Pack(FlatBufferBuilder builder, ShopRecruitExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ShopRecruitExcel>);
...
public class ShopRecruitExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("RecruitCoinId")]
  public long RecruitCoinId { get; set; }
  [Newtonsoft.Json.JsonProperty("RecruitSellectionShopId")]
  public long RecruitSellectionShopId { get; set; }
  [Newtonsoft.Json.JsonProperty("PurchaseCooltimeMin")]
  public long PurchaseCooltimeMin { get; set; }
  [Newtonsoft.Json.JsonProperty("PurchaseCountLimit")]
  public long PurchaseCountLimit { get; set; }
  [Newtonsoft.Json.JsonProperty("PurchaseCountResetType")]
  public FlatData.PurchaseCountResetType PurchaseCountResetType { get; set; }
  [Newtonsoft.Json.JsonProperty("IsNewbie")]
  public bool IsNewbie { get; set; }
  [Newtonsoft.Json.JsonProperty("IsSelectRecruit")]
  public bool IsSelectRecruit { get; set; }
  [Newtonsoft.Json.JsonProperty("DirectPayInvisibleTokenId")]
  public long DirectPayInvisibleTokenId { get; set; }
  [Newtonsoft.Json.JsonProperty("DirectPayAndroidShopCashId")]
  public long DirectPayAndroidShopCashId { get; set; }
  [Newtonsoft.Json.JsonProperty("DirectPayAppleShopCashId")]
  ...
  public ShopRecruitExcelT() {
    ...
    this.DisplayTag = FlatData.GachaDisplayTag.None;
    this.DisplayOrder = 0;
    ...
    this.PurchaseCountResetType = FlatData.PurchaseCountResetType.None;
    this.IsNewbie = false;
...
static public class ShopRecruitExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*DisplayTag*/, 4 /*FlatData.GachaDisplayTag*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 40 /*PurchaseCountResetType*/, 4 /*FlatData.PurchaseCountResetType*/, 4, false)
