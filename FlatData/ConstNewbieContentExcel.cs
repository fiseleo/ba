...
public struct ConstNewbieContentExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.ConstNewbieContentExcel> CreateConstNewbieContentExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.ConstNewbieContentExcel> EndConstNewbieContentExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ConstNewbieContentExcel>(o);
  }
  ...
  public void UnPackTo(ConstNewbieContentExcelT _o) {
    _o.NewbieGachaReleaseDate = this.NewbieGachaReleaseDate;
    _o.NewbieGachaCheckDays = this.NewbieGachaCheckDays;
    _o.NewbieGachaTokenGraceTime = this.NewbieGachaTokenGraceTime;
    _o.NewbieAttendanceReleaseDate = this.NewbieAttendanceReleaseDate;
    _o.NewbieAttendanceStartableEndDay = this.NewbieAttendanceStartableEndDay;
    _o.NewbieAttendanceEndDay = this.NewbieAttendanceEndDay;
  }
  public static Offset<FlatData.ConstNewbieContentExcel> Pack(FlatBufferBuilder builder, ConstNewbieContentExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ConstNewbieContentExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("NewbieGachaReleaseDate")]
  public string NewbieGachaReleaseDate { get; set; }
  [Newtonsoft.Json.JsonProperty("NewbieGachaCheckDays")]
  public int NewbieGachaCheckDays { get; set; }
  [Newtonsoft.Json.JsonProperty("NewbieGachaTokenGraceTime")]
  public int NewbieGachaTokenGraceTime { get; set; }
  [Newtonsoft.Json.JsonProperty("NewbieAttendanceReleaseDate")]
  public string NewbieAttendanceReleaseDate { get; set; }
  [Newtonsoft.Json.JsonProperty("NewbieAttendanceStartableEndDay")]
  public int NewbieAttendanceStartableEndDay { get; set; }
  [Newtonsoft.Json.JsonProperty("NewbieAttendanceEndDay")]
