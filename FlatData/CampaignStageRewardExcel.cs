...
public struct CampaignStageRewardExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CampaignStageRewardExcelT _o) {
    ...
    _o.StageRewardProb = this.StageRewardProb;
    _o.StageRewardParcelType = this.StageRewardParcelType;
    _o.StageRewardId = this.StageRewardId;
    _o.StageRewardAmount = this.StageRewardAmount;
    _o.IsDisplayed = this.IsDisplayed;
  }
  public static Offset<FlatData.CampaignStageRewardExcel> Pack(FlatBufferBuilder builder, CampaignStageRewardExcelT _o) {
    if (_o == null) return default(Offset<FlatData.CampaignStageRewardExcel>);
...
public class CampaignStageRewardExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("StageRewardProb")]
  public int StageRewardProb { get; set; }
  [Newtonsoft.Json.JsonProperty("StageRewardParcelType")]
  public FlatData.ParcelType StageRewardParcelType { get; set; }
  [Newtonsoft.Json.JsonProperty("StageRewardId")]
  public long StageRewardId { get; set; }
  [Newtonsoft.Json.JsonProperty("StageRewardAmount")]
  ...
  public CampaignStageRewardExcelT() {
    ...
    this.StageRewardParcelType = FlatData.ParcelType.None;
