...
public struct EventContentDiceRaceExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.EventContentDiceRaceExcel> CreateEventContentDiceRaceExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.EventContentDiceRaceExcel> EndEventContentDiceRaceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentDiceRaceExcel>(o);
  }
  ...
  public void UnPackTo(EventContentDiceRaceExcelT _o) {
    ...
    _o.DiceCostGoodsId = this.DiceCostGoodsId;
    _o.SkipableLap = this.SkipableLap;
    _o.DiceRacePawnPrefab = this.DiceRacePawnPrefab;
    _o.IsUsingFixedDice = this.IsUsingFixedDice;
    _o.DiceRaceEventType = new List<string>();
    for (var _j = 0; _j < this.DiceRaceEventTypeLength; ++_j) {_o.DiceRaceEventType.Add(this.DiceRaceEventType(_j));}
  }
  public static Offset<FlatData.EventContentDiceRaceExcel> Pack(FlatBufferBuilder builder, EventContentDiceRaceExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EventContentDiceRaceExcel>);
...
public class EventContentDiceRaceExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("DiceCostGoodsId")]
  public long DiceCostGoodsId { get; set; }
  [Newtonsoft.Json.JsonProperty("SkipableLap")]
  public int SkipableLap { get; set; }
  [Newtonsoft.Json.JsonProperty("DiceRacePawnPrefab")]
  public string DiceRacePawnPrefab { get; set; }
  [Newtonsoft.Json.JsonProperty("IsUsingFixedDice")]
  public bool IsUsingFixedDice { get; set; }
  [Newtonsoft.Json.JsonProperty("DiceRaceEventType")]
