...
public struct ConstMiniGameShootingExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ConstMiniGameShootingExcelT _o) {
    _o.NormalStageId = this.NormalStageId;
    _o.NormalSectionCount = this.NormalSectionCount;
    _o.HardStageId = this.HardStageId;
    _o.HardSectionCount = this.HardSectionCount;
    _o.FreeStageId = this.FreeStageId;
    _o.FreeSectionCount = this.FreeSectionCount;
    _o.PlayerCharacterId = new List<long>();
    for (var _j = 0; _j < this.PlayerCharacterIdLength; ++_j) {_o.PlayerCharacterId.Add(this.PlayerCharacterId(_j));}
    _o.HiddenPlayerCharacterId = this.HiddenPlayerCharacterId;
    _o.CameraSmoothTime = this.CameraSmoothTime;
    _o.SpawnEffectPath = this.SpawnEffectPath;
    _o.WaitTimeAfterSpawn = this.WaitTimeAfterSpawn;
    _o.FreeGearInterval = this.FreeGearInterval;
  }
  public static Offset<FlatData.ConstMiniGameShootingExcel> Pack(FlatBufferBuilder builder, ConstMiniGameShootingExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ConstMiniGameShootingExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("NormalStageId")]
  public long NormalStageId { get; set; }
  [Newtonsoft.Json.JsonProperty("NormalSectionCount")]
  public int NormalSectionCount { get; set; }
  [Newtonsoft.Json.JsonProperty("HardStageId")]
  public long HardStageId { get; set; }
  [Newtonsoft.Json.JsonProperty("HardSectionCount")]
  public int HardSectionCount { get; set; }
  [Newtonsoft.Json.JsonProperty("FreeStageId")]
  public long FreeStageId { get; set; }
  [Newtonsoft.Json.JsonProperty("FreeSectionCount")]
  public int FreeSectionCount { get; set; }
  [Newtonsoft.Json.JsonProperty("PlayerCharacterId")]
  public List<long> PlayerCharacterId { get; set; }
  [Newtonsoft.Json.JsonProperty("HiddenPlayerCharacterId")]
  public long HiddenPlayerCharacterId { get; set; }
  [Newtonsoft.Json.JsonProperty("CameraSmoothTime")]
  public float CameraSmoothTime { get; set; }
  [Newtonsoft.Json.JsonProperty("SpawnEffectPath")]
  public string SpawnEffectPath { get; set; }
  [Newtonsoft.Json.JsonProperty("WaitTimeAfterSpawn")]
  public float WaitTimeAfterSpawn { get; set; }
  [Newtonsoft.Json.JsonProperty("FreeGearInterval")]
