...
public struct TimeAttackDungeonGeasExcel : IFlatbufferObject
{
  ...
  public FlatData.TimeAttackDungeonType TimeAttackDungeonType { get { int o = __p.__offset(6); return o != 0 ? (FlatData.TimeAttackDungeonType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.TimeAttackDungeonType.None; } }
  ...
  public static Offset<FlatData.TimeAttackDungeonGeasExcel> CreateTimeAttackDungeonGeasExcel(FlatBufferBuilder builder,
      long Id = 0,
      FlatData.TimeAttackDungeonType TimeAttackDungeonType = FlatData.TimeAttackDungeonType.None,
  ...
  public static void AddTimeAttackDungeonType(FlatBufferBuilder builder, FlatData.TimeAttackDungeonType timeAttackDungeonType) { builder.AddInt(1, (int)timeAttackDungeonType, 0); }
  ...
  public static Offset<FlatData.TimeAttackDungeonGeasExcel> EndTimeAttackDungeonGeasExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.TimeAttackDungeonGeasExcel>(o);
  }
  ...
  public void UnPackTo(TimeAttackDungeonGeasExcelT _o) {
    _o.Id = this.Id;
    _o.TimeAttackDungeonType = this.TimeAttackDungeonType;
    _o.LocalizeEtcKey = this.LocalizeEtcKey;
    _o.BattleDuration = this.BattleDuration;
    _o.ClearDefaultPoint = this.ClearDefaultPoint;
    _o.ClearTimeWeightPoint = this.ClearTimeWeightPoint;
    _o.TimeWeightConst = this.TimeWeightConst;
    ...
    for (var _j = 0; _j < this.GeasIconPathLength; ++_j) {_o.GeasIconPath.Add(this.GeasIconPath(_j));}
    _o.GeasLocalizeEtcKey = new List<uint>();
    for (var _j = 0; _j < this.GeasLocalizeEtcKeyLength; ++_j) {_o.GeasLocalizeEtcKey.Add(this.GeasLocalizeEtcKey(_j));}
  }
  public static Offset<FlatData.TimeAttackDungeonGeasExcel> Pack(FlatBufferBuilder builder, TimeAttackDungeonGeasExcelT _o) {
    if (_o == null) return default(Offset<FlatData.TimeAttackDungeonGeasExcel>);
...
public class TimeAttackDungeonGeasExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("TimeAttackDungeonType")]
  public FlatData.TimeAttackDungeonType TimeAttackDungeonType { get; set; }
  [Newtonsoft.Json.JsonProperty("LocalizeEtcKey")]
  public uint LocalizeEtcKey { get; set; }
  [Newtonsoft.Json.JsonProperty("BattleDuration")]
  public long BattleDuration { get; set; }
  [Newtonsoft.Json.JsonProperty("ClearDefaultPoint")]
  public long ClearDefaultPoint { get; set; }
  [Newtonsoft.Json.JsonProperty("ClearTimeWeightPoint")]
  public long ClearTimeWeightPoint { get; set; }
  [Newtonsoft.Json.JsonProperty("TimeWeightConst")]
  ...
  [Newtonsoft.Json.JsonProperty("GeasIconPath")]
  public List<string> GeasIconPath { get; set; }
  [Newtonsoft.Json.JsonProperty("GeasLocalizeEtcKey")]
  public List<uint> GeasLocalizeEtcKey { get; set; }

  public TimeAttackDungeonGeasExcelT() {
    this.Id = 0;
    this.TimeAttackDungeonType = FlatData.TimeAttackDungeonType.None;
...
static public class TimeAttackDungeonGeasExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*TimeAttackDungeonType*/, 4 /*FlatData.TimeAttackDungeonType*/, 4, false)
