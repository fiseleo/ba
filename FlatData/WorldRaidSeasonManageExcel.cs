...
public struct WorldRaidSeasonManageExcel : IFlatbufferObject
{
  ...
  public FlatData.CurrencyTypes EnterTicket { get { int o = __p.__offset(8); return o != 0 ? (FlatData.CurrencyTypes)__p.bb.GetInt(o + __p.bb_pos) : FlatData.CurrencyTypes.Invalid; } }
  ...
  public static Offset<FlatData.WorldRaidSeasonManageExcel> CreateWorldRaidSeasonManageExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
      long EventContentId = 0,
      FlatData.CurrencyTypes EnterTicket = FlatData.CurrencyTypes.Invalid,
  ...
  public static void AddEnterTicket(FlatBufferBuilder builder, FlatData.CurrencyTypes enterTicket) { builder.AddInt(2, (int)enterTicket, 0); }
  ...
  public static Offset<FlatData.WorldRaidSeasonManageExcel> EndWorldRaidSeasonManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.WorldRaidSeasonManageExcel>(o);
  }
  ...
  public void UnPackTo(WorldRaidSeasonManageExcelT _o) {
    ...
    _o.EnterTicket = this.EnterTicket;
    _o.WorldRaidLobbyScene = this.WorldRaidLobbyScene;
    _o.WorldRaidLobbyBanner = this.WorldRaidLobbyBanner;
    _o.WorldRaidLobbyBG = this.WorldRaidLobbyBG;
    _o.WorldRaidLobbyBannerShow = this.WorldRaidLobbyBannerShow;
    _o.SeasonOpenCondition = this.SeasonOpenCondition;
    _o.WorldRaidLobbyEnterScenario = this.WorldRaidLobbyEnterScenario;
    _o.CanPlayNotSeasonTime = this.CanPlayNotSeasonTime;
    _o.WorldRaidUniqueThemeLobbyUI = this.WorldRaidUniqueThemeLobbyUI;
    _o.WorldRaidUniqueThemeName = this.WorldRaidUniqueThemeName;
    _o.CanWorldRaidGemEnter = this.CanWorldRaidGemEnter;
    _o.HideWorldRaidTicketUI = this.HideWorldRaidTicketUI;
    _o.UseWorldRaidCommonToast = this.UseWorldRaidCommonToast;
    _o.OpenRaidBossGroupId = new List<long>();
    for (var _j = 0; _j < this.OpenRaidBossGroupIdLength; ++_j) {_o.OpenRaidBossGroupId.Add(this.OpenRaidBossGroupId(_j));}
    _o.BossSpawnTime = new List<string>();
    for (var _j = 0; _j < this.BossSpawnTimeLength; ++_j) {_o.BossSpawnTime.Add(this.BossSpawnTime(_j));}
    _o.EliminateTime = new List<string>();
    for (var _j = 0; _j < this.EliminateTimeLength; ++_j) {_o.EliminateTime.Add(this.EliminateTime(_j));}
    _o.ScenarioOutputConditionId = new List<long>();
    for (var _j = 0; _j < this.ScenarioOutputConditionIdLength; ++_j) {_o.ScenarioOutputConditionId.Add(this.ScenarioOutputConditionId(_j));}
    _o.ConditionScenarioGroupid = new List<long>();
    for (var _j = 0; _j < this.ConditionScenarioGroupidLength; ++_j) {_o.ConditionScenarioGroupid.Add(this.ConditionScenarioGroupid(_j));}
    _o.WorldRaidMapEnterOperator = this.WorldRaidMapEnterOperator;
    _o.UseFavorRankBuff = this.UseFavorRankBuff;
  }
  public static Offset<FlatData.WorldRaidSeasonManageExcel> Pack(FlatBufferBuilder builder, WorldRaidSeasonManageExcelT _o) {
    if (_o == null) return default(Offset<FlatData.WorldRaidSeasonManageExcel>);
...
public class WorldRaidSeasonManageExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("EnterTicket")]
  public FlatData.CurrencyTypes EnterTicket { get; set; }
  [Newtonsoft.Json.JsonProperty("WorldRaidLobbyScene")]
  public string WorldRaidLobbyScene { get; set; }
  [Newtonsoft.Json.JsonProperty("WorldRaidLobbyBanner")]
  public string WorldRaidLobbyBanner { get; set; }
  [Newtonsoft.Json.JsonProperty("WorldRaidLobbyBG")]
  public string WorldRaidLobbyBG { get; set; }
  [Newtonsoft.Json.JsonProperty("WorldRaidLobbyBannerShow")]
  public bool WorldRaidLobbyBannerShow { get; set; }
  [Newtonsoft.Json.JsonProperty("SeasonOpenCondition")]
  public long SeasonOpenCondition { get; set; }
  [Newtonsoft.Json.JsonProperty("WorldRaidLobbyEnterScenario")]
  public long WorldRaidLobbyEnterScenario { get; set; }
  [Newtonsoft.Json.JsonProperty("CanPlayNotSeasonTime")]
  public bool CanPlayNotSeasonTime { get; set; }
  [Newtonsoft.Json.JsonProperty("WorldRaidUniqueThemeLobbyUI")]
  public bool WorldRaidUniqueThemeLobbyUI { get; set; }
  [Newtonsoft.Json.JsonProperty("WorldRaidUniqueThemeName")]
  public string WorldRaidUniqueThemeName { get; set; }
  [Newtonsoft.Json.JsonProperty("CanWorldRaidGemEnter")]
  public bool CanWorldRaidGemEnter { get; set; }
  [Newtonsoft.Json.JsonProperty("HideWorldRaidTicketUI")]
  public bool HideWorldRaidTicketUI { get; set; }
  [Newtonsoft.Json.JsonProperty("UseWorldRaidCommonToast")]
  public bool UseWorldRaidCommonToast { get; set; }
  [Newtonsoft.Json.JsonProperty("OpenRaidBossGroupId")]
  public List<long> OpenRaidBossGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("BossSpawnTime")]
  public List<string> BossSpawnTime { get; set; }
  [Newtonsoft.Json.JsonProperty("EliminateTime")]
  public List<string> EliminateTime { get; set; }
  [Newtonsoft.Json.JsonProperty("ScenarioOutputConditionId")]
  ...
  [Newtonsoft.Json.JsonProperty("WorldRaidMapEnterOperator")]
  public string WorldRaidMapEnterOperator { get; set; }
  [Newtonsoft.Json.JsonProperty("UseFavorRankBuff")]
  public bool UseFavorRankBuff { get; set; }

  public WorldRaidSeasonManageExcelT() {
    this.SeasonId = 0;
    this.EventContentId = 0;
    this.EnterTicket = FlatData.CurrencyTypes.Invalid;
...
static public class WorldRaidSeasonManageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*EnterTicket*/, 4 /*FlatData.CurrencyTypes*/, 4, false)
