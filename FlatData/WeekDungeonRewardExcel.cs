...
public struct WeekDungeonRewardExcel : IFlatbufferObject
{
  ...
  public FlatData.WeekDungeonType DungeonType { get { int o = __p.__offset(6); return o != 0 ? (FlatData.WeekDungeonType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.WeekDungeonType.None; } }
  ...
  public static Offset<FlatData.WeekDungeonRewardExcel> CreateWeekDungeonRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      FlatData.WeekDungeonType DungeonType = FlatData.WeekDungeonType.None,
  ...
  public static void AddDungeonType(FlatBufferBuilder builder, FlatData.WeekDungeonType dungeonType) { builder.AddInt(1, (int)dungeonType, 0); }
  ...
  public static Offset<FlatData.WeekDungeonRewardExcel> EndWeekDungeonRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.WeekDungeonRewardExcel>(o);
  }
  ...
  public static Offset<FlatData.WeekDungeonRewardExcel> Pack(FlatBufferBuilder builder, WeekDungeonRewardExcelT _o) {
    if (_o == null) return default(Offset<FlatData.WeekDungeonRewardExcel>);
...
public class WeekDungeonRewardExcelT
{
  ...
  public FlatData.WeekDungeonType DungeonType { get; set; }
  ...
  public WeekDungeonRewardExcelT() {
    this.GroupId = 0;
    this.DungeonType = FlatData.WeekDungeonType.None;
...
static public class WeekDungeonRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*DungeonType*/, 4 /*FlatData.WeekDungeonType*/, 4, false)
