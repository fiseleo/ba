...
public struct LogicEffectCommonVisualExcel : IFlatbufferObject
{
  ...
  public FlatData.EffectBone ParticleEnterSocket { get { int o = __p.__offset(12); return o != 0 ? (FlatData.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : FlatData.EffectBone.None; } }
  ...
  public FlatData.EffectBone ParticleLoopSocket { get { int o = __p.__offset(16); return o != 0 ? (FlatData.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : FlatData.EffectBone.None; } }
  ...
  public FlatData.EffectBone ParticleEndSocket { get { int o = __p.__offset(20); return o != 0 ? (FlatData.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : FlatData.EffectBone.None; } }
  ...
  public FlatData.EffectBone ParticleApplySocket { get { int o = __p.__offset(24); return o != 0 ? (FlatData.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : FlatData.EffectBone.None; } }
  ...
  public FlatData.EffectBone ParticleRemovedSocket { get { int o = __p.__offset(28); return o != 0 ? (FlatData.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : FlatData.EffectBone.None; } }

  public static Offset<FlatData.LogicEffectCommonVisualExcel> CreateLogicEffectCommonVisualExcel(FlatBufferBuilder builder,
      uint StringID = 0,
      ...
      FlatData.EffectBone ParticleEnterSocket = FlatData.EffectBone.None,
      StringOffset ParticleLoopPathOffset = default(StringOffset),
      FlatData.EffectBone ParticleLoopSocket = FlatData.EffectBone.None,
      StringOffset ParticleEndPathOffset = default(StringOffset),
      FlatData.EffectBone ParticleEndSocket = FlatData.EffectBone.None,
      StringOffset ParticleApplyPathOffset = default(StringOffset),
      FlatData.EffectBone ParticleApplySocket = FlatData.EffectBone.None,
      StringOffset ParticleRemovedPathOffset = default(StringOffset),
      FlatData.EffectBone ParticleRemovedSocket = FlatData.EffectBone.None) {
  ...
  public static void AddParticleEnterSocket(FlatBufferBuilder builder, FlatData.EffectBone particleEnterSocket) { builder.AddInt(4, (int)particleEnterSocket, 0); }
  ...
  public static void AddParticleLoopSocket(FlatBufferBuilder builder, FlatData.EffectBone particleLoopSocket) { builder.AddInt(6, (int)particleLoopSocket, 0); }
  ...
  public static void AddParticleEndSocket(FlatBufferBuilder builder, FlatData.EffectBone particleEndSocket) { builder.AddInt(8, (int)particleEndSocket, 0); }
  ...
  public static void AddParticleApplySocket(FlatBufferBuilder builder, FlatData.EffectBone particleApplySocket) { builder.AddInt(10, (int)particleApplySocket, 0); }
  ...
  public static void AddParticleRemovedSocket(FlatBufferBuilder builder, FlatData.EffectBone particleRemovedSocket) { builder.AddInt(12, (int)particleRemovedSocket, 0); }
  public static Offset<FlatData.LogicEffectCommonVisualExcel> EndLogicEffectCommonVisualExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.LogicEffectCommonVisualExcel>(o);
  }
  ...
  public void UnPackTo(LogicEffectCommonVisualExcelT _o) {
    ...
    _o.IconSpriteName = this.IconSpriteName;
    _o.IconDispelColor = new List<float>();
    for (var _j = 0; _j < this.IconDispelColorLength; ++_j) {_o.IconDispelColor.Add(this.IconDispelColor(_j));}
    _o.ParticleEnterPath = this.ParticleEnterPath;
    _o.ParticleEnterSocket = this.ParticleEnterSocket;
    _o.ParticleLoopPath = this.ParticleLoopPath;
    _o.ParticleLoopSocket = this.ParticleLoopSocket;
    _o.ParticleEndPath = this.ParticleEndPath;
    _o.ParticleEndSocket = this.ParticleEndSocket;
    _o.ParticleApplyPath = this.ParticleApplyPath;
    _o.ParticleApplySocket = this.ParticleApplySocket;
    _o.ParticleRemovedPath = this.ParticleRemovedPath;
    _o.ParticleRemovedSocket = this.ParticleRemovedSocket;
  }
  public static Offset<FlatData.LogicEffectCommonVisualExcel> Pack(FlatBufferBuilder builder, LogicEffectCommonVisualExcelT _o) {
    if (_o == null) return default(Offset<FlatData.LogicEffectCommonVisualExcel>);
...
public class LogicEffectCommonVisualExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("IconSpriteName")]
  public string IconSpriteName { get; set; }
  [Newtonsoft.Json.JsonProperty("IconDispelColor")]
  public List<float> IconDispelColor { get; set; }
  [Newtonsoft.Json.JsonProperty("ParticleEnterPath")]
  public string ParticleEnterPath { get; set; }
  [Newtonsoft.Json.JsonProperty("ParticleEnterSocket")]
  public FlatData.EffectBone ParticleEnterSocket { get; set; }
  [Newtonsoft.Json.JsonProperty("ParticleLoopPath")]
  public string ParticleLoopPath { get; set; }
  [Newtonsoft.Json.JsonProperty("ParticleLoopSocket")]
  public FlatData.EffectBone ParticleLoopSocket { get; set; }
  [Newtonsoft.Json.JsonProperty("ParticleEndPath")]
  public string ParticleEndPath { get; set; }
  [Newtonsoft.Json.JsonProperty("ParticleEndSocket")]
  public FlatData.EffectBone ParticleEndSocket { get; set; }
  [Newtonsoft.Json.JsonProperty("ParticleApplyPath")]
  public string ParticleApplyPath { get; set; }
  [Newtonsoft.Json.JsonProperty("ParticleApplySocket")]
  public FlatData.EffectBone ParticleApplySocket { get; set; }
  [Newtonsoft.Json.JsonProperty("ParticleRemovedPath")]
  public string ParticleRemovedPath { get; set; }
  [Newtonsoft.Json.JsonProperty("ParticleRemovedSocket")]
  public FlatData.EffectBone ParticleRemovedSocket { get; set; }
  ...
  public LogicEffectCommonVisualExcelT() {
    ...
    this.ParticleEnterSocket = FlatData.EffectBone.None;
    this.ParticleLoopPath = null;
    this.ParticleLoopSocket = FlatData.EffectBone.None;
    this.ParticleEndPath = null;
    this.ParticleEndSocket = FlatData.EffectBone.None;
    this.ParticleApplyPath = null;
    this.ParticleApplySocket = FlatData.EffectBone.None;
    this.ParticleRemovedPath = null;
    this.ParticleRemovedSocket = FlatData.EffectBone.None;
  }
}
...
static public class LogicEffectCommonVisualExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*ParticleEnterSocket*/, 4 /*FlatData.EffectBone*/, 4, false)
      && verifier.VerifyString(tablePos, 14 /*ParticleLoopPath*/, false)
      && verifier.VerifyField(tablePos, 16 /*ParticleLoopSocket*/, 4 /*FlatData.EffectBone*/, 4, false)
      && verifier.VerifyString(tablePos, 18 /*ParticleEndPath*/, false)
      && verifier.VerifyField(tablePos, 20 /*ParticleEndSocket*/, 4 /*FlatData.EffectBone*/, 4, false)
      && verifier.VerifyString(tablePos, 22 /*ParticleApplyPath*/, false)
      && verifier.VerifyField(tablePos, 24 /*ParticleApplySocket*/, 4 /*FlatData.EffectBone*/, 4, false)
      && verifier.VerifyString(tablePos, 26 /*ParticleRemovedPath*/, false)
      && verifier.VerifyField(tablePos, 28 /*ParticleRemovedSocket*/, 4 /*FlatData.EffectBone*/, 4, false)
