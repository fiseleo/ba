...
public struct CharacterTranscendenceExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.CharacterTranscendenceExcel> CreateCharacterTranscendenceExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
  ...
  public static Offset<FlatData.CharacterTranscendenceExcel> EndCharacterTranscendenceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.CharacterTranscendenceExcel>(o);
  }
  ...
  public void UnPackTo(CharacterTranscendenceExcelT _o) {
    ...
    for (var _j = 0; _j < this.MaxFavorLevelLength; ++_j) {_o.MaxFavorLevel.Add(this.MaxFavorLevel(_j));}
    _o.StatBonusRateAttack = new List<long>();
    for (var _j = 0; _j < this.StatBonusRateAttackLength; ++_j) {_o.StatBonusRateAttack.Add(this.StatBonusRateAttack(_j));}
    _o.StatBonusRateHP = new List<long>();
    for (var _j = 0; _j < this.StatBonusRateHPLength; ++_j) {_o.StatBonusRateHP.Add(this.StatBonusRateHP(_j));}
    _o.StatBonusRateHeal = new List<long>();
    for (var _j = 0; _j < this.StatBonusRateHealLength; ++_j) {_o.StatBonusRateHeal.Add(this.StatBonusRateHeal(_j));}
    ...
    for (var _j = 0; _j < this.SkillSlotALength; ++_j) {_o.SkillSlotA.Add(this.SkillSlotA(_j));}
    _o.SkillSlotB = new List<string>();
    for (var _j = 0; _j < this.SkillSlotBLength; ++_j) {_o.SkillSlotB.Add(this.SkillSlotB(_j));}
    _o.MaxlevelStar = new List<int>();
    for (var _j = 0; _j < this.MaxlevelStarLength; ++_j) {_o.MaxlevelStar.Add(this.MaxlevelStar(_j));}
  }
  public static Offset<FlatData.CharacterTranscendenceExcel> Pack(FlatBufferBuilder builder, CharacterTranscendenceExcelT _o) {
    if (_o == null) return default(Offset<FlatData.CharacterTranscendenceExcel>);
