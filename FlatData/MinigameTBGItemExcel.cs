...
public struct MinigameTBGItemExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MinigameTBGItemExcelT _o) {
    ...
    _o.TBGItemEffectType = this.TBGItemEffectType;
    _o.ItemParameter = this.ItemParameter;
    _o.LocalizeETCId = this.LocalizeETCId;
    _o.Icon = this.Icon;
    _o.BuffIcon = this.BuffIcon;
    _o.EncounterCount = this.EncounterCount;
    _o.DiceEffectAniClip = this.DiceEffectAniClip;
  }
  public static Offset<FlatData.MinigameTBGItemExcel> Pack(FlatBufferBuilder builder, MinigameTBGItemExcelT _o) {
    if (_o == null) return default(Offset<FlatData.MinigameTBGItemExcel>);
...
public class MinigameTBGItemExcelT
{
  ...
  public FlatData.TBGItemType ItemType { get; set; }
  [Newtonsoft.Json.JsonProperty("TBGItemEffectType")]
  public FlatData.TBGItemEffectType TBGItemEffectType { get; set; }
  [Newtonsoft.Json.JsonProperty("ItemParameter")]
  public int ItemParameter { get; set; }
  [Newtonsoft.Json.JsonProperty("LocalizeETCId")]
  public string LocalizeETCId { get; set; }
  [Newtonsoft.Json.JsonProperty("Icon")]
  public string Icon { get; set; }
  [Newtonsoft.Json.JsonProperty("BuffIcon")]
  public string BuffIcon { get; set; }
  [Newtonsoft.Json.JsonProperty("EncounterCount")]
  public int EncounterCount { get; set; }
  [Newtonsoft.Json.JsonProperty("DiceEffectAniClip")]
  public string DiceEffectAniClip { get; set; }

  public MinigameTBGItemExcelT() {
    this.UniqueId = 0;
    this.ItemType = FlatData.TBGItemType.None;
    this.TBGItemEffectType = FlatData.TBGItemEffectType.None;
