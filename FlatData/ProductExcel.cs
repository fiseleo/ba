...
public struct ProductExcel : IFlatbufferObject
{
  ...
  public FlatData.PurchasePeriodType PurchasePeriodType { get { int o = __p.__offset(14); return o != 0 ? (FlatData.PurchasePeriodType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.PurchasePeriodType.None; } }
  ...
  public static void AddPurchasePeriodType(FlatBufferBuilder builder, FlatData.PurchasePeriodType purchasePeriodType) { builder.AddInt(5, (int)purchasePeriodType, 0); }
  ...
  public void UnPackTo(ProductExcelT _o) {
    ...
    _o.PurchasePeriodType = this.PurchasePeriodType;
    _o.PurchasePeriodLimit = this.PurchasePeriodLimit;
  ...
  public static Offset<FlatData.ProductExcel> Pack(FlatBufferBuilder builder, ProductExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ProductExcel>);
...
public class ProductExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("PurchasePeriodType")]
  public FlatData.PurchasePeriodType PurchasePeriodType { get; set; }
  [Newtonsoft.Json.JsonProperty("PurchasePeriodLimit")]
  ...
  public ProductExcelT() {
    ...
    this.PurchasePeriodType = FlatData.PurchasePeriodType.None;
...
static public class ProductExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*PurchasePeriodType*/, 4 /*FlatData.PurchasePeriodType*/, 4, false)
