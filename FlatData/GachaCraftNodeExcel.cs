...
public struct GachaCraftNodeExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.GachaCraftNodeExcel> CreateGachaCraftNodeExcel(FlatBufferBuilder builder,
      long ID = 0,
      long Tier = 0,
  ...
  public static Offset<FlatData.GachaCraftNodeExcel> EndGachaCraftNodeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.GachaCraftNodeExcel>(o);
  }
  ...
  public void UnPackTo(GachaCraftNodeExcelT _o) {
    _o.ID = this.ID;
    _o.Tier = this.Tier;
    _o.QuickCraftNodeDisplayOrder = this.QuickCraftNodeDisplayOrder;
    _o.NodeQuality = this.NodeQuality;
    _o.Icon = this.Icon;
    _o.LocalizeKey = this.LocalizeKey;
    _o.Property = this.Property;
  }
  public static Offset<FlatData.GachaCraftNodeExcel> Pack(FlatBufferBuilder builder, GachaCraftNodeExcelT _o) {
    if (_o == null) return default(Offset<FlatData.GachaCraftNodeExcel>);
...
public class GachaCraftNodeExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("QuickCraftNodeDisplayOrder")]
  public int QuickCraftNodeDisplayOrder { get; set; }
  [Newtonsoft.Json.JsonProperty("NodeQuality")]
  public long NodeQuality { get; set; }
  [Newtonsoft.Json.JsonProperty("Icon")]
  public string Icon { get; set; }
  [Newtonsoft.Json.JsonProperty("LocalizeKey")]
