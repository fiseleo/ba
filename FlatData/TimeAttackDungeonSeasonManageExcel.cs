...
public struct TimeAttackDungeonSeasonManageExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.TimeAttackDungeonSeasonManageExcel> CreateTimeAttackDungeonSeasonManageExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatData.TimeAttackDungeonSeasonManageExcel> EndTimeAttackDungeonSeasonManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.TimeAttackDungeonSeasonManageExcel>(o);
  }
  ...
  public void UnPackTo(TimeAttackDungeonSeasonManageExcelT _o) {
    ...
    _o.UISlot = this.UISlot;
    _o.DungeonId = this.DungeonId;
    _o.DifficultyGeas = new List<long>();
    for (var _j = 0; _j < this.DifficultyGeasLength; ++_j) {_o.DifficultyGeas.Add(this.DifficultyGeas(_j));}
    _o.TimeAttackDungeonRewardId = this.TimeAttackDungeonRewardId;
    _o.RoomLifeTimeInSeconds = this.RoomLifeTimeInSeconds;
  }
  public static Offset<FlatData.TimeAttackDungeonSeasonManageExcel> Pack(FlatBufferBuilder builder, TimeAttackDungeonSeasonManageExcelT _o) {
    if (_o == null) return default(Offset<FlatData.TimeAttackDungeonSeasonManageExcel>);
...
public class TimeAttackDungeonSeasonManageExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("UISlot")]
  public long UISlot { get; set; }
  [Newtonsoft.Json.JsonProperty("DungeonId")]
  public long DungeonId { get; set; }
  [Newtonsoft.Json.JsonProperty("DifficultyGeas")]
  public List<long> DifficultyGeas { get; set; }
  [Newtonsoft.Json.JsonProperty("TimeAttackDungeonRewardId")]
  public long TimeAttackDungeonRewardId { get; set; }
  [Newtonsoft.Json.JsonProperty("RoomLifeTimeInSeconds")]
