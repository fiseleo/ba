...
public struct CouponStuffExcel : IFlatbufferObject
{
  ...
  public FlatData.ParcelType ParcelType { get { int o = __p.__offset(6); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ParcelType.None; } }
  ...
  public static Offset<FlatData.CouponStuffExcel> CreateCouponStuffExcel(FlatBufferBuilder builder,
      long StuffId = 0,
  ...
  public static void AddParcelType(FlatBufferBuilder builder, FlatData.ParcelType parcelType) { builder.AddInt(1, (int)parcelType, 0); }
  ...
  public static Offset<FlatData.CouponStuffExcel> EndCouponStuffExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.CouponStuffExcel>(o);
  }
  ...
  public void UnPackTo(CouponStuffExcelT _o) {
    _o.StuffId = this.StuffId;
    _o.ParcelType = this.ParcelType;
    _o.ParcelId = this.ParcelId;
    _o.LimitAmount = this.LimitAmount;
    _o.CouponStuffNameLocalizeKey = this.CouponStuffNameLocalizeKey;
  }
  public static Offset<FlatData.CouponStuffExcel> Pack(FlatBufferBuilder builder, CouponStuffExcelT _o) {
    if (_o == null) return default(Offset<FlatData.CouponStuffExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("StuffId")]
  ...
  [Newtonsoft.Json.JsonProperty("LimitAmount")]
  public int LimitAmount { get; set; }
  [Newtonsoft.Json.JsonProperty("CouponStuffNameLocalizeKey")]
...
static public class CouponStuffExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ParcelType*/, 4 /*FlatData.ParcelType*/, 4, false)
