...
public struct EventContentShopExcel : IFlatbufferObject
{
  ...
  public FlatData.ShopCategoryType CategoryType { get { int o = __p.__offset(10); return o != 0 ? (FlatData.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ShopCategoryType.General; } }
  ...
  public FlatData.PurchaseCountResetType PurchaseCountResetType { get { int o = __p.__offset(26); return o != 0 ? (FlatData.PurchaseCountResetType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.PurchaseCountResetType.None; } }
  ...
  public static Offset<FlatData.EventContentShopExcel> CreateEventContentShopExcel(FlatBufferBuilder builder,
  ...
  public static void AddCategoryType(FlatBufferBuilder builder, FlatData.ShopCategoryType categoryType) { builder.AddInt(3, (int)categoryType, 0); }
  ...
  public static void AddPurchaseCountResetType(FlatBufferBuilder builder, FlatData.PurchaseCountResetType purchaseCountResetType) { builder.AddInt(11, (int)purchaseCountResetType, 0); }
  ...
  public static Offset<FlatData.EventContentShopExcel> EndEventContentShopExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentShopExcel>(o);
  }
  ...
  public static Offset<FlatData.EventContentShopExcel> Pack(FlatBufferBuilder builder, EventContentShopExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EventContentShopExcel>);
...
static public class EventContentShopExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*CategoryType*/, 4 /*FlatData.ShopCategoryType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 26 /*PurchaseCountResetType*/, 4 /*FlatData.PurchaseCountResetType*/, 4, false)
