...
public struct PersonalityExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.PersonalityExcel> CreatePersonalityExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatData.PersonalityExcel> EndPersonalityExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.PersonalityExcel>(o);
  }
  ...
  public static Offset<FlatData.PersonalityExcel> Pack(FlatBufferBuilder builder, PersonalityExcelT _o) {
    if (_o == null) return default(Offset<FlatData.PersonalityExcel>);
