...
public struct EventContentShopRefreshExcel : IFlatbufferObject
{
  ...
  public FlatData.ShopCategoryType CategoryType { get { int o = __p.__offset(16); return o != 0 ? (FlatData.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ShopCategoryType.General; } }
  ...
  public static Offset<FlatData.EventContentShopRefreshExcel> CreateEventContentShopRefreshExcel(FlatBufferBuilder builder,
  ...
  public static void AddCategoryType(FlatBufferBuilder builder, FlatData.ShopCategoryType categoryType) { builder.AddInt(6, (int)categoryType, 0); }
  ...
  public static Offset<FlatData.EventContentShopRefreshExcel> EndEventContentShopRefreshExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentShopRefreshExcel>(o);
  }
  ...
  public static Offset<FlatData.EventContentShopRefreshExcel> Pack(FlatBufferBuilder builder, EventContentShopRefreshExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EventContentShopRefreshExcel>);
...
static public class EventContentShopRefreshExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*CategoryType*/, 4 /*FlatData.ShopCategoryType*/, 4, false)
