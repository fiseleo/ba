...
public struct EventContentDiceRaceNodeExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentDiceRaceNodeExcelT _o) {
    ...
    _o.EventContentDiceRaceNodeType = this.EventContentDiceRaceNodeType;
    _o.MoveForwardTypeArg = this.MoveForwardTypeArg;
  ...
  public static Offset<FlatData.EventContentDiceRaceNodeExcel> Pack(FlatBufferBuilder builder, EventContentDiceRaceNodeExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EventContentDiceRaceNodeExcel>);
...
public class EventContentDiceRaceNodeExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("EventContentDiceRaceNodeType")]
  public FlatData.EventContentDiceRaceNodeType EventContentDiceRaceNodeType { get; set; }
  [Newtonsoft.Json.JsonProperty("MoveForwardTypeArg")]
  ...
  public EventContentDiceRaceNodeExcelT() {
    ...
    this.NodeId = 0;
    this.EventContentDiceRaceNodeType = FlatData.EventContentDiceRaceNodeType.StartNode;
