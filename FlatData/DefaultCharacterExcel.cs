...
public struct DefaultCharacterExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.DefaultCharacterExcel> CreateDefaultCharacterExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
  ...
  public static Offset<FlatData.DefaultCharacterExcel> EndDefaultCharacterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.DefaultCharacterExcel>(o);
  }
  ...
  public void UnPackTo(DefaultCharacterExcelT _o) {
    ...
    _o.FavoriteCharacter = this.FavoriteCharacter;
    _o.Level = this.Level;
    _o.Exp = this.Exp;
  ...
  public static Offset<FlatData.DefaultCharacterExcel> Pack(FlatBufferBuilder builder, DefaultCharacterExcelT _o) {
    if (_o == null) return default(Offset<FlatData.DefaultCharacterExcel>);
...
public class DefaultCharacterExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("FavoriteCharacter")]
