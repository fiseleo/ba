...
public struct MiniGameAudioAnimatorExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.MiniGameAudioAnimatorExcel> CreateMiniGameAudioAnimatorExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.MiniGameAudioAnimatorExcel> EndMiniGameAudioAnimatorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.MiniGameAudioAnimatorExcel>(o);
  }
  ...
  public void UnPackTo(MiniGameAudioAnimatorExcelT _o) {
    _o.ControllerNameHash = this.ControllerNameHash;
    _o.VoiceNamePrefix = this.VoiceNamePrefix;
    _o.StateNameHash = this.StateNameHash;
    _o.StateName = this.StateName;
    _o.IgnoreInterruptDelay = this.IgnoreInterruptDelay;
    _o.IgnoreInterruptPlay = this.IgnoreInterruptPlay;
    _o.Volume = this.Volume;
    _o.Delay = this.Delay;
    _o.AudioPriority = this.AudioPriority;
    _o.AudioClipPath = new List<string>();
    for (var _j = 0; _j < this.AudioClipPathLength; ++_j) {_o.AudioClipPath.Add(this.AudioClipPath(_j));}
    _o.VoiceHash = new List<uint>();
    for (var _j = 0; _j < this.VoiceHashLength; ++_j) {_o.VoiceHash.Add(this.VoiceHash(_j));}
  }
  public static Offset<FlatData.MiniGameAudioAnimatorExcel> Pack(FlatBufferBuilder builder, MiniGameAudioAnimatorExcelT _o) {
    if (_o == null) return default(Offset<FlatData.MiniGameAudioAnimatorExcel>);
