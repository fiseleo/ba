...
public struct AcademyMessangerExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.AcademyMessangerExcel> CreateAcademyMessangerExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.AcademyMessangerExcel> EndAcademyMessangerExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.AcademyMessangerExcel>(o);
  }
  ...
  public static Offset<FlatData.AcademyMessangerExcel> Pack(FlatBufferBuilder builder, AcademyMessangerExcelT _o) {
    if (_o == null) return default(Offset<FlatData.AcademyMessangerExcel>);
