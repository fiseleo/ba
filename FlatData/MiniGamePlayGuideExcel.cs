...
public struct MiniGamePlayGuideExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.MiniGamePlayGuideExcel> Pack(FlatBufferBuilder builder, MiniGamePlayGuideExcelT _o) {
    if (_o == null) return default(Offset<FlatData.MiniGamePlayGuideExcel>);
