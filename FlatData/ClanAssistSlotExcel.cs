...
public struct ClanAssistSlotExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.ClanAssistSlotExcel> CreateClanAssistSlotExcel(FlatBufferBuilder builder,
      long SlotId = 0,
  ...
  public static Offset<FlatData.ClanAssistSlotExcel> EndClanAssistSlotExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ClanAssistSlotExcel>(o);
  }
  ...
  public void UnPackTo(ClanAssistSlotExcelT _o) {
    ...
    _o.SlotNumber = this.SlotNumber;
    _o.AssistTermRewardPeriodFromSec = this.AssistTermRewardPeriodFromSec;
    _o.AssistRewardLimit = this.AssistRewardLimit;
    _o.AssistRentRewardDailyMaxCount = this.AssistRentRewardDailyMaxCount;
    _o.AssistRentalFeeAmount = this.AssistRentalFeeAmount;
    _o.AssistRentalFeeAmountStranger = this.AssistRentalFeeAmountStranger;
  }
  public static Offset<FlatData.ClanAssistSlotExcel> Pack(FlatBufferBuilder builder, ClanAssistSlotExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ClanAssistSlotExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("SlotId")]
  public long SlotId { get; set; }
  [Newtonsoft.Json.JsonProperty("EchelonType")]
  public FlatData.EchelonType EchelonType { get; set; }
  [Newtonsoft.Json.JsonProperty("SlotNumber")]
  public long SlotNumber { get; set; }
  [Newtonsoft.Json.JsonProperty("AssistTermRewardPeriodFromSec")]
  public long AssistTermRewardPeriodFromSec { get; set; }
  [Newtonsoft.Json.JsonProperty("AssistRewardLimit")]
  public long AssistRewardLimit { get; set; }
  [Newtonsoft.Json.JsonProperty("AssistRentRewardDailyMaxCount")]
  public long AssistRentRewardDailyMaxCount { get; set; }
  [Newtonsoft.Json.JsonProperty("AssistRentalFeeAmount")]
  public long AssistRentalFeeAmount { get; set; }
  [Newtonsoft.Json.JsonProperty("AssistRentalFeeAmountStranger")]
