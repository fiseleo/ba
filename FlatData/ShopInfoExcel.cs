...
public struct ShopInfoExcel : IFlatbufferObject
{
  ...
  public FlatData.ShopCategoryType CategoryType { get { int o = __p.__offset(4); return o != 0 ? (FlatData.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ShopCategoryType.General; } }
  ...
  public FlatData.ParcelType DisplayParcelType { get { int o = __p.__offset(26); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ParcelType.None; } }
  ...
  public static Offset<FlatData.ShopInfoExcel> CreateShopInfoExcel(FlatBufferBuilder builder,
      ...
      FlatData.ParcelType DisplayParcelType = FlatData.ParcelType.None,
  ...
  public static void AddCategoryType(FlatBufferBuilder builder, FlatData.ShopCategoryType categoryType) { builder.AddInt(0, (int)categoryType, 0); }
  ...
  public static void AddDisplayParcelType(FlatBufferBuilder builder, FlatData.ParcelType displayParcelType) { builder.AddInt(11, (int)displayParcelType, 0); }
  ...
  public static Offset<FlatData.ShopInfoExcel> EndShopInfoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ShopInfoExcel>(o);
  }
  ...
  public void UnPackTo(ShopInfoExcelT _o) {
    ...
    _o.ShopProductUpdateTime = this.ShopProductUpdateTime;
    _o.DisplayParcelType = this.DisplayParcelType;
    _o.DisplayParcelId = this.DisplayParcelId;
    _o.IsShopVisible = this.IsShopVisible;
    _o.DisplayOrder = this.DisplayOrder;
    _o.ShopUpdateDate = this.ShopUpdateDate;
    _o.ShopUpdateGroupId1 = this.ShopUpdateGroupId1;
    _o.ShopUpdateGroupId2 = this.ShopUpdateGroupId2;
    _o.ShopUpdateGroupId3 = this.ShopUpdateGroupId3;
    _o.ShopUpdateGroupId4 = this.ShopUpdateGroupId4;
    _o.ShopUpdateGroupId5 = this.ShopUpdateGroupId5;
    _o.ShopUpdateGroupId6 = this.ShopUpdateGroupId6;
    _o.ShopUpdateGroupId7 = this.ShopUpdateGroupId7;
    _o.ShopUpdateGroupId8 = this.ShopUpdateGroupId8;
    _o.ShopUpdateGroupId9 = this.ShopUpdateGroupId9;
    _o.ShopUpdateGroupId10 = this.ShopUpdateGroupId10;
    _o.ShopUpdateGroupId11 = this.ShopUpdateGroupId11;
    _o.ShopUpdateGroupId12 = this.ShopUpdateGroupId12;
  }
  public static Offset<FlatData.ShopInfoExcel> Pack(FlatBufferBuilder builder, ShopInfoExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ShopInfoExcel>);
...
public class ShopInfoExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("ShopProductUpdateTime")]
  public string ShopProductUpdateTime { get; set; }
  [Newtonsoft.Json.JsonProperty("DisplayParcelType")]
  public FlatData.ParcelType DisplayParcelType { get; set; }
  [Newtonsoft.Json.JsonProperty("DisplayParcelId")]
  public long DisplayParcelId { get; set; }
  [Newtonsoft.Json.JsonProperty("IsShopVisible")]
  public bool IsShopVisible { get; set; }
  [Newtonsoft.Json.JsonProperty("DisplayOrder")]
  public int DisplayOrder { get; set; }
  [Newtonsoft.Json.JsonProperty("ShopUpdateDate")]
  public int ShopUpdateDate { get; set; }
  [Newtonsoft.Json.JsonProperty("ShopUpdateGroupId1")]
  public int ShopUpdateGroupId1 { get; set; }
  [Newtonsoft.Json.JsonProperty("ShopUpdateGroupId2")]
  public int ShopUpdateGroupId2 { get; set; }
  [Newtonsoft.Json.JsonProperty("ShopUpdateGroupId3")]
  public int ShopUpdateGroupId3 { get; set; }
  [Newtonsoft.Json.JsonProperty("ShopUpdateGroupId4")]
  public int ShopUpdateGroupId4 { get; set; }
  [Newtonsoft.Json.JsonProperty("ShopUpdateGroupId5")]
  public int ShopUpdateGroupId5 { get; set; }
  [Newtonsoft.Json.JsonProperty("ShopUpdateGroupId6")]
  public int ShopUpdateGroupId6 { get; set; }
  [Newtonsoft.Json.JsonProperty("ShopUpdateGroupId7")]
  public int ShopUpdateGroupId7 { get; set; }
  [Newtonsoft.Json.JsonProperty("ShopUpdateGroupId8")]
  public int ShopUpdateGroupId8 { get; set; }
  [Newtonsoft.Json.JsonProperty("ShopUpdateGroupId9")]
  public int ShopUpdateGroupId9 { get; set; }
  [Newtonsoft.Json.JsonProperty("ShopUpdateGroupId10")]
  public int ShopUpdateGroupId10 { get; set; }
  [Newtonsoft.Json.JsonProperty("ShopUpdateGroupId11")]
  public int ShopUpdateGroupId11 { get; set; }
  [Newtonsoft.Json.JsonProperty("ShopUpdateGroupId12")]
  ...
  public ShopInfoExcelT() {
    ...
    this.DisplayParcelType = FlatData.ParcelType.None;
...
static public class ShopInfoExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*CategoryType*/, 4 /*FlatData.ShopCategoryType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 26 /*DisplayParcelType*/, 4 /*FlatData.ParcelType*/, 4, false)
