...
public struct MinigameTBGEncounterRewardExcel : IFlatbufferObject
{
  ...
  public FlatData.TBGOptionSuccessType TBGOptionSuccessType { get { int o = __p.__offset(8); return o != 0 ? (FlatData.TBGOptionSuccessType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.TBGOptionSuccessType.None; } }
  public long Paremeter { get { int o = __p.__offset(10); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public FlatData.ParcelType ParcelType { get { int o = __p.__offset(12); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ParcelType.None; } }
  ...
  public static Offset<FlatData.MinigameTBGEncounterRewardExcel> CreateMinigameTBGEncounterRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      long UniqueId = 0,
      FlatData.TBGOptionSuccessType TBGOptionSuccessType = FlatData.TBGOptionSuccessType.None,
      long Paremeter = 0,
  ...
  public static void AddTBGOptionSuccessType(FlatBufferBuilder builder, FlatData.TBGOptionSuccessType tBGOptionSuccessType) { builder.AddInt(2, (int)tBGOptionSuccessType, 0); }
  public static void AddParemeter(FlatBufferBuilder builder, long paremeter) { builder.AddLong(3, paremeter, 0); }
  public static void AddParcelType(FlatBufferBuilder builder, FlatData.ParcelType parcelType) { builder.AddInt(4, (int)parcelType, 0); }
  ...
  public static Offset<FlatData.MinigameTBGEncounterRewardExcel> EndMinigameTBGEncounterRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.MinigameTBGEncounterRewardExcel>(o);
  }
  ...
  public void UnPackTo(MinigameTBGEncounterRewardExcelT _o) {
    ...
    _o.TBGOptionSuccessType = this.TBGOptionSuccessType;
    _o.Paremeter = this.Paremeter;
    _o.ParcelType = this.ParcelType;
    _o.ParcelId = this.ParcelId;
    _o.Amount = this.Amount;
    _o.Prob = this.Prob;
  }
  public static Offset<FlatData.MinigameTBGEncounterRewardExcel> Pack(FlatBufferBuilder builder, MinigameTBGEncounterRewardExcelT _o) {
    if (_o == null) return default(Offset<FlatData.MinigameTBGEncounterRewardExcel>);
...
public class MinigameTBGEncounterRewardExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("TBGOptionSuccessType")]
  public FlatData.TBGOptionSuccessType TBGOptionSuccessType { get; set; }
  [Newtonsoft.Json.JsonProperty("Paremeter")]
  ...
  public MinigameTBGEncounterRewardExcelT() {
    this.GroupId = 0;
    this.UniqueId = 0;
    this.TBGOptionSuccessType = FlatData.TBGOptionSuccessType.None;
    this.Paremeter = 0;
...
static public class MinigameTBGEncounterRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*TBGOptionSuccessType*/, 4 /*FlatData.TBGOptionSuccessType*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*Paremeter*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 12 /*ParcelType*/, 4 /*FlatData.ParcelType*/, 4, false)
