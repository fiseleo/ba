...
public struct CampaignChapterRewardExcel : IFlatbufferObject
{
  ...
  public FlatData.ParcelType ChapterRewardParcelType(int j) { int o = __p.__offset(8); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatData.ParcelType)0; }
  public int ChapterRewardParcelTypeLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatData.ParcelType> GetChapterRewardParcelTypeBytes() { return __p.__vector_as_span<FlatData.ParcelType>(8, 4); }
#else
  public ArraySegment<byte>? GetChapterRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(8); }
#endif
  public FlatData.ParcelType[] GetChapterRewardParcelTypeArray() { int o = __p.__offset(8); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatData.ParcelType[] a = new FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<FlatData.CampaignChapterRewardExcel> CreateCampaignChapterRewardExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static VectorOffset CreateChapterRewardParcelTypeVector(FlatBufferBuilder builder, FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateChapterRewardParcelTypeVectorBlock(FlatBufferBuilder builder, FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateChapterRewardParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatData.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateChapterRewardParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatData.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<FlatData.CampaignChapterRewardExcel> EndCampaignChapterRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.CampaignChapterRewardExcel>(o);
  }
  ...
  public void UnPackTo(CampaignChapterRewardExcelT _o) {
    _o.Id = this.Id;
    _o.CampaignChapterStar = this.CampaignChapterStar;
    _o.ChapterRewardParcelType = new List<FlatData.ParcelType>();
    for (var _j = 0; _j < this.ChapterRewardParcelTypeLength; ++_j) {_o.ChapterRewardParcelType.Add(this.ChapterRewardParcelType(_j));}
    _o.ChapterRewardId = new List<long>();
    for (var _j = 0; _j < this.ChapterRewardIdLength; ++_j) {_o.ChapterRewardId.Add(this.ChapterRewardId(_j));}
    _o.ChapterRewardAmount = new List<int>();
    for (var _j = 0; _j < this.ChapterRewardAmountLength; ++_j) {_o.ChapterRewardAmount.Add(this.ChapterRewardAmount(_j));}
  }
  public static Offset<FlatData.CampaignChapterRewardExcel> Pack(FlatBufferBuilder builder, CampaignChapterRewardExcelT _o) {
    if (_o == null) return default(Offset<FlatData.CampaignChapterRewardExcel>);
...
public class CampaignChapterRewardExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("CampaignChapterStar")]
  public long CampaignChapterStar { get; set; }
  [Newtonsoft.Json.JsonProperty("ChapterRewardParcelType")]
  public List<FlatData.ParcelType> ChapterRewardParcelType { get; set; }
  [Newtonsoft.Json.JsonProperty("ChapterRewardId")]
  public List<long> ChapterRewardId { get; set; }
  [Newtonsoft.Json.JsonProperty("ChapterRewardAmount")]
...
static public class CampaignChapterRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 8 /*ChapterRewardParcelType*/, 4 /*FlatData.ParcelType*/, false)
