...
public struct CharacterCombatSkinExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.CharacterCombatSkinExcel> CreateCharacterCombatSkinExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.CharacterCombatSkinExcel> EndCharacterCombatSkinExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.CharacterCombatSkinExcel>(o);
  }
  ...
  public static Offset<FlatData.CharacterCombatSkinExcel> Pack(FlatBufferBuilder builder, CharacterCombatSkinExcelT _o) {
    if (_o == null) return default(Offset<FlatData.CharacterCombatSkinExcel>);
