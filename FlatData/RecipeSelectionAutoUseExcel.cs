...
public struct RecipeSelectionAutoUseExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.RecipeSelectionAutoUseExcel> CreateRecipeSelectionAutoUseExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatData.RecipeSelectionAutoUseExcel> EndRecipeSelectionAutoUseExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.RecipeSelectionAutoUseExcel>(o);
  }
  ...
  public void UnPackTo(RecipeSelectionAutoUseExcelT _o) {
    ...
    _o.TargetItemId = this.TargetItemId;
    _o.Priority = new List<long>();
    for (var _j = 0; _j < this.PriorityLength; ++_j) {_o.Priority.Add(this.Priority(_j));}
  }
  public static Offset<FlatData.RecipeSelectionAutoUseExcel> Pack(FlatBufferBuilder builder, RecipeSelectionAutoUseExcelT _o) {
    if (_o == null) return default(Offset<FlatData.RecipeSelectionAutoUseExcel>);
...
public class RecipeSelectionAutoUseExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("TargetItemId")]
