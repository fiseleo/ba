...
public struct EventContentMiniEventTokenExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.EventContentMiniEventTokenExcel> CreateEventContentMiniEventTokenExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.EventContentMiniEventTokenExcel> EndEventContentMiniEventTokenExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentMiniEventTokenExcel>(o);
  }
  ...
  public void UnPackTo(EventContentMiniEventTokenExcelT _o) {
    ...
    _o.MaximumAmount = this.MaximumAmount;
  }
  public static Offset<FlatData.EventContentMiniEventTokenExcel> Pack(FlatBufferBuilder builder, EventContentMiniEventTokenExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EventContentMiniEventTokenExcel>);
...
public class EventContentMiniEventTokenExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("MaximumAmount")]
