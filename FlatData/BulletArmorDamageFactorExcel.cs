...
public struct BulletArmorDamageFactorExcel : IFlatbufferObject
{
  ...
  public FlatData.BulletType BulletType { get { int o = __p.__offset(6); return o != 0 ? (FlatData.BulletType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.BulletType.Normal; } }
  public FlatData.ArmorType ArmorType { get { int o = __p.__offset(8); return o != 0 ? (FlatData.ArmorType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ArmorType.LightArmor; } }
  public long DamageRate { get { int o = __p.__offset(10); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public FlatData.DamageAttribute DamageAttribute { get { int o = __p.__offset(12); return o != 0 ? (FlatData.DamageAttribute)__p.bb.GetInt(o + __p.bb_pos) : FlatData.DamageAttribute.Resist; } }
  ...
  public static Offset<FlatData.BulletArmorDamageFactorExcel> CreateBulletArmorDamageFactorExcel(FlatBufferBuilder builder,
      ...
      long DamageRate = 0,
      FlatData.DamageAttribute DamageAttribute = FlatData.DamageAttribute.Resist,
  ...
  public static void AddBulletType(FlatBufferBuilder builder, FlatData.BulletType bulletType) { builder.AddInt(1, (int)bulletType, 0); }
  public static void AddArmorType(FlatBufferBuilder builder, FlatData.ArmorType armorType) { builder.AddInt(2, (int)armorType, 0); }
  public static void AddDamageRate(FlatBufferBuilder builder, long damageRate) { builder.AddLong(3, damageRate, 0); }
  public static void AddDamageAttribute(FlatBufferBuilder builder, FlatData.DamageAttribute damageAttribute) { builder.AddInt(4, (int)damageAttribute, 0); }
  ...
  public static Offset<FlatData.BulletArmorDamageFactorExcel> EndBulletArmorDamageFactorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.BulletArmorDamageFactorExcel>(o);
  }
  ...
  public void UnPackTo(BulletArmorDamageFactorExcelT _o) {
    ...
    _o.DamageAttribute = this.DamageAttribute;
    _o.MinDamageRate = this.MinDamageRate;
    _o.MaxDamageRate = this.MaxDamageRate;
    _o.ShowHighlightFloater = this.ShowHighlightFloater;
  }
  public static Offset<FlatData.BulletArmorDamageFactorExcel> Pack(FlatBufferBuilder builder, BulletArmorDamageFactorExcelT _o) {
    if (_o == null) return default(Offset<FlatData.BulletArmorDamageFactorExcel>);
...
public class BulletArmorDamageFactorExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("DamageAttribute")]
  public FlatData.DamageAttribute DamageAttribute { get; set; }
  [Newtonsoft.Json.JsonProperty("MinDamageRate")]
  public long MinDamageRate { get; set; }
  [Newtonsoft.Json.JsonProperty("MaxDamageRate")]
  public long MaxDamageRate { get; set; }
  [Newtonsoft.Json.JsonProperty("ShowHighlightFloater")]
  ...
  public BulletArmorDamageFactorExcelT() {
    ...
    this.DamageRate = 0;
    this.DamageAttribute = FlatData.DamageAttribute.Resist;
...
static public class BulletArmorDamageFactorExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*BulletType*/, 4 /*FlatData.BulletType*/, 4, false)
      && verifier.VerifyField(tablePos, 8 /*ArmorType*/, 4 /*FlatData.ArmorType*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*DamageRate*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 12 /*DamageAttribute*/, 4 /*FlatData.DamageAttribute*/, 4, false)
