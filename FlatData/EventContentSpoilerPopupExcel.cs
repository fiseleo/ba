...
public struct EventContentSpoilerPopupExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.EventContentSpoilerPopupExcel> CreateEventContentSpoilerPopupExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.EventContentSpoilerPopupExcel> EndEventContentSpoilerPopupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentSpoilerPopupExcel>(o);
  }
  ...
  public static Offset<FlatData.EventContentSpoilerPopupExcel> Pack(FlatBufferBuilder builder, EventContentSpoilerPopupExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EventContentSpoilerPopupExcel>);
