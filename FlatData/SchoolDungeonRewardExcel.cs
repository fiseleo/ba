...
public struct SchoolDungeonRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.SchoolDungeonRewardExcel> Pack(FlatBufferBuilder builder, SchoolDungeonRewardExcelT _o) {
    if (_o == null) return default(Offset<FlatData.SchoolDungeonRewardExcel>);
