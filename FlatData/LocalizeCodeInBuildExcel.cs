...
public struct LocalizeCodeInBuildExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.LocalizeCodeInBuildExcel> Pack(FlatBufferBuilder builder, LocalizeCodeInBuildExcelT _o) {
    if (_o == null) return default(Offset<FlatData.LocalizeCodeInBuildExcel>);
