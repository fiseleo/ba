...
public struct FieldContentStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.FieldContentStageRewardExcel> CreateFieldContentStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<FlatData.FieldContentStageRewardExcel> EndFieldContentStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.FieldContentStageRewardExcel>(o);
  }
  ...
  public static Offset<FlatData.FieldContentStageRewardExcel> Pack(FlatBufferBuilder builder, FieldContentStageRewardExcelT _o) {
    if (_o == null) return default(Offset<FlatData.FieldContentStageRewardExcel>);
