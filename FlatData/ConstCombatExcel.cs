...
public struct ConstCombatExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.ConstCombatExcel> CreateConstCombatExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.ConstCombatExcel> EndConstCombatExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ConstCombatExcel>(o);
  }
  ...
  public void UnPackTo(ConstCombatExcelT _o) {
    _o.SkillHandCount = this.SkillHandCount;
    _o.DyingTime = this.DyingTime;
    _o.BuffIconBlinkTime = this.BuffIconBlinkTime;
    _o.ShowBufficonEXSkill = this.ShowBufficonEXSkill;
    _o.ShowBufficonPassiveSkill = this.ShowBufficonPassiveSkill;
    _o.ShowBufficonExtraPassiveSkill = this.ShowBufficonExtraPassiveSkill;
    _o.ShowBufficonLeaderSkill = this.ShowBufficonLeaderSkill;
    _o.ShowBufficonGroundPassiveSkill = this.ShowBufficonGroundPassiveSkill;
    _o.SuppliesConditionStringId = this.SuppliesConditionStringId;
    _o.PublicSpeechBubbleOffsetX = this.PublicSpeechBubbleOffsetX;
    _o.PublicSpeechBubbleOffsetY = this.PublicSpeechBubbleOffsetY;
    _o.PublicSpeechBubbleOffsetZ = this.PublicSpeechBubbleOffsetZ;
    _o.ShowRaidListCount = this.ShowRaidListCount;
    _o.MaxRaidTicketCount = this.MaxRaidTicketCount;
    _o.MaxRaidBossSkillSlot = this.MaxRaidBossSkillSlot;
    _o.EngageTimelinePath = this.EngageTimelinePath;
    _o.EngageWithSupporterTimelinePath = this.EngageWithSupporterTimelinePath;
    _o.VictoryTimelinePath = this.VictoryTimelinePath;
    _o.TimeLimitAlarm = this.TimeLimitAlarm;
    _o.EchelonMaxCommonCost = this.EchelonMaxCommonCost;
    _o.EchelonInitCommonCost = this.EchelonInitCommonCost;
    _o.SkillSlotCoolTime = this.SkillSlotCoolTime;
    _o.EnemyRegenCost = this.EnemyRegenCost;
    _o.ChampionRegenCost = this.ChampionRegenCost;
    _o.PlayerRegenCostDelay = this.PlayerRegenCostDelay;
    _o.CrowdControlFactor = this.CrowdControlFactor;
    _o.RaidOpenScenarioId = this.RaidOpenScenarioId;
    _o.EliminateRaidOpenScenarioId = this.EliminateRaidOpenScenarioId;
    _o.DefenceConstA = this.DefenceConstA;
    _o.DefenceConstB = this.DefenceConstB;
    _o.DefenceConstC = this.DefenceConstC;
    _o.DefenceConstD = this.DefenceConstD;
    _o.AccuracyConstA = this.AccuracyConstA;
    _o.AccuracyConstB = this.AccuracyConstB;
    _o.AccuracyConstC = this.AccuracyConstC;
    _o.AccuracyConstD = this.AccuracyConstD;
    _o.CriticalConstA = this.CriticalConstA;
    _o.CriticalConstB = this.CriticalConstB;
    _o.CriticalConstC = this.CriticalConstC;
    _o.CriticalConstD = this.CriticalConstD;
    _o.MaxGroupBuffLevel = this.MaxGroupBuffLevel;
    _o.EmojiDefaultTime = this.EmojiDefaultTime;
    _o.TimeLineActionRotateSpeed = this.TimeLineActionRotateSpeed;
    _o.BodyRotateSpeed = this.BodyRotateSpeed;
    _o.NormalTimeScale = this.NormalTimeScale;
    _o.FastTimeScale = this.FastTimeScale;
    _o.BulletTimeScale = this.BulletTimeScale;
    _o.UIDisplayDelayAfterSkillCutIn = this.UIDisplayDelayAfterSkillCutIn;
    _o.UseInitialRangeForCoverMove = this.UseInitialRangeForCoverMove;
    _o.SlowTimeScale = this.SlowTimeScale;
    _o.AimIKMinDegree = this.AimIKMinDegree;
    _o.AimIKMaxDegree = this.AimIKMaxDegree;
    _o.MinimumClearTime = this.MinimumClearTime;
    _o.MinimumClearLevelGap = this.MinimumClearLevelGap;
    _o.CheckCheaterMaxUseCostNonArena = this.CheckCheaterMaxUseCostNonArena;
    _o.CheckCheaterMaxUseCostArena = this.CheckCheaterMaxUseCostArena;
    _o.AllowedMaxTimeScale = this.AllowedMaxTimeScale;
    _o.RandomAnimationOutput = this.RandomAnimationOutput;
    _o.SummonedTeleportDistance = this.SummonedTeleportDistance;
    _o.ArenaMinimumClearTime = this.ArenaMinimumClearTime;
    _o.WORLDBOSSBATTLELITTLE = this.WORLDBOSSBATTLELITTLE;
    _o.WORLDBOSSBATTLEMIDDLE = this.WORLDBOSSBATTLEMIDDLE;
    _o.WORLDBOSSBATTLEHIGH = this.WORLDBOSSBATTLEHIGH;
    _o.WORLDBOSSBATTLEVERYHIGH = this.WORLDBOSSBATTLEVERYHIGH;
    _o.WorldRaidAutoSyncTermSecond = this.WorldRaidAutoSyncTermSecond;
    _o.WorldRaidBossHpDecreaseTerm = this.WorldRaidBossHpDecreaseTerm;
    _o.WorldRaidBossParcelReactionDelay = this.WorldRaidBossParcelReactionDelay;
    _o.RaidRankingJumpMinimumWaitingTime = this.RaidRankingJumpMinimumWaitingTime;
    _o.EffectTeleportDistance = this.EffectTeleportDistance;
    _o.AuraExitThresholdMargin = this.AuraExitThresholdMargin;
    _o.TSAInteractionDamageFactor = this.TSAInteractionDamageFactor;
    _o.VictoryInteractionRate = this.VictoryInteractionRate;
    _o.EchelonExtensionEngageTimelinePath = this.EchelonExtensionEngageTimelinePath;
    _o.EchelonExtensionEngageWithSupporterTimelinePath = this.EchelonExtensionEngageWithSupporterTimelinePath;
    _o.EchelonExtensionVictoryTimelinePath = this.EchelonExtensionVictoryTimelinePath;
    _o.EchelonExtensionEchelonMaxCommonCost = this.EchelonExtensionEchelonMaxCommonCost;
    _o.EchelonExtensionEchelonInitCommonCost = this.EchelonExtensionEchelonInitCommonCost;
    _o.EchelonExtensionCostRegenRatio = this.EchelonExtensionCostRegenRatio;
    _o.CheckCheaterMaxUseCostMultiFloorRaid = this.CheckCheaterMaxUseCostMultiFloorRaid;
  }
  public static Offset<FlatData.ConstCombatExcel> Pack(FlatBufferBuilder builder, ConstCombatExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ConstCombatExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("SkillHandCount")]
  public int SkillHandCount { get; set; }
  [Newtonsoft.Json.JsonProperty("DyingTime")]
  public int DyingTime { get; set; }
  [Newtonsoft.Json.JsonProperty("BuffIconBlinkTime")]
  public int BuffIconBlinkTime { get; set; }
  [Newtonsoft.Json.JsonProperty("ShowBufficonEXSkill")]
  public bool ShowBufficonEXSkill { get; set; }
  [Newtonsoft.Json.JsonProperty("ShowBufficonPassiveSkill")]
  public bool ShowBufficonPassiveSkill { get; set; }
  [Newtonsoft.Json.JsonProperty("ShowBufficonExtraPassiveSkill")]
  public bool ShowBufficonExtraPassiveSkill { get; set; }
  [Newtonsoft.Json.JsonProperty("ShowBufficonLeaderSkill")]
  public bool ShowBufficonLeaderSkill { get; set; }
  [Newtonsoft.Json.JsonProperty("ShowBufficonGroundPassiveSkill")]
  public bool ShowBufficonGroundPassiveSkill { get; set; }
  [Newtonsoft.Json.JsonProperty("SuppliesConditionStringId")]
  public string SuppliesConditionStringId { get; set; }
  [Newtonsoft.Json.JsonProperty("PublicSpeechBubbleOffsetX")]
  public float PublicSpeechBubbleOffsetX { get; set; }
  [Newtonsoft.Json.JsonProperty("PublicSpeechBubbleOffsetY")]
  public float PublicSpeechBubbleOffsetY { get; set; }
  [Newtonsoft.Json.JsonProperty("PublicSpeechBubbleOffsetZ")]
  public float PublicSpeechBubbleOffsetZ { get; set; }
  [Newtonsoft.Json.JsonProperty("ShowRaidListCount")]
  public int ShowRaidListCount { get; set; }
  [Newtonsoft.Json.JsonProperty("MaxRaidTicketCount")]
  public long MaxRaidTicketCount { get; set; }
  [Newtonsoft.Json.JsonProperty("MaxRaidBossSkillSlot")]
  public long MaxRaidBossSkillSlot { get; set; }
  [Newtonsoft.Json.JsonProperty("EngageTimelinePath")]
  public string EngageTimelinePath { get; set; }
  [Newtonsoft.Json.JsonProperty("EngageWithSupporterTimelinePath")]
  ...
  [Newtonsoft.Json.JsonProperty("TimeLimitAlarm")]
  public long TimeLimitAlarm { get; set; }
  [Newtonsoft.Json.JsonProperty("EchelonMaxCommonCost")]
  public int EchelonMaxCommonCost { get; set; }
  [Newtonsoft.Json.JsonProperty("EchelonInitCommonCost")]
  public int EchelonInitCommonCost { get; set; }
  [Newtonsoft.Json.JsonProperty("SkillSlotCoolTime")]
  public long SkillSlotCoolTime { get; set; }
  [Newtonsoft.Json.JsonProperty("EnemyRegenCost")]
  public long EnemyRegenCost { get; set; }
  [Newtonsoft.Json.JsonProperty("ChampionRegenCost")]
  public long ChampionRegenCost { get; set; }
  [Newtonsoft.Json.JsonProperty("PlayerRegenCostDelay")]
  public long PlayerRegenCostDelay { get; set; }
  [Newtonsoft.Json.JsonProperty("CrowdControlFactor")]
  public long CrowdControlFactor { get; set; }
  [Newtonsoft.Json.JsonProperty("RaidOpenScenarioId")]
  public string RaidOpenScenarioId { get; set; }
  [Newtonsoft.Json.JsonProperty("EliminateRaidOpenScenarioId")]
  public string EliminateRaidOpenScenarioId { get; set; }
  [Newtonsoft.Json.JsonProperty("DefenceConstA")]
  public long DefenceConstA { get; set; }
  [Newtonsoft.Json.JsonProperty("DefenceConstB")]
  public long DefenceConstB { get; set; }
  [Newtonsoft.Json.JsonProperty("DefenceConstC")]
  public long DefenceConstC { get; set; }
  [Newtonsoft.Json.JsonProperty("DefenceConstD")]
  public long DefenceConstD { get; set; }
  [Newtonsoft.Json.JsonProperty("AccuracyConstA")]
  public long AccuracyConstA { get; set; }
  [Newtonsoft.Json.JsonProperty("AccuracyConstB")]
  public long AccuracyConstB { get; set; }
  [Newtonsoft.Json.JsonProperty("AccuracyConstC")]
  public long AccuracyConstC { get; set; }
  [Newtonsoft.Json.JsonProperty("AccuracyConstD")]
  public long AccuracyConstD { get; set; }
  [Newtonsoft.Json.JsonProperty("CriticalConstA")]
  public long CriticalConstA { get; set; }
  [Newtonsoft.Json.JsonProperty("CriticalConstB")]
  public long CriticalConstB { get; set; }
  [Newtonsoft.Json.JsonProperty("CriticalConstC")]
  public long CriticalConstC { get; set; }
  [Newtonsoft.Json.JsonProperty("CriticalConstD")]
  public long CriticalConstD { get; set; }
  [Newtonsoft.Json.JsonProperty("MaxGroupBuffLevel")]
  public int MaxGroupBuffLevel { get; set; }
  [Newtonsoft.Json.JsonProperty("EmojiDefaultTime")]
  public int EmojiDefaultTime { get; set; }
  [Newtonsoft.Json.JsonProperty("TimeLineActionRotateSpeed")]
  public long TimeLineActionRotateSpeed { get; set; }
  [Newtonsoft.Json.JsonProperty("BodyRotateSpeed")]
  public long BodyRotateSpeed { get; set; }
  [Newtonsoft.Json.JsonProperty("NormalTimeScale")]
  public long NormalTimeScale { get; set; }
  [Newtonsoft.Json.JsonProperty("FastTimeScale")]
  public long FastTimeScale { get; set; }
  [Newtonsoft.Json.JsonProperty("BulletTimeScale")]
  public long BulletTimeScale { get; set; }
  [Newtonsoft.Json.JsonProperty("UIDisplayDelayAfterSkillCutIn")]
  public long UIDisplayDelayAfterSkillCutIn { get; set; }
  [Newtonsoft.Json.JsonProperty("UseInitialRangeForCoverMove")]
  public bool UseInitialRangeForCoverMove { get; set; }
  [Newtonsoft.Json.JsonProperty("SlowTimeScale")]
  public long SlowTimeScale { get; set; }
  [Newtonsoft.Json.JsonProperty("AimIKMinDegree")]
  public float AimIKMinDegree { get; set; }
  [Newtonsoft.Json.JsonProperty("AimIKMaxDegree")]
  public float AimIKMaxDegree { get; set; }
  [Newtonsoft.Json.JsonProperty("MinimumClearTime")]
  public int MinimumClearTime { get; set; }
  [Newtonsoft.Json.JsonProperty("MinimumClearLevelGap")]
  public int MinimumClearLevelGap { get; set; }
  [Newtonsoft.Json.JsonProperty("CheckCheaterMaxUseCostNonArena")]
  public int CheckCheaterMaxUseCostNonArena { get; set; }
  [Newtonsoft.Json.JsonProperty("CheckCheaterMaxUseCostArena")]
  public int CheckCheaterMaxUseCostArena { get; set; }
  [Newtonsoft.Json.JsonProperty("AllowedMaxTimeScale")]
  public long AllowedMaxTimeScale { get; set; }
  [Newtonsoft.Json.JsonProperty("RandomAnimationOutput")]
  public long RandomAnimationOutput { get; set; }
  [Newtonsoft.Json.JsonProperty("SummonedTeleportDistance")]
  public long SummonedTeleportDistance { get; set; }
  [Newtonsoft.Json.JsonProperty("ArenaMinimumClearTime")]
  public int ArenaMinimumClearTime { get; set; }
  [Newtonsoft.Json.JsonProperty("WORLDBOSSBATTLELITTLE")]
  public long WORLDBOSSBATTLELITTLE { get; set; }
  [Newtonsoft.Json.JsonProperty("WORLDBOSSBATTLEMIDDLE")]
  public long WORLDBOSSBATTLEMIDDLE { get; set; }
  [Newtonsoft.Json.JsonProperty("WORLDBOSSBATTLEHIGH")]
  public long WORLDBOSSBATTLEHIGH { get; set; }
  [Newtonsoft.Json.JsonProperty("WORLDBOSSBATTLEVERYHIGH")]
  public long WORLDBOSSBATTLEVERYHIGH { get; set; }
  [Newtonsoft.Json.JsonProperty("WorldRaidAutoSyncTermSecond")]
  public long WorldRaidAutoSyncTermSecond { get; set; }
  [Newtonsoft.Json.JsonProperty("WorldRaidBossHpDecreaseTerm")]
  public long WorldRaidBossHpDecreaseTerm { get; set; }
  [Newtonsoft.Json.JsonProperty("WorldRaidBossParcelReactionDelay")]
  public long WorldRaidBossParcelReactionDelay { get; set; }
  [Newtonsoft.Json.JsonProperty("RaidRankingJumpMinimumWaitingTime")]
  public long RaidRankingJumpMinimumWaitingTime { get; set; }
  [Newtonsoft.Json.JsonProperty("EffectTeleportDistance")]
  public float EffectTeleportDistance { get; set; }
  [Newtonsoft.Json.JsonProperty("AuraExitThresholdMargin")]
  public long AuraExitThresholdMargin { get; set; }
  [Newtonsoft.Json.JsonProperty("TSAInteractionDamageFactor")]
  public long TSAInteractionDamageFactor { get; set; }
  [Newtonsoft.Json.JsonProperty("VictoryInteractionRate")]
  public long VictoryInteractionRate { get; set; }
  [Newtonsoft.Json.JsonProperty("EchelonExtensionEngageTimelinePath")]
  public string EchelonExtensionEngageTimelinePath { get; set; }
  [Newtonsoft.Json.JsonProperty("EchelonExtensionEngageWithSupporterTimelinePath")]
  public string EchelonExtensionEngageWithSupporterTimelinePath { get; set; }
  [Newtonsoft.Json.JsonProperty("EchelonExtensionVictoryTimelinePath")]
  public string EchelonExtensionVictoryTimelinePath { get; set; }
  [Newtonsoft.Json.JsonProperty("EchelonExtensionEchelonMaxCommonCost")]
  public int EchelonExtensionEchelonMaxCommonCost { get; set; }
  [Newtonsoft.Json.JsonProperty("EchelonExtensionEchelonInitCommonCost")]
  public int EchelonExtensionEchelonInitCommonCost { get; set; }
  [Newtonsoft.Json.JsonProperty("EchelonExtensionCostRegenRatio")]
  public long EchelonExtensionCostRegenRatio { get; set; }
  [Newtonsoft.Json.JsonProperty("CheckCheaterMaxUseCostMultiFloorRaid")]
