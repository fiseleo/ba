...
public struct MiniGameShootingGeasExcel : IFlatbufferObject
{
  ...
  public FlatData.Geas GeasType { get { int o = __p.__offset(6); return o != 0 ? (FlatData.Geas)__p.bb.GetInt(o + __p.bb_pos) : FlatData.Geas.ForwardProjectile; } }
  ...
  public static Offset<FlatData.MiniGameShootingGeasExcel> CreateMiniGameShootingGeasExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      FlatData.Geas GeasType = FlatData.Geas.ForwardProjectile,
  ...
  public static void AddGeasType(FlatBufferBuilder builder, FlatData.Geas geasType) { builder.AddInt(1, (int)geasType, 0); }
  ...
  public static Offset<FlatData.MiniGameShootingGeasExcel> EndMiniGameShootingGeasExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.MiniGameShootingGeasExcel>(o);
  }
  ...
  public void UnPackTo(MiniGameShootingGeasExcelT _o) {
    ...
    _o.GeasType = this.GeasType;
    _o.Icon = this.Icon;
    _o.Probability = this.Probability;
    _o.MaxOverlapCount = this.MaxOverlapCount;
    _o.GeasData = this.GeasData;
    _o.NeedGeasId = this.NeedGeasId;
    _o.HideInPausePopup = this.HideInPausePopup;
  }
  public static Offset<FlatData.MiniGameShootingGeasExcel> Pack(FlatBufferBuilder builder, MiniGameShootingGeasExcelT _o) {
    if (_o == null) return default(Offset<FlatData.MiniGameShootingGeasExcel>);
...
public class MiniGameShootingGeasExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("GeasType")]
  public FlatData.Geas GeasType { get; set; }
  [Newtonsoft.Json.JsonProperty("Icon")]
  public string Icon { get; set; }
  [Newtonsoft.Json.JsonProperty("Probability")]
  public long Probability { get; set; }
  [Newtonsoft.Json.JsonProperty("MaxOverlapCount")]
  public int MaxOverlapCount { get; set; }
  [Newtonsoft.Json.JsonProperty("GeasData")]
  public string GeasData { get; set; }
  [Newtonsoft.Json.JsonProperty("NeedGeasId")]
  public long NeedGeasId { get; set; }
  [Newtonsoft.Json.JsonProperty("HideInPausePopup")]
  public bool HideInPausePopup { get; set; }

  public MiniGameShootingGeasExcelT() {
    this.UniqueId = 0;
    this.GeasType = FlatData.Geas.ForwardProjectile;
    this.Icon = null;
    this.Probability = 0;
...
static public class MiniGameShootingGeasExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*GeasType*/, 4 /*FlatData.Geas*/, 4, false)
