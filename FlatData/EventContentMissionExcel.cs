...
public struct EventContentMissionExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(EventContentMissionExcelT _o) {
    ...
    _o.IsCompleteExtensionTime = this.IsCompleteExtensionTime;
    ...
    for (var _j = 0; _j < this.CompleteConditionMissionIdLength; ++_j) {_o.CompleteConditionMissionId.Add(this.CompleteConditionMissionId(_j));}
    _o.CompleteConditionMissionCount = this.CompleteConditionMissionCount;
    ...
    _o.ConditionRewardParcelType = new List<FlatData.ParcelType>();
    for (var _j = 0; _j < this.ConditionRewardParcelTypeLength; ++_j) {_o.ConditionRewardParcelType.Add(this.ConditionRewardParcelType(_j));}
    _o.ConditionRewardParcelId = new List<long>();
    for (var _j = 0; _j < this.ConditionRewardParcelIdLength; ++_j) {_o.ConditionRewardParcelId.Add(this.ConditionRewardParcelId(_j));}
    _o.ConditionRewardAmount = new List<int>();
    for (var _j = 0; _j < this.ConditionRewardAmountLength; ++_j) {_o.ConditionRewardAmount.Add(this.ConditionRewardAmount(_j));}
  }
  public static Offset<FlatData.EventContentMissionExcel> Pack(FlatBufferBuilder builder, EventContentMissionExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EventContentMissionExcel>);
...
public class EventContentMissionExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("IsCompleteExtensionTime")]
  ...
  [Newtonsoft.Json.JsonProperty("CompleteConditionMissionId")]
  public List<long> CompleteConditionMissionId { get; set; }
  [Newtonsoft.Json.JsonProperty("CompleteConditionMissionCount")]
  ...
  [Newtonsoft.Json.JsonProperty("ConditionRewardParcelType")]
  public List<FlatData.ParcelType> ConditionRewardParcelType { get; set; }
  [Newtonsoft.Json.JsonProperty("ConditionRewardParcelId")]
  public List<long> ConditionRewardParcelId { get; set; }
  [Newtonsoft.Json.JsonProperty("ConditionRewardAmount")]
