...
public struct ShopCashScenarioResourceInfoExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.ShopCashScenarioResourceInfoExcel> CreateShopCashScenarioResourceInfoExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.ShopCashScenarioResourceInfoExcel> EndShopCashScenarioResourceInfoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ShopCashScenarioResourceInfoExcel>(o);
  }
  ...
  public void UnPackTo(ShopCashScenarioResourceInfoExcelT _o) {
    _o.ScenarioResrouceInfoId = this.ScenarioResrouceInfoId;
    _o.ShopCashId = this.ShopCashId;
    _o.IconPath = this.IconPath;
  }
  public static Offset<FlatData.ShopCashScenarioResourceInfoExcel> Pack(FlatBufferBuilder builder, ShopCashScenarioResourceInfoExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ShopCashScenarioResourceInfoExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("ScenarioResrouceInfoId")]
  public long ScenarioResrouceInfoId { get; set; }
  [Newtonsoft.Json.JsonProperty("ShopCashId")]
