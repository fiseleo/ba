...
public struct StickerPageContentExcel : IFlatbufferObject
{
  ...
  public FlatData.StickerGetConditionType StickerGetConditionType { get { int o = __p.__offset(12); return o != 0 ? (FlatData.StickerGetConditionType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.StickerGetConditionType.None; } }
  public FlatData.StickerCheckPassType StickerCheckPassType { get { int o = __p.__offset(14); return o != 0 ? (FlatData.StickerCheckPassType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.StickerCheckPassType.None; } }
  public FlatData.GetStickerConditionType GetStickerConditionType { get { int o = __p.__offset(16); return o != 0 ? (FlatData.GetStickerConditionType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.GetStickerConditionType.None; } }
  ...
  public FlatData.Tag StickerGetConditionParameterTag(int j) { int o = __p.__offset(22); return o != 0 ? (FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatData.Tag)0; }
  public int StickerGetConditionParameterTagLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatData.Tag> GetStickerGetConditionParameterTagBytes() { return __p.__vector_as_span<FlatData.Tag>(22, 4); }
#else
  public ArraySegment<byte>? GetStickerGetConditionParameterTagBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public FlatData.Tag[] GetStickerGetConditionParameterTagArray() { int o = __p.__offset(22); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatData.Tag[] a = new FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<FlatData.StickerPageContentExcel> CreateStickerPageContentExcel(FlatBufferBuilder builder,
      long Id = 0,
      long StickerGroupId = 0,
      long StickerPageId = 0,
      long StickerSlot = 0,
      FlatData.StickerGetConditionType StickerGetConditionType = FlatData.StickerGetConditionType.None,
      FlatData.StickerCheckPassType StickerCheckPassType = FlatData.StickerCheckPassType.None,
      FlatData.GetStickerConditionType GetStickerConditionType = FlatData.GetStickerConditionType.None,
  ...
  public static void AddStickerGetConditionType(FlatBufferBuilder builder, FlatData.StickerGetConditionType stickerGetConditionType) { builder.AddInt(4, (int)stickerGetConditionType, 0); }
  public static void AddStickerCheckPassType(FlatBufferBuilder builder, FlatData.StickerCheckPassType stickerCheckPassType) { builder.AddInt(5, (int)stickerCheckPassType, 0); }
  public static void AddGetStickerConditionType(FlatBufferBuilder builder, FlatData.GetStickerConditionType getStickerConditionType) { builder.AddInt(6, (int)getStickerConditionType, 0); }
  ...
  public static VectorOffset CreateStickerGetConditionParameterTagVector(FlatBufferBuilder builder, FlatData.Tag[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateStickerGetConditionParameterTagVectorBlock(FlatBufferBuilder builder, FlatData.Tag[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStickerGetConditionParameterTagVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatData.Tag> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStickerGetConditionParameterTagVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatData.Tag>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<FlatData.StickerPageContentExcel> EndStickerPageContentExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.StickerPageContentExcel>(o);
  }
  ...
  public void UnPackTo(StickerPageContentExcelT _o) {
    _o.Id = this.Id;
    _o.StickerGroupId = this.StickerGroupId;
    _o.StickerPageId = this.StickerPageId;
    _o.StickerSlot = this.StickerSlot;
    _o.StickerGetConditionType = this.StickerGetConditionType;
    _o.StickerCheckPassType = this.StickerCheckPassType;
    _o.GetStickerConditionType = this.GetStickerConditionType;
    _o.StickerGetConditionCount = this.StickerGetConditionCount;
    _o.StickerGetConditionParameter = new List<long>();
    for (var _j = 0; _j < this.StickerGetConditionParameterLength; ++_j) {_o.StickerGetConditionParameter.Add(this.StickerGetConditionParameter(_j));}
    _o.StickerGetConditionParameterTag = new List<FlatData.Tag>();
    for (var _j = 0; _j < this.StickerGetConditionParameterTagLength; ++_j) {_o.StickerGetConditionParameterTag.Add(this.StickerGetConditionParameterTag(_j));}
    _o.PackedStickerIconLocalizeEtcId = this.PackedStickerIconLocalizeEtcId;
    _o.PackedStickerIconPath = this.PackedStickerIconPath;
    _o.IconPath = this.IconPath;
    _o.StickerDetailPath = this.StickerDetailPath;
  }
  public static Offset<FlatData.StickerPageContentExcel> Pack(FlatBufferBuilder builder, StickerPageContentExcelT _o) {
    if (_o == null) return default(Offset<FlatData.StickerPageContentExcel>);
...
public class StickerPageContentExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("StickerGroupId")]
  public long StickerGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("StickerPageId")]
  public long StickerPageId { get; set; }
  [Newtonsoft.Json.JsonProperty("StickerSlot")]
  public long StickerSlot { get; set; }
  [Newtonsoft.Json.JsonProperty("StickerGetConditionType")]
  public FlatData.StickerGetConditionType StickerGetConditionType { get; set; }
  [Newtonsoft.Json.JsonProperty("StickerCheckPassType")]
  public FlatData.StickerCheckPassType StickerCheckPassType { get; set; }
  [Newtonsoft.Json.JsonProperty("GetStickerConditionType")]
  public FlatData.GetStickerConditionType GetStickerConditionType { get; set; }
  [Newtonsoft.Json.JsonProperty("StickerGetConditionCount")]
  public long StickerGetConditionCount { get; set; }
  [Newtonsoft.Json.JsonProperty("StickerGetConditionParameter")]
  public List<long> StickerGetConditionParameter { get; set; }
  [Newtonsoft.Json.JsonProperty("StickerGetConditionParameterTag")]
  public List<FlatData.Tag> StickerGetConditionParameterTag { get; set; }
  [Newtonsoft.Json.JsonProperty("PackedStickerIconLocalizeEtcId")]
  public uint PackedStickerIconLocalizeEtcId { get; set; }
  [Newtonsoft.Json.JsonProperty("PackedStickerIconPath")]
  public string PackedStickerIconPath { get; set; }
  [Newtonsoft.Json.JsonProperty("IconPath")]
  public string IconPath { get; set; }
  [Newtonsoft.Json.JsonProperty("StickerDetailPath")]
  ...
  public StickerPageContentExcelT() {
    ...
    this.StickerSlot = 0;
    this.StickerGetConditionType = FlatData.StickerGetConditionType.None;
    this.StickerCheckPassType = FlatData.StickerCheckPassType.None;
    this.GetStickerConditionType = FlatData.GetStickerConditionType.None;
...
static public class StickerPageContentExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*StickerGetConditionType*/, 4 /*FlatData.StickerGetConditionType*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*StickerCheckPassType*/, 4 /*FlatData.StickerCheckPassType*/, 4, false)
      && verifier.VerifyField(tablePos, 16 /*GetStickerConditionType*/, 4 /*FlatData.GetStickerConditionType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 22 /*StickerGetConditionParameterTag*/, 4 /*FlatData.Tag*/, false)
