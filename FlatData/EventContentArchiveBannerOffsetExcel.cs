...
public struct EventContentArchiveBannerOffsetExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.EventContentArchiveBannerOffsetExcel> CreateEventContentArchiveBannerOffsetExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.EventContentArchiveBannerOffsetExcel> EndEventContentArchiveBannerOffsetExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentArchiveBannerOffsetExcel>(o);
  }
  ...
  public static Offset<FlatData.EventContentArchiveBannerOffsetExcel> Pack(FlatBufferBuilder builder, EventContentArchiveBannerOffsetExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EventContentArchiveBannerOffsetExcel>);
...
public class EventContentArchiveBannerOffsetExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("OffsetX")]
