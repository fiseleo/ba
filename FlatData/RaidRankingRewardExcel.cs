...
public struct RaidRankingRewardExcel : IFlatbufferObject
{
  ...
  public FlatData.ParcelType RewardParcelType(int j) { int o = __p.__offset(18); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatData.ParcelType)0; }
  public int RewardParcelTypeLength { get { int o = __p.__offset(18); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatData.ParcelType> GetRewardParcelTypeBytes() { return __p.__vector_as_span<FlatData.ParcelType>(18, 4); }
#else
  public ArraySegment<byte>? GetRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(18); }
#endif
  public FlatData.ParcelType[] GetRewardParcelTypeArray() { int o = __p.__offset(18); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatData.ParcelType[] a = new FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<FlatData.RaidRankingRewardExcel> CreateRaidRankingRewardExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.RaidRankingRewardExcel> EndRaidRankingRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.RaidRankingRewardExcel>(o);
  }
  ...
  public void UnPackTo(RaidRankingRewardExcelT _o) {
    ...
    _o.Id = this.Id;
    _o.RankStart = this.RankStart;
    _o.RankEnd = this.RankEnd;
    _o.PercentRankStart = this.PercentRankStart;
    _o.PercentRankEnd = this.PercentRankEnd;
    _o.Tier = this.Tier;
    ...
    for (var _j = 0; _j < this.RewardParcelUniqueIdLength; ++_j) {_o.RewardParcelUniqueId.Add(this.RewardParcelUniqueId(_j));}
    _o.RewardParcelUniqueName = new List<string>();
    for (var _j = 0; _j < this.RewardParcelUniqueNameLength; ++_j) {_o.RewardParcelUniqueName.Add(this.RewardParcelUniqueName(_j));}
  ...
  public static Offset<FlatData.RaidRankingRewardExcel> Pack(FlatBufferBuilder builder, RaidRankingRewardExcelT _o) {
    if (_o == null) return default(Offset<FlatData.RaidRankingRewardExcel>);
...
public class RaidRankingRewardExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("RankStart")]
  public long RankStart { get; set; }
  [Newtonsoft.Json.JsonProperty("RankEnd")]
  public long RankEnd { get; set; }
  [Newtonsoft.Json.JsonProperty("PercentRankStart")]
  public long PercentRankStart { get; set; }
  [Newtonsoft.Json.JsonProperty("PercentRankEnd")]
  ...
  [Newtonsoft.Json.JsonProperty("RewardParcelUniqueId")]
  public List<long> RewardParcelUniqueId { get; set; }
  [Newtonsoft.Json.JsonProperty("RewardParcelUniqueName")]
...
static public class RaidRankingRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 18 /*RewardParcelType*/, 4 /*FlatData.ParcelType*/, false)
