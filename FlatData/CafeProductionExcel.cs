...
public struct CafeProductionExcel : IFlatbufferObject
{
  ...
  public FlatData.ParcelType CafeProductionParcelType { get { int o = __p.__offset(8); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ParcelType.None; } }
  ...
  public static Offset<FlatData.CafeProductionExcel> CreateCafeProductionExcel(FlatBufferBuilder builder,
      long CafeId = 0,
      long Rank = 0,
      FlatData.ParcelType CafeProductionParcelType = FlatData.ParcelType.None,
  ...
  public static void AddCafeProductionParcelType(FlatBufferBuilder builder, FlatData.ParcelType cafeProductionParcelType) { builder.AddInt(2, (int)cafeProductionParcelType, 0); }
  ...
  public static Offset<FlatData.CafeProductionExcel> EndCafeProductionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.CafeProductionExcel>(o);
  }
  ...
  public void UnPackTo(CafeProductionExcelT _o) {
    ...
    _o.Rank = this.Rank;
    _o.CafeProductionParcelType = this.CafeProductionParcelType;
    _o.CafeProductionParcelId = this.CafeProductionParcelId;
    _o.ParcelProductionCoefficient = this.ParcelProductionCoefficient;
    _o.ParcelProductionCorrectionValue = this.ParcelProductionCorrectionValue;
    _o.ParcelStorageMax = this.ParcelStorageMax;
  }
  public static Offset<FlatData.CafeProductionExcel> Pack(FlatBufferBuilder builder, CafeProductionExcelT _o) {
    if (_o == null) return default(Offset<FlatData.CafeProductionExcel>);
...
public class CafeProductionExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("CafeProductionParcelType")]
  public FlatData.ParcelType CafeProductionParcelType { get; set; }
  [Newtonsoft.Json.JsonProperty("CafeProductionParcelId")]
  public long CafeProductionParcelId { get; set; }
  [Newtonsoft.Json.JsonProperty("ParcelProductionCoefficient")]
  public long ParcelProductionCoefficient { get; set; }
  [Newtonsoft.Json.JsonProperty("ParcelProductionCorrectionValue")]
  public long ParcelProductionCorrectionValue { get; set; }
  [Newtonsoft.Json.JsonProperty("ParcelStorageMax")]
  public long ParcelStorageMax { get; set; }

  public CafeProductionExcelT() {
    this.CafeId = 0;
    this.Rank = 0;
    this.CafeProductionParcelType = FlatData.ParcelType.None;
...
static public class CafeProductionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*CafeProductionParcelType*/, 4 /*FlatData.ParcelType*/, 4, false)
