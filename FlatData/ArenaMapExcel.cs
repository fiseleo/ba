...
public struct ArenaMapExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.ArenaMapExcel> CreateArenaMapExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      long TerrainType = 0,
  ...
  public static Offset<FlatData.ArenaMapExcel> EndArenaMapExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ArenaMapExcel>(o);
  }
  ...
  public void UnPackTo(ArenaMapExcelT _o) {
    ...
    _o.TerrainType = this.TerrainType;
    _o.TerrainTypeLocalizeKey = this.TerrainTypeLocalizeKey;
    _o.ImagePath = this.ImagePath;
    _o.GroundGroupId = this.GroundGroupId;
    _o.GroundGroupNameLocalizeKey = this.GroundGroupNameLocalizeKey;
    _o.StartRank = this.StartRank;
    _o.EndRank = this.EndRank;
    _o.GroundId = this.GroundId;
  }
  public static Offset<FlatData.ArenaMapExcel> Pack(FlatBufferBuilder builder, ArenaMapExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ArenaMapExcel>);
...
public class ArenaMapExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("TerrainType")]
  public long TerrainType { get; set; }
  [Newtonsoft.Json.JsonProperty("TerrainTypeLocalizeKey")]
  public string TerrainTypeLocalizeKey { get; set; }
  [Newtonsoft.Json.JsonProperty("ImagePath")]
  public string ImagePath { get; set; }
  [Newtonsoft.Json.JsonProperty("GroundGroupId")]
  public long GroundGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("GroundGroupNameLocalizeKey")]
  public string GroundGroupNameLocalizeKey { get; set; }
  [Newtonsoft.Json.JsonProperty("StartRank")]
  public long StartRank { get; set; }
  [Newtonsoft.Json.JsonProperty("EndRank")]
