...
public struct TacticTimeAttackSimulatorConfigExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.TacticTimeAttackSimulatorConfigExcel> CreateTacticTimeAttackSimulatorConfigExcel(FlatBufferBuilder builder,
      long Order = 0,
      long Repeat = 0,
  ...
  public static Offset<FlatData.TacticTimeAttackSimulatorConfigExcel> EndTacticTimeAttackSimulatorConfigExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.TacticTimeAttackSimulatorConfigExcel>(o);
  }
  ...
  public void UnPackTo(TacticTimeAttackSimulatorConfigExcelT _o) {
    ...
    _o.PresetGroupId = this.PresetGroupId;
    _o.AttackStrikerNum = this.AttackStrikerNum;
    _o.AttackSpecialNum = this.AttackSpecialNum;
    _o.GeasId = this.GeasId;
  }
  public static Offset<FlatData.TacticTimeAttackSimulatorConfigExcel> Pack(FlatBufferBuilder builder, TacticTimeAttackSimulatorConfigExcelT _o) {
    if (_o == null) return default(Offset<FlatData.TacticTimeAttackSimulatorConfigExcel>);
...
public class TacticTimeAttackSimulatorConfigExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("PresetGroupId")]
  public long PresetGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("AttackStrikerNum")]
  public long AttackStrikerNum { get; set; }
  [Newtonsoft.Json.JsonProperty("AttackSpecialNum")]
  public long AttackSpecialNum { get; set; }
  [Newtonsoft.Json.JsonProperty("GeasId")]
