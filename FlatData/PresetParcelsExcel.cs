...
public struct PresetParcelsExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.PresetParcelsExcel> CreatePresetParcelsExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.PresetParcelsExcel> EndPresetParcelsExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.PresetParcelsExcel>(o);
  }
  ...
  public static Offset<FlatData.PresetParcelsExcel> Pack(FlatBufferBuilder builder, PresetParcelsExcelT _o) {
    if (_o == null) return default(Offset<FlatData.PresetParcelsExcel>);
