...
public struct DefaultEchelonExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.DefaultEchelonExcel> CreateDefaultEchelonExcel(FlatBufferBuilder builder,
      int EchlonId = 0,
      long LeaderId = 0,
  ...
  public static Offset<FlatData.DefaultEchelonExcel> EndDefaultEchelonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.DefaultEchelonExcel>(o);
  }
  ...
  public void UnPackTo(DefaultEchelonExcelT _o) {
    _o.EchlonId = this.EchlonId;
    _o.LeaderId = this.LeaderId;
    _o.MainId = new List<long>();
    for (var _j = 0; _j < this.MainIdLength; ++_j) {_o.MainId.Add(this.MainId(_j));}
    _o.SupportId = new List<long>();
    for (var _j = 0; _j < this.SupportIdLength; ++_j) {_o.SupportId.Add(this.SupportId(_j));}
    _o.TssId = this.TssId;
  }
  public static Offset<FlatData.DefaultEchelonExcel> Pack(FlatBufferBuilder builder, DefaultEchelonExcelT _o) {
    if (_o == null) return default(Offset<FlatData.DefaultEchelonExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("EchlonId")]
  public int EchlonId { get; set; }
  [Newtonsoft.Json.JsonProperty("LeaderId")]
  public long LeaderId { get; set; }
  [Newtonsoft.Json.JsonProperty("MainId")]
  public List<long> MainId { get; set; }
  [Newtonsoft.Json.JsonProperty("SupportId")]
  public List<long> SupportId { get; set; }
  [Newtonsoft.Json.JsonProperty("TssId")]
