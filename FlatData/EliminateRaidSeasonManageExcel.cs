...
public struct EliminateRaidSeasonManageExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.EliminateRaidSeasonManageExcel> CreateEliminateRaidSeasonManageExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
  ...
  public static Offset<FlatData.EliminateRaidSeasonManageExcel> EndEliminateRaidSeasonManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EliminateRaidSeasonManageExcel>(o);
  }
  ...
  public void UnPackTo(EliminateRaidSeasonManageExcelT _o) {
    ...
    _o.SeasonDisplay = this.SeasonDisplay;
    _o.SeasonStartData = this.SeasonStartData;
    _o.SeasonEndData = this.SeasonEndData;
    _o.SettlementEndDate = this.SettlementEndDate;
    _o.LobbyTableBGPath = this.LobbyTableBGPath;
    _o.LobbyScreenBGPath = this.LobbyScreenBGPath;
    _o.OpenRaidBossGroup01 = this.OpenRaidBossGroup01;
    _o.OpenRaidBossGroup02 = this.OpenRaidBossGroup02;
    _o.OpenRaidBossGroup03 = this.OpenRaidBossGroup03;
    _o.RankingRewardGroupId = this.RankingRewardGroupId;
    _o.MaxSeasonRewardGauage = this.MaxSeasonRewardGauage;
    _o.StackedSeasonRewardGauge = new List<long>();
    for (var _j = 0; _j < this.StackedSeasonRewardGaugeLength; ++_j) {_o.StackedSeasonRewardGauge.Add(this.StackedSeasonRewardGauge(_j));}
    _o.SeasonRewardId = new List<long>();
    for (var _j = 0; _j < this.SeasonRewardIdLength; ++_j) {_o.SeasonRewardId.Add(this.SeasonRewardId(_j));}
    _o.LimitedRewardIdNormal = this.LimitedRewardIdNormal;
    _o.LimitedRewardIdHard = this.LimitedRewardIdHard;
    _o.LimitedRewardIdVeryhard = this.LimitedRewardIdVeryhard;
    _o.LimitedRewardIdHardcore = this.LimitedRewardIdHardcore;
    _o.LimitedRewardIdExtreme = this.LimitedRewardIdExtreme;
    _o.LimitedRewardIdInsane = this.LimitedRewardIdInsane;
    _o.LimitedRewardIdTorment = this.LimitedRewardIdTorment;
  }
  public static Offset<FlatData.EliminateRaidSeasonManageExcel> Pack(FlatBufferBuilder builder, EliminateRaidSeasonManageExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EliminateRaidSeasonManageExcel>);
...
public class EliminateRaidSeasonManageExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("SeasonDisplay")]
  public long SeasonDisplay { get; set; }
  [Newtonsoft.Json.JsonProperty("SeasonStartData")]
  public string SeasonStartData { get; set; }
  [Newtonsoft.Json.JsonProperty("SeasonEndData")]
  public string SeasonEndData { get; set; }
  [Newtonsoft.Json.JsonProperty("SettlementEndDate")]
  public string SettlementEndDate { get; set; }
  [Newtonsoft.Json.JsonProperty("LobbyTableBGPath")]
  public string LobbyTableBGPath { get; set; }
  [Newtonsoft.Json.JsonProperty("LobbyScreenBGPath")]
  public string LobbyScreenBGPath { get; set; }
  [Newtonsoft.Json.JsonProperty("OpenRaidBossGroup01")]
  public string OpenRaidBossGroup01 { get; set; }
  [Newtonsoft.Json.JsonProperty("OpenRaidBossGroup02")]
  public string OpenRaidBossGroup02 { get; set; }
  [Newtonsoft.Json.JsonProperty("OpenRaidBossGroup03")]
  public string OpenRaidBossGroup03 { get; set; }
  [Newtonsoft.Json.JsonProperty("RankingRewardGroupId")]
  public long RankingRewardGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("MaxSeasonRewardGauage")]
  public int MaxSeasonRewardGauage { get; set; }
  [Newtonsoft.Json.JsonProperty("StackedSeasonRewardGauge")]
  ...
  [Newtonsoft.Json.JsonProperty("LimitedRewardIdNormal")]
  public long LimitedRewardIdNormal { get; set; }
  [Newtonsoft.Json.JsonProperty("LimitedRewardIdHard")]
  public long LimitedRewardIdHard { get; set; }
  [Newtonsoft.Json.JsonProperty("LimitedRewardIdVeryhard")]
  public long LimitedRewardIdVeryhard { get; set; }
  [Newtonsoft.Json.JsonProperty("LimitedRewardIdHardcore")]
  public long LimitedRewardIdHardcore { get; set; }
  [Newtonsoft.Json.JsonProperty("LimitedRewardIdExtreme")]
  public long LimitedRewardIdExtreme { get; set; }
  [Newtonsoft.Json.JsonProperty("LimitedRewardIdInsane")]
  public long LimitedRewardIdInsane { get; set; }
  [Newtonsoft.Json.JsonProperty("LimitedRewardIdTorment")]
