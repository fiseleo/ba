...
public struct EventContentBoxGachaManageExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.EventContentBoxGachaManageExcel> CreateEventContentBoxGachaManageExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.EventContentBoxGachaManageExcel> EndEventContentBoxGachaManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentBoxGachaManageExcel>(o);
  }
  ...
  public static Offset<FlatData.EventContentBoxGachaManageExcel> Pack(FlatBufferBuilder builder, EventContentBoxGachaManageExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EventContentBoxGachaManageExcel>);
