...
public struct SpecialLobbyIllustExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.SpecialLobbyIllustExcel> CreateSpecialLobbyIllustExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<FlatData.SpecialLobbyIllustExcel> EndSpecialLobbyIllustExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.SpecialLobbyIllustExcel>(o);
  }
  ...
  public void UnPackTo(SpecialLobbyIllustExcelT _o) {
    ...
    _o.CharacterCostumeUniqueId = this.CharacterCostumeUniqueId;
    _o.PrefabName = this.PrefabName;
    _o.SlotTextureName = this.SlotTextureName;
    _o.RewardTextureName = this.RewardTextureName;
  }
  public static Offset<FlatData.SpecialLobbyIllustExcel> Pack(FlatBufferBuilder builder, SpecialLobbyIllustExcelT _o) {
    if (_o == null) return default(Offset<FlatData.SpecialLobbyIllustExcel>);
...
public class SpecialLobbyIllustExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("CharacterCostumeUniqueId")]
  public long CharacterCostumeUniqueId { get; set; }
  [Newtonsoft.Json.JsonProperty("PrefabName")]
  public string PrefabName { get; set; }
  [Newtonsoft.Json.JsonProperty("SlotTextureName")]
  public string SlotTextureName { get; set; }
  [Newtonsoft.Json.JsonProperty("RewardTextureName")]
