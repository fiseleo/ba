...
public struct BuffParticleExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.BuffParticleExcel> CreateBuffParticleExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<FlatData.BuffParticleExcel> EndBuffParticleExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.BuffParticleExcel>(o);
  }
  ...
  public void UnPackTo(BuffParticleExcelT _o) {
    ...
    _o.UniqueName = this.UniqueName;
    _o.BuffType = this.BuffType;
    _o.BuffName = this.BuffName;
    _o.ResourcePath = this.ResourcePath;
  }
  public static Offset<FlatData.BuffParticleExcel> Pack(FlatBufferBuilder builder, BuffParticleExcelT _o) {
    if (_o == null) return default(Offset<FlatData.BuffParticleExcel>);
...
public class BuffParticleExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("UniqueName")]
  public string UniqueName { get; set; }
  [Newtonsoft.Json.JsonProperty("BuffType")]
  public string BuffType { get; set; }
  [Newtonsoft.Json.JsonProperty("BuffName")]
  public string BuffName { get; set; }
  [Newtonsoft.Json.JsonProperty("ResourcePath")]
