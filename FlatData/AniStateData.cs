...
public struct AniStateData : IFlatbufferObject
{
  ...
  public FlatData.AniEventData? Events(int j) { int o = __p.__offset(26); return o != 0 ? (FlatData.AniEventData?)(new FlatData.AniEventData()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int EventsLength { get { int o = __p.__offset(26); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<FlatData.AniStateData> CreateAniStateData(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateEventsVector(FlatBufferBuilder builder, Offset<FlatData.AniEventData>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateEventsVectorBlock(FlatBufferBuilder builder, Offset<FlatData.AniEventData>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEventsVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<FlatData.AniEventData>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEventsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<FlatData.AniEventData>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartEventsVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<FlatData.AniStateData> EndAniStateData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.AniStateData>(o);
  }
  ...
  public void UnPackTo(AniStateDataT _o) {
    ...
    _o.StatePrefix = this.StatePrefix;
    _o.StateNameWithPrefix = this.StateNameWithPrefix;
    _o.Tag = this.Tag;
    _o.SpeedParameterName = this.SpeedParameterName;
    _o.SpeedParamter = this.SpeedParamter;
    _o.StateSpeed = this.StateSpeed;
    _o.ClipName = this.ClipName;
    _o.Length = this.Length;
    _o.FrameRate = this.FrameRate;
    _o.IsLooping = this.IsLooping;
    _o.Events = new List<FlatData.AniEventDataT>();
    for (var _j = 0; _j < this.EventsLength; ++_j) {_o.Events.Add(this.Events(_j).HasValue ? this.Events(_j).Value.UnPack() : null);}
  }
  public static Offset<FlatData.AniStateData> Pack(FlatBufferBuilder builder, AniStateDataT _o) {
    if (_o == null) return default(Offset<FlatData.AniStateData>);
    ...
    if (_o.Events != null) {
      var __Events = new Offset<FlatData.AniEventData>[_o.Events.Count];
      for (var _j = 0; _j < __Events.Length; ++_j) { __Events[_j] = FlatData.AniEventData.Pack(builder, _o.Events[_j]); }
...
public class AniStateDataT
{
  ...
  [Newtonsoft.Json.JsonProperty("StatePrefix")]
  public string StatePrefix { get; set; }
  [Newtonsoft.Json.JsonProperty("StateNameWithPrefix")]
  ...
  [Newtonsoft.Json.JsonProperty("SpeedParamter")]
  public float SpeedParamter { get; set; }
  [Newtonsoft.Json.JsonProperty("StateSpeed")]
  public float StateSpeed { get; set; }
  [Newtonsoft.Json.JsonProperty("ClipName")]
  public string ClipName { get; set; }
  [Newtonsoft.Json.JsonProperty("Length")]
  public float Length { get; set; }
  [Newtonsoft.Json.JsonProperty("FrameRate")]
  public float FrameRate { get; set; }
  [Newtonsoft.Json.JsonProperty("IsLooping")]
  public bool IsLooping { get; set; }
  [Newtonsoft.Json.JsonProperty("Events")]
  public List<FlatData.AniEventDataT> Events { get; set; }
...
static public class AniStateDataVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfTables(tablePos, 26 /*Events*/, FlatData.AniEventDataVerify.Verify, false)
