...
public struct FurnitureGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.FurnitureGroupExcel> CreateFurnitureGroupExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatData.FurnitureGroupExcel> EndFurnitureGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.FurnitureGroupExcel>(o);
  }
  ...
  public void UnPackTo(FurnitureGroupExcelT _o) {
    _o.Id = this.Id;
    _o.GroupNameLocalize = this.GroupNameLocalize;
    _o.LocalizeEtcId = this.LocalizeEtcId;
    _o.RequiredFurnitureCount = new List<int>();
    for (var _j = 0; _j < this.RequiredFurnitureCountLength; ++_j) {_o.RequiredFurnitureCount.Add(this.RequiredFurnitureCount(_j));}
    _o.ComfortBonus = new List<long>();
    for (var _j = 0; _j < this.ComfortBonusLength; ++_j) {_o.ComfortBonus.Add(this.ComfortBonus(_j));}
  }
  public static Offset<FlatData.FurnitureGroupExcel> Pack(FlatBufferBuilder builder, FurnitureGroupExcelT _o) {
    if (_o == null) return default(Offset<FlatData.FurnitureGroupExcel>);
...
public class FurnitureGroupExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("GroupNameLocalize")]
  public uint GroupNameLocalize { get; set; }
  [Newtonsoft.Json.JsonProperty("LocalizeEtcId")]
  public uint LocalizeEtcId { get; set; }
  [Newtonsoft.Json.JsonProperty("RequiredFurnitureCount")]
