...
public struct GuideMissionOpenStageConditionExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.GuideMissionOpenStageConditionExcel> CreateGuideMissionOpenStageConditionExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
      long OrderNumber = 0,
  ...
  public static Offset<FlatData.GuideMissionOpenStageConditionExcel> EndGuideMissionOpenStageConditionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.GuideMissionOpenStageConditionExcel>(o);
  }
  ...
  public void UnPackTo(GuideMissionOpenStageConditionExcelT _o) {
    ...
    _o.OrderNumber = this.OrderNumber;
    _o.TabLocalizeCode = this.TabLocalizeCode;
    _o.ClearScenarioModeId = this.ClearScenarioModeId;
    _o.LockScenarioTextLocailzeCode = this.LockScenarioTextLocailzeCode;
    _o.ShortcutScenarioUI = this.ShortcutScenarioUI;
    _o.ClearStageId = this.ClearStageId;
    _o.LockStageTextLocailzeCode = this.LockStageTextLocailzeCode;
    _o.ShortcutStageUI = this.ShortcutStageUI;
  }
  public static Offset<FlatData.GuideMissionOpenStageConditionExcel> Pack(FlatBufferBuilder builder, GuideMissionOpenStageConditionExcelT _o) {
    if (_o == null) return default(Offset<FlatData.GuideMissionOpenStageConditionExcel>);
...
public class GuideMissionOpenStageConditionExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("TabLocalizeCode")]
  public string TabLocalizeCode { get; set; }
  [Newtonsoft.Json.JsonProperty("ClearScenarioModeId")]
  public long ClearScenarioModeId { get; set; }
  [Newtonsoft.Json.JsonProperty("LockScenarioTextLocailzeCode")]
  public string LockScenarioTextLocailzeCode { get; set; }
  [Newtonsoft.Json.JsonProperty("ShortcutScenarioUI")]
  public string ShortcutScenarioUI { get; set; }
  [Newtonsoft.Json.JsonProperty("ClearStageId")]
  public long ClearStageId { get; set; }
  [Newtonsoft.Json.JsonProperty("LockStageTextLocailzeCode")]
  public string LockStageTextLocailzeCode { get; set; }
  [Newtonsoft.Json.JsonProperty("ShortcutStageUI")]
