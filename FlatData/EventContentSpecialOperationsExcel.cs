...
public struct EventContentSpecialOperationsExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.EventContentSpecialOperationsExcel> CreateEventContentSpecialOperationsExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.EventContentSpecialOperationsExcel> EndEventContentSpecialOperationsExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentSpecialOperationsExcel>(o);
  }
  ...
  public static Offset<FlatData.EventContentSpecialOperationsExcel> Pack(FlatBufferBuilder builder, EventContentSpecialOperationsExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EventContentSpecialOperationsExcel>);
...
public class EventContentSpecialOperationsExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("PointItemId")]
