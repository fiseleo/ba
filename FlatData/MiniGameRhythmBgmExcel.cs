...
public struct MiniGameRhythmBgmExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.MiniGameRhythmBgmExcel> CreateMiniGameRhythmBgmExcel(FlatBufferBuilder builder,
      long RhythmBgmId = 0,
  ...
  public static Offset<FlatData.MiniGameRhythmBgmExcel> EndMiniGameRhythmBgmExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.MiniGameRhythmBgmExcel>(o);
  }
  ...
  public void UnPackTo(MiniGameRhythmBgmExcelT _o) {
    ...
    _o.StageSelectImagePath = this.StageSelectImagePath;
    _o.Bpm = this.Bpm;
    _o.Bgm = this.Bgm;
    _o.BgmNameText = this.BgmNameText;
    _o.BgmArtistText = this.BgmArtistText;
    _o.HasLyricist = this.HasLyricist;
    _o.BgmComposerText = this.BgmComposerText;
    _o.BgmLength = this.BgmLength;
  }
  public static Offset<FlatData.MiniGameRhythmBgmExcel> Pack(FlatBufferBuilder builder, MiniGameRhythmBgmExcelT _o) {
    if (_o == null) return default(Offset<FlatData.MiniGameRhythmBgmExcel>);
...
public class MiniGameRhythmBgmExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("StageSelectImagePath")]
  public string StageSelectImagePath { get; set; }
  [Newtonsoft.Json.JsonProperty("Bpm")]
  public long Bpm { get; set; }
  [Newtonsoft.Json.JsonProperty("Bgm")]
  public long Bgm { get; set; }
  [Newtonsoft.Json.JsonProperty("BgmNameText")]
  public string BgmNameText { get; set; }
  [Newtonsoft.Json.JsonProperty("BgmArtistText")]
  public string BgmArtistText { get; set; }
  [Newtonsoft.Json.JsonProperty("HasLyricist")]
  public bool HasLyricist { get; set; }
  [Newtonsoft.Json.JsonProperty("BgmComposerText")]
  public string BgmComposerText { get; set; }
  [Newtonsoft.Json.JsonProperty("BgmLength")]
