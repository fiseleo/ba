...
public struct ConquestPlayGuideExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.ConquestPlayGuideExcel> CreateConquestPlayGuideExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatData.ConquestPlayGuideExcel> EndConquestPlayGuideExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ConquestPlayGuideExcel>(o);
  }
  ...
  public static Offset<FlatData.ConquestPlayGuideExcel> Pack(FlatBufferBuilder builder, ConquestPlayGuideExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ConquestPlayGuideExcel>);
