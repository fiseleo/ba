...
public struct ConquestGroupBuffExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.ConquestGroupBuffExcel> CreateConquestGroupBuffExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.ConquestGroupBuffExcel> EndConquestGroupBuffExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ConquestGroupBuffExcel>(o);
  }
  ...
  public void UnPackTo(ConquestGroupBuffExcelT _o) {
    _o.ConquestBuffId = this.ConquestBuffId;
  ...
  public static Offset<FlatData.ConquestGroupBuffExcel> Pack(FlatBufferBuilder builder, ConquestGroupBuffExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ConquestGroupBuffExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("ConquestBuffId")]
