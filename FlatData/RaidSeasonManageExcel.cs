...
public struct RaidSeasonManageExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.RaidSeasonManageExcel> CreateRaidSeasonManageExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
  ...
  public static Offset<FlatData.RaidSeasonManageExcel> EndRaidSeasonManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.RaidSeasonManageExcel>(o);
  }
  ...
  public void UnPackTo(RaidSeasonManageExcelT _o) {
    ...
    for (var _j = 0; _j < this.OpenRaidBossGroupLength; ++_j) {_o.OpenRaidBossGroup.Add(this.OpenRaidBossGroup(_j));}
  ...
  public static Offset<FlatData.RaidSeasonManageExcel> Pack(FlatBufferBuilder builder, RaidSeasonManageExcelT _o) {
    if (_o == null) return default(Offset<FlatData.RaidSeasonManageExcel>);
...
public class RaidSeasonManageExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("OpenRaidBossGroup")]
