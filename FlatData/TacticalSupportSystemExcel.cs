...
public struct TacticalSupportSystemExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.TacticalSupportSystemExcel> CreateTacticalSupportSystemExcel(FlatBufferBuilder builder,
      long Id = 0,
      long SummonedTime = 0,
  ...
  public static Offset<FlatData.TacticalSupportSystemExcel> EndTacticalSupportSystemExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.TacticalSupportSystemExcel>(o);
  }
  ...
  public void UnPackTo(TacticalSupportSystemExcelT _o) {
    _o.Id = this.Id;
    _o.SummonedTime = this.SummonedTime;
    _o.DefaultPersonalityId = this.DefaultPersonalityId;
    _o.CanTargeting = this.CanTargeting;
    _o.CanCover = this.CanCover;
    _o.ObstacleUniqueName = this.ObstacleUniqueName;
    _o.ObstacleCoverRange = this.ObstacleCoverRange;
    _o.SummonSkilllGroupId = this.SummonSkilllGroupId;
    _o.CrashObstacleOBBWidth = this.CrashObstacleOBBWidth;
    _o.CrashObstacleOBBHeight = this.CrashObstacleOBBHeight;
    _o.IsTSSBlockedNodeCheck = this.IsTSSBlockedNodeCheck;
    _o.NumberOfUses = this.NumberOfUses;
    _o.InventoryOffsetX = this.InventoryOffsetX;
    _o.InventoryOffsetY = this.InventoryOffsetY;
    _o.InventoryOffsetZ = this.InventoryOffsetZ;
    _o.InteractionChar = this.InteractionChar;
    _o.CharacterInteractionStartDelay = this.CharacterInteractionStartDelay;
    _o.GetOnStartEffectPath = this.GetOnStartEffectPath;
    _o.GetOnEndEffectPath = this.GetOnEndEffectPath;
    _o.SummonerCharacterId = this.SummonerCharacterId;
    _o.InteractionFrame = this.InteractionFrame;
    _o.TSAInteractionAddDuration = this.TSAInteractionAddDuration;
    _o.InteractionStudentExSkillGroupId = this.InteractionStudentExSkillGroupId;
    _o.InteractionSkillCardTexture = this.InteractionSkillCardTexture;
    _o.InteractionSkillSpine = this.InteractionSkillSpine;
    _o.RetreatFrame = this.RetreatFrame;
    _o.DestroyFrame = this.DestroyFrame;
  }
  public static Offset<FlatData.TacticalSupportSystemExcel> Pack(FlatBufferBuilder builder, TacticalSupportSystemExcelT _o) {
    if (_o == null) return default(Offset<FlatData.TacticalSupportSystemExcel>);
...
public class TacticalSupportSystemExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("SummonedTime")]
  public long SummonedTime { get; set; }
  [Newtonsoft.Json.JsonProperty("DefaultPersonalityId")]
  public long DefaultPersonalityId { get; set; }
  [Newtonsoft.Json.JsonProperty("CanTargeting")]
  public bool CanTargeting { get; set; }
  [Newtonsoft.Json.JsonProperty("CanCover")]
  public bool CanCover { get; set; }
  [Newtonsoft.Json.JsonProperty("ObstacleUniqueName")]
  public string ObstacleUniqueName { get; set; }
  [Newtonsoft.Json.JsonProperty("ObstacleCoverRange")]
  public long ObstacleCoverRange { get; set; }
  [Newtonsoft.Json.JsonProperty("SummonSkilllGroupId")]
  public string SummonSkilllGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("CrashObstacleOBBWidth")]
  public long CrashObstacleOBBWidth { get; set; }
  [Newtonsoft.Json.JsonProperty("CrashObstacleOBBHeight")]
  public long CrashObstacleOBBHeight { get; set; }
  [Newtonsoft.Json.JsonProperty("IsTSSBlockedNodeCheck")]
  public bool IsTSSBlockedNodeCheck { get; set; }
  [Newtonsoft.Json.JsonProperty("NumberOfUses")]
  public int NumberOfUses { get; set; }
  [Newtonsoft.Json.JsonProperty("InventoryOffsetX")]
  public float InventoryOffsetX { get; set; }
  [Newtonsoft.Json.JsonProperty("InventoryOffsetY")]
  public float InventoryOffsetY { get; set; }
  [Newtonsoft.Json.JsonProperty("InventoryOffsetZ")]
  public float InventoryOffsetZ { get; set; }
  [Newtonsoft.Json.JsonProperty("InteractionChar")]
  public long InteractionChar { get; set; }
  [Newtonsoft.Json.JsonProperty("CharacterInteractionStartDelay")]
  public long CharacterInteractionStartDelay { get; set; }
  [Newtonsoft.Json.JsonProperty("GetOnStartEffectPath")]
  public string GetOnStartEffectPath { get; set; }
  [Newtonsoft.Json.JsonProperty("GetOnEndEffectPath")]
  public string GetOnEndEffectPath { get; set; }
  [Newtonsoft.Json.JsonProperty("SummonerCharacterId")]
  public long SummonerCharacterId { get; set; }
  [Newtonsoft.Json.JsonProperty("InteractionFrame")]
  public int InteractionFrame { get; set; }
  [Newtonsoft.Json.JsonProperty("TSAInteractionAddDuration")]
  public long TSAInteractionAddDuration { get; set; }
  [Newtonsoft.Json.JsonProperty("InteractionStudentExSkillGroupId")]
  public string InteractionStudentExSkillGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("InteractionSkillCardTexture")]
  public string InteractionSkillCardTexture { get; set; }
  [Newtonsoft.Json.JsonProperty("InteractionSkillSpine")]
  public string InteractionSkillSpine { get; set; }
  [Newtonsoft.Json.JsonProperty("RetreatFrame")]
  public int RetreatFrame { get; set; }
  [Newtonsoft.Json.JsonProperty("DestroyFrame")]
