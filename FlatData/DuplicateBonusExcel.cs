...
public struct DuplicateBonusExcel : IFlatbufferObject
{
  ...
  public FlatData.ItemCategory ItemCategory { get { int o = __p.__offset(6); return o != 0 ? (FlatData.ItemCategory)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ItemCategory.Coin; } }
  ...
  public static Offset<FlatData.DuplicateBonusExcel> CreateDuplicateBonusExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddItemCategory(FlatBufferBuilder builder, FlatData.ItemCategory itemCategory) { builder.AddInt(1, (int)itemCategory, 0); }
  ...
  public static Offset<FlatData.DuplicateBonusExcel> EndDuplicateBonusExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.DuplicateBonusExcel>(o);
  }
  ...
  public static Offset<FlatData.DuplicateBonusExcel> Pack(FlatBufferBuilder builder, DuplicateBonusExcelT _o) {
    if (_o == null) return default(Offset<FlatData.DuplicateBonusExcel>);
...
static public class DuplicateBonusExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ItemCategory*/, 4 /*FlatData.ItemCategory*/, 4, false)
