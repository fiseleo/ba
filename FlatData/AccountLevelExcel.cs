...
public struct AccountLevelExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(AccountLevelExcelT _o) {
    ...
    _o.Level = this.Level;
    _o.Exp = this.Exp;
    _o.APAutoChargeMax = this.APAutoChargeMax;
    _o.NeedReportEvent = this.NeedReportEvent;
  }
  public static Offset<FlatData.AccountLevelExcel> Pack(FlatBufferBuilder builder, AccountLevelExcelT _o) {
    if (_o == null) return default(Offset<FlatData.AccountLevelExcel>);
...
public class AccountLevelExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("APAutoChargeMax")]
  public long APAutoChargeMax { get; set; }
  [Newtonsoft.Json.JsonProperty("NeedReportEvent")]
