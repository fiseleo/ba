...
public struct ClearDeckRuleExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(ClearDeckRuleExcelT _o) {
    ...
    _o.SizeLimit = this.SizeLimit;
  }
  public static Offset<FlatData.ClearDeckRuleExcel> Pack(FlatBufferBuilder builder, ClearDeckRuleExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ClearDeckRuleExcel>);
...
public class ClearDeckRuleExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("SizeLimit")]
