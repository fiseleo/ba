...
public struct BossPhaseExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.BossPhaseExcel> CreateBossPhaseExcel(FlatBufferBuilder builder,
      long Id = 0,
      long AIPhase = 0,
  ...
  public static Offset<FlatData.BossPhaseExcel> EndBossPhaseExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.BossPhaseExcel>(o);
  }
  ...
  public void UnPackTo(BossPhaseExcelT _o) {
    ...
    _o.NormalAttackSkillUniqueName = this.NormalAttackSkillUniqueName;
    _o.UseExSkill = new List<bool>();
    for (var _j = 0; _j < this.UseExSkillLength; ++_j) {_o.UseExSkill.Add(this.UseExSkill(_j));}
  }
  public static Offset<FlatData.BossPhaseExcel> Pack(FlatBufferBuilder builder, BossPhaseExcelT _o) {
    if (_o == null) return default(Offset<FlatData.BossPhaseExcel>);
...
public class BossPhaseExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("NormalAttackSkillUniqueName")]
  public string NormalAttackSkillUniqueName { get; set; }
  [Newtonsoft.Json.JsonProperty("UseExSkill")]
