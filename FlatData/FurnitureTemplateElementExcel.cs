...
public struct FurnitureTemplateElementExcel : IFlatbufferObject
{
  ...
  public FlatData.FurnitureLocation Location { get { int o = __p.__offset(8); return o != 0 ? (FlatData.FurnitureLocation)__p.bb.GetInt(o + __p.bb_pos) : FlatData.FurnitureLocation.None; } }
  ...
  public static Offset<FlatData.FurnitureTemplateElementExcel> CreateFurnitureTemplateElementExcel(FlatBufferBuilder builder,
      long FurnitureTemplateId = 0,
      long FurnitureId = 0,
      FlatData.FurnitureLocation Location = FlatData.FurnitureLocation.None,
  ...
  public static void AddLocation(FlatBufferBuilder builder, FlatData.FurnitureLocation location) { builder.AddInt(2, (int)location, 0); }
  ...
  public static Offset<FlatData.FurnitureTemplateElementExcel> EndFurnitureTemplateElementExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.FurnitureTemplateElementExcel>(o);
  }
  ...
  public void UnPackTo(FurnitureTemplateElementExcelT _o) {
    _o.FurnitureTemplateId = this.FurnitureTemplateId;
  ...
  public static Offset<FlatData.FurnitureTemplateElementExcel> Pack(FlatBufferBuilder builder, FurnitureTemplateElementExcelT _o) {
    if (_o == null) return default(Offset<FlatData.FurnitureTemplateElementExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("FurnitureTemplateId")]
  public long FurnitureTemplateId { get; set; }
  [Newtonsoft.Json.JsonProperty("FurnitureId")]
  public long FurnitureId { get; set; }
  [Newtonsoft.Json.JsonProperty("Location")]
  public FlatData.FurnitureLocation Location { get; set; }
  ...
  public FurnitureTemplateElementExcelT() {
    ...
    this.FurnitureId = 0;
    this.Location = FlatData.FurnitureLocation.None;
    this.PositionX = 0.0f;
    this.PositionY = 0.0f;
    this.Rotation = 0.0f;
    this.Order = 0;
...
static public class FurnitureTemplateElementExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*Location*/, 4 /*FlatData.FurnitureLocation*/, 4, false)
