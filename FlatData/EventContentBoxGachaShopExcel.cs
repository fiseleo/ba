...
public struct EventContentBoxGachaShopExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.EventContentBoxGachaShopExcel> CreateEventContentBoxGachaShopExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.EventContentBoxGachaShopExcel> EndEventContentBoxGachaShopExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentBoxGachaShopExcel>(o);
  }
  ...
  public void UnPackTo(EventContentBoxGachaShopExcelT _o) {
    ...
    _o.GroupElementAmount = this.GroupElementAmount;
    _o.Round = this.Round;
    _o.IsLegacy = this.IsLegacy;
    _o.IsPrize = this.IsPrize;
  ...
  public static Offset<FlatData.EventContentBoxGachaShopExcel> Pack(FlatBufferBuilder builder, EventContentBoxGachaShopExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EventContentBoxGachaShopExcel>);
