...
public struct LocalizeEtcExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(LocalizeEtcExcelT _o) {
    ...
    _o.DescriptionKr = this.DescriptionKr;
    _o.NameJp = this.NameJp;
    _o.DescriptionJp = this.DescriptionJp;
  }
  public static Offset<FlatData.LocalizeEtcExcel> Pack(FlatBufferBuilder builder, LocalizeEtcExcelT _o) {
    if (_o == null) return default(Offset<FlatData.LocalizeEtcExcel>);
...
public class LocalizeEtcExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("DescriptionKr")]
  public string DescriptionKr { get; set; }
  [Newtonsoft.Json.JsonProperty("NameJp")]
  public string NameJp { get; set; }
  [Newtonsoft.Json.JsonProperty("DescriptionJp")]
