...
public struct FormationLocationExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.FormationLocationExcel> CreateFormationLocationExcel(FlatBufferBuilder builder,
      long Id = 0,
      long GroupID = 0,
  ...
  public static Offset<FlatData.FormationLocationExcel> EndFormationLocationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.FormationLocationExcel>(o);
  }
  ...
  public void UnPackTo(FormationLocationExcelT _o) {
    ...
    for (var _j = 0; _j < this.SlotZLength; ++_j) {_o.SlotZ.Add(this.SlotZ(_j));}
    _o.SlotX = new List<float>();
    for (var _j = 0; _j < this.SlotXLength; ++_j) {_o.SlotX.Add(this.SlotX(_j));}
  }
  public static Offset<FlatData.FormationLocationExcel> Pack(FlatBufferBuilder builder, FormationLocationExcelT _o) {
    if (_o == null) return default(Offset<FlatData.FormationLocationExcel>);
...
public class FormationLocationExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("SlotZ")]
  public List<float> SlotZ { get; set; }
  [Newtonsoft.Json.JsonProperty("SlotX")]
