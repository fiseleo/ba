...
public struct EventContentZoneVisitRewardExcel : IFlatbufferObject
{
  ...
  public FlatData.ParcelType VisitRewardParcelType(int j) { int o = __p.__offset(14); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatData.ParcelType)0; }
  public int VisitRewardParcelTypeLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatData.ParcelType> GetVisitRewardParcelTypeBytes() { return __p.__vector_as_span<FlatData.ParcelType>(14, 4); }
#else
  public ArraySegment<byte>? GetVisitRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(14); }
#endif
  public FlatData.ParcelType[] GetVisitRewardParcelTypeArray() { int o = __p.__offset(14); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatData.ParcelType[] a = new FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<FlatData.EventContentZoneVisitRewardExcel> CreateEventContentZoneVisitRewardExcel(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateVisitRewardParcelTypeVector(FlatBufferBuilder builder, FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateVisitRewardParcelTypeVectorBlock(FlatBufferBuilder builder, FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateVisitRewardParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatData.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateVisitRewardParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatData.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<FlatData.EventContentZoneVisitRewardExcel> EndEventContentZoneVisitRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentZoneVisitRewardExcel>(o);
  }
  ...
  public void UnPackTo(EventContentZoneVisitRewardExcelT _o) {
    ...
    _o.EventContentLocationId = this.EventContentLocationId;
    _o.DevName = this.DevName;
    _o.CharacterId = this.CharacterId;
    _o.CharacterDevName = this.CharacterDevName;
    _o.VisitRewardParcelType = new List<FlatData.ParcelType>();
    for (var _j = 0; _j < this.VisitRewardParcelTypeLength; ++_j) {_o.VisitRewardParcelType.Add(this.VisitRewardParcelType(_j));}
    _o.VisitRewardParcelId = new List<long>();
    for (var _j = 0; _j < this.VisitRewardParcelIdLength; ++_j) {_o.VisitRewardParcelId.Add(this.VisitRewardParcelId(_j));}
    _o.VisitRewardAmount = new List<long>();
    for (var _j = 0; _j < this.VisitRewardAmountLength; ++_j) {_o.VisitRewardAmount.Add(this.VisitRewardAmount(_j));}
    _o.VisitRewardProb = new List<long>();
    for (var _j = 0; _j < this.VisitRewardProbLength; ++_j) {_o.VisitRewardProb.Add(this.VisitRewardProb(_j));}
  }
  public static Offset<FlatData.EventContentZoneVisitRewardExcel> Pack(FlatBufferBuilder builder, EventContentZoneVisitRewardExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EventContentZoneVisitRewardExcel>);
...
public class EventContentZoneVisitRewardExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("EventContentLocationId")]
  ...
  [Newtonsoft.Json.JsonProperty("CharacterDevName")]
  public string CharacterDevName { get; set; }
  [Newtonsoft.Json.JsonProperty("VisitRewardParcelType")]
  public List<FlatData.ParcelType> VisitRewardParcelType { get; set; }
  [Newtonsoft.Json.JsonProperty("VisitRewardParcelId")]
  public List<long> VisitRewardParcelId { get; set; }
  [Newtonsoft.Json.JsonProperty("VisitRewardAmount")]
  public List<long> VisitRewardAmount { get; set; }
  [Newtonsoft.Json.JsonProperty("VisitRewardProb")]
...
static public class EventContentZoneVisitRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 14 /*VisitRewardParcelType*/, 4 /*FlatData.ParcelType*/, false)
