...
public struct BlendInfo : IFlatbufferObject
{
  ...
  public static Offset<FlatData.BlendInfo> CreateBlendInfo(FlatBufferBuilder builder,
      int From = 0,
      int To = 0,
      float Blend = 0.0f) {
  ...
  public static Offset<FlatData.BlendInfo> EndBlendInfo(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.BlendInfo>(o);
  }
  ...
  public static Offset<FlatData.BlendInfo> Pack(FlatBufferBuilder builder, BlendInfoT _o) {
    if (_o == null) return default(Offset<FlatData.BlendInfo>);
...
public class BlendInfoT
{
  ...
  [Newtonsoft.Json.JsonProperty("Blend")]
