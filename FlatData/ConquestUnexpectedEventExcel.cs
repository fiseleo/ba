...
public struct ConquestUnexpectedEventExcel : IFlatbufferObject
{
  ...
  public FlatData.ParcelType UnexpectedEventConditionType { get { int o = __p.__offset(6); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ParcelType.None; } }
  ...
  public static Offset<FlatData.ConquestUnexpectedEventExcel> CreateConquestUnexpectedEventExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      FlatData.ParcelType UnexpectedEventConditionType = FlatData.ParcelType.None,
  ...
  public static void AddUnexpectedEventConditionType(FlatBufferBuilder builder, FlatData.ParcelType unexpectedEventConditionType) { builder.AddInt(1, (int)unexpectedEventConditionType, 0); }
  ...
  public static Offset<FlatData.ConquestUnexpectedEventExcel> EndConquestUnexpectedEventExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ConquestUnexpectedEventExcel>(o);
  }
  ...
  public void UnPackTo(ConquestUnexpectedEventExcelT _o) {
    ...
    _o.UnexpectedEventConditionType = this.UnexpectedEventConditionType;
    _o.UnexpectedEventConditionUniqueId = this.UnexpectedEventConditionUniqueId;
    _o.UnexpectedEventConditionAmount = this.UnexpectedEventConditionAmount;
    _o.UnexpectedEventOccurDailyLimitCount = this.UnexpectedEventOccurDailyLimitCount;
    _o.UnitCountPerStep = this.UnitCountPerStep;
    _o.UnexpectedEventPrefab = new List<string>();
    for (var _j = 0; _j < this.UnexpectedEventPrefabLength; ++_j) {_o.UnexpectedEventPrefab.Add(this.UnexpectedEventPrefab(_j));}
  ...
  public static Offset<FlatData.ConquestUnexpectedEventExcel> Pack(FlatBufferBuilder builder, ConquestUnexpectedEventExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ConquestUnexpectedEventExcel>);
...
public class ConquestUnexpectedEventExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("UnexpectedEventConditionType")]
  public FlatData.ParcelType UnexpectedEventConditionType { get; set; }
  [Newtonsoft.Json.JsonProperty("UnexpectedEventConditionUniqueId")]
  public long UnexpectedEventConditionUniqueId { get; set; }
  [Newtonsoft.Json.JsonProperty("UnexpectedEventConditionAmount")]
  public long UnexpectedEventConditionAmount { get; set; }
  [Newtonsoft.Json.JsonProperty("UnexpectedEventOccurDailyLimitCount")]
  public int UnexpectedEventOccurDailyLimitCount { get; set; }
  [Newtonsoft.Json.JsonProperty("UnitCountPerStep")]
  ...
  public ConquestUnexpectedEventExcelT() {
    ...
    this.UnexpectedEventConditionType = FlatData.ParcelType.None;
...
static public class ConquestUnexpectedEventExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*UnexpectedEventConditionType*/, 4 /*FlatData.ParcelType*/, 4, false)
