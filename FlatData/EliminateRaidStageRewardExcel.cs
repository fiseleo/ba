...
public struct EliminateRaidStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.EliminateRaidStageRewardExcel> CreateEliminateRaidStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<FlatData.EliminateRaidStageRewardExcel> EndEliminateRaidStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EliminateRaidStageRewardExcel>(o);
  }
  ...
  public static Offset<FlatData.EliminateRaidStageRewardExcel> Pack(FlatBufferBuilder builder, EliminateRaidStageRewardExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EliminateRaidStageRewardExcel>);
