...
public struct EliminateRaidStageExcel : IFlatbufferObject
{
  ...
  public FlatData.ParcelType RaidEnterCostType { get { int o = __p.__offset(12); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ParcelType.None; } }
  ...
  public FlatData.Difficulty Difficulty { get { int o = __p.__offset(28); return o != 0 ? (FlatData.Difficulty)__p.bb.GetInt(o + __p.bb_pos) : FlatData.Difficulty.Normal; } }
  ...
  public FlatData.TacticEnvironment TacticEnvironment { get { int o = __p.__offset(44); return o != 0 ? (FlatData.TacticEnvironment)__p.bb.GetInt(o + __p.bb_pos) : FlatData.TacticEnvironment.None; } }
  ...
  public FlatData.EchelonExtensionType EchelonExtensionType { get { int o = __p.__offset(80); return o != 0 ? (FlatData.EchelonExtensionType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.EchelonExtensionType.Base; } }

  public static Offset<FlatData.EliminateRaidStageExcel> CreateEliminateRaidStageExcel(FlatBufferBuilder builder,
      long Id = 0,
      bool UseBossIndex = false,
      bool UseBossAIPhaseSync = false,
      StringOffset RaidBossGroupOffset = default(StringOffset),
      FlatData.ParcelType RaidEnterCostType = FlatData.ParcelType.None,
  ...
  public static void AddRaidEnterCostType(FlatBufferBuilder builder, FlatData.ParcelType raidEnterCostType) { builder.AddInt(4, (int)raidEnterCostType, 0); }
  ...
  public static void AddDifficulty(FlatBufferBuilder builder, FlatData.Difficulty difficulty) { builder.AddInt(12, (int)difficulty, 0); }
  ...
  public static void AddTacticEnvironment(FlatBufferBuilder builder, FlatData.TacticEnvironment tacticEnvironment) { builder.AddInt(20, (int)tacticEnvironment, 0); }
  ...
  public static void AddEchelonExtensionType(FlatBufferBuilder builder, FlatData.EchelonExtensionType echelonExtensionType) { builder.AddInt(38, (int)echelonExtensionType, 0); }
  public static Offset<FlatData.EliminateRaidStageExcel> EndEliminateRaidStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EliminateRaidStageExcel>(o);
  }
  ...
  public void UnPackTo(EliminateRaidStageExcelT _o) {
    ...
    _o.RaidEnterCostAmount = this.RaidEnterCostAmount;
    _o.BossSpinePath = this.BossSpinePath;
  ...
  public static Offset<FlatData.EliminateRaidStageExcel> Pack(FlatBufferBuilder builder, EliminateRaidStageExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EliminateRaidStageExcel>);
...
public class EliminateRaidStageExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("RaidEnterCostAmount")]
  public int RaidEnterCostAmount { get; set; }
  [Newtonsoft.Json.JsonProperty("BossSpinePath")]
  ...
  [Newtonsoft.Json.JsonProperty("IsOpen")]
...
static public class EliminateRaidStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*RaidEnterCostType*/, 4 /*FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 28 /*Difficulty*/, 4 /*FlatData.Difficulty*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 44 /*TacticEnvironment*/, 4 /*FlatData.TacticEnvironment*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 80 /*EchelonExtensionType*/, 4 /*FlatData.EchelonExtensionType*/, 4, false)
