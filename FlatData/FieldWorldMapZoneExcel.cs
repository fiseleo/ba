...
public struct FieldWorldMapZoneExcel : IFlatbufferObject
{
  ...
  public FlatData.FieldConditionType OpenConditionType { get { int o = __p.__offset(10); return o != 0 ? (FlatData.FieldConditionType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.FieldConditionType.Invalid; } }
  public long OpenConditionId { get { int o = __p.__offset(12); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public FlatData.FieldConditionType CloseConditionType { get { int o = __p.__offset(14); return o != 0 ? (FlatData.FieldConditionType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.FieldConditionType.Invalid; } }
  ...
  public static Offset<FlatData.FieldWorldMapZoneExcel> CreateFieldWorldMapZoneExcel(FlatBufferBuilder builder,
      long Id = 0,
      int GroupId = 0,
      int Date = 0,
      FlatData.FieldConditionType OpenConditionType = FlatData.FieldConditionType.Invalid,
      long OpenConditionId = 0,
      FlatData.FieldConditionType CloseConditionType = FlatData.FieldConditionType.Invalid,
  ...
  public static void AddOpenConditionType(FlatBufferBuilder builder, FlatData.FieldConditionType openConditionType) { builder.AddInt(3, (int)openConditionType, 0); }
  public static void AddOpenConditionId(FlatBufferBuilder builder, long openConditionId) { builder.AddLong(4, openConditionId, 0); }
  public static void AddCloseConditionType(FlatBufferBuilder builder, FlatData.FieldConditionType closeConditionType) { builder.AddInt(5, (int)closeConditionType, 0); }
  ...
  public static Offset<FlatData.FieldWorldMapZoneExcel> EndFieldWorldMapZoneExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.FieldWorldMapZoneExcel>(o);
  }
  ...
  public void UnPackTo(FieldWorldMapZoneExcelT _o) {
    ...
    _o.Date = this.Date;
    _o.OpenConditionType = this.OpenConditionType;
    _o.OpenConditionId = this.OpenConditionId;
    _o.CloseConditionType = this.CloseConditionType;
    _o.CloseConditionId = this.CloseConditionId;
    _o.ResultFieldScene = this.ResultFieldScene;
    _o.FieldStageInteractionId = this.FieldStageInteractionId;
    _o.LocalizeCode = this.LocalizeCode;
  }
  public static Offset<FlatData.FieldWorldMapZoneExcel> Pack(FlatBufferBuilder builder, FieldWorldMapZoneExcelT _o) {
    if (_o == null) return default(Offset<FlatData.FieldWorldMapZoneExcel>);
...
public class FieldWorldMapZoneExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("OpenConditionType")]
  public FlatData.FieldConditionType OpenConditionType { get; set; }
  [Newtonsoft.Json.JsonProperty("OpenConditionId")]
  public long OpenConditionId { get; set; }
  [Newtonsoft.Json.JsonProperty("CloseConditionType")]
  public FlatData.FieldConditionType CloseConditionType { get; set; }
  [Newtonsoft.Json.JsonProperty("CloseConditionId")]
  public long CloseConditionId { get; set; }
  [Newtonsoft.Json.JsonProperty("ResultFieldScene")]
  public long ResultFieldScene { get; set; }
  [Newtonsoft.Json.JsonProperty("FieldStageInteractionId")]
  ...
  public FieldWorldMapZoneExcelT() {
    ...
    this.GroupId = 0;
    this.Date = 0;
    this.OpenConditionType = FlatData.FieldConditionType.Invalid;
    this.OpenConditionId = 0;
    this.CloseConditionType = FlatData.FieldConditionType.Invalid;
...
static public class FieldWorldMapZoneExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*OpenConditionType*/, 4 /*FlatData.FieldConditionType*/, 4, false)
      && verifier.VerifyField(tablePos, 12 /*OpenConditionId*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 14 /*CloseConditionType*/, 4 /*FlatData.FieldConditionType*/, 4, false)
