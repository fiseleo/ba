...
public struct PresetCharacterGroupSettingExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.PresetCharacterGroupSettingExcel> CreatePresetCharacterGroupSettingExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
  ...
  public static Offset<FlatData.PresetCharacterGroupSettingExcel> EndPresetCharacterGroupSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.PresetCharacterGroupSettingExcel>(o);
  }
  ...
  public void UnPackTo(PresetCharacterGroupSettingExcelT _o) {
    ...
    _o.ArenaSimulatorFixed = this.ArenaSimulatorFixed;
    _o.PresetType = new List<string>();
    for (var _j = 0; _j < this.PresetTypeLength; ++_j) {_o.PresetType.Add(this.PresetType(_j));}
  }
  public static Offset<FlatData.PresetCharacterGroupSettingExcel> Pack(FlatBufferBuilder builder, PresetCharacterGroupSettingExcelT _o) {
    if (_o == null) return default(Offset<FlatData.PresetCharacterGroupSettingExcel>);
...
public class PresetCharacterGroupSettingExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("ArenaSimulatorFixed")]
  public bool ArenaSimulatorFixed { get; set; }
  [Newtonsoft.Json.JsonProperty("PresetType")]
