...
public struct FieldSceneExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.FieldSceneExcel> CreateFieldSceneExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      long DateId = 0,
      long GroupId = 0,
  ...
  public static Offset<FlatData.FieldSceneExcel> EndFieldSceneExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.FieldSceneExcel>(o);
  }
  ...
  public void UnPackTo(FieldSceneExcelT _o) {
    ...
    _o.DateId = this.DateId;
    _o.GroupId = this.GroupId;
    _o.ArtLevelPath = this.ArtLevelPath;
    _o.DesignLevelPath = this.DesignLevelPath;
    _o.BGMId = this.BGMId;
    _o.ConditionalBGMQuestId = new List<long>();
    for (var _j = 0; _j < this.ConditionalBGMQuestIdLength; ++_j) {_o.ConditionalBGMQuestId.Add(this.ConditionalBGMQuestId(_j));}
    _o.BeginConditionalBGMScenarioGroupId = new List<long>();
    for (var _j = 0; _j < this.BeginConditionalBGMScenarioGroupIdLength; ++_j) {_o.BeginConditionalBGMScenarioGroupId.Add(this.BeginConditionalBGMScenarioGroupId(_j));}
    _o.EndConditionalBGMScenarioGroupId = new List<long>();
    for (var _j = 0; _j < this.EndConditionalBGMScenarioGroupIdLength; ++_j) {_o.EndConditionalBGMScenarioGroupId.Add(this.EndConditionalBGMScenarioGroupId(_j));}
    _o.ConditionalBGMId = new List<long>();
    for (var _j = 0; _j < this.ConditionalBGMIdLength; ++_j) {_o.ConditionalBGMId.Add(this.ConditionalBGMId(_j));}
  }
  public static Offset<FlatData.FieldSceneExcel> Pack(FlatBufferBuilder builder, FieldSceneExcelT _o) {
    if (_o == null) return default(Offset<FlatData.FieldSceneExcel>);
...
public class FieldSceneExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("DateId")]
  public long DateId { get; set; }
  [Newtonsoft.Json.JsonProperty("GroupId")]
  public long GroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("ArtLevelPath")]
  public string ArtLevelPath { get; set; }
  [Newtonsoft.Json.JsonProperty("DesignLevelPath")]
  public string DesignLevelPath { get; set; }
  [Newtonsoft.Json.JsonProperty("BGMId")]
  public long BGMId { get; set; }
  [Newtonsoft.Json.JsonProperty("ConditionalBGMQuestId")]
  public List<long> ConditionalBGMQuestId { get; set; }
  [Newtonsoft.Json.JsonProperty("BeginConditionalBGMScenarioGroupId")]
  public List<long> BeginConditionalBGMScenarioGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("EndConditionalBGMScenarioGroupId")]
  public List<long> EndConditionalBGMScenarioGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("ConditionalBGMId")]
