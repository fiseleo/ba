...
public struct CharacterLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.CharacterLevelExcel> CreateCharacterLevelExcel(FlatBufferBuilder builder,
      int Level = 0,
      long Exp = 0,
      long TotalExp = 0) {
  ...
  public static Offset<FlatData.CharacterLevelExcel> EndCharacterLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.CharacterLevelExcel>(o);
  }
  ...
  public static Offset<FlatData.CharacterLevelExcel> Pack(FlatBufferBuilder builder, CharacterLevelExcelT _o) {
    if (_o == null) return default(Offset<FlatData.CharacterLevelExcel>);
