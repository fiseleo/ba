...
public struct GachaElementExcel : IFlatbufferObject
{
  ...
  public FlatData.Rarity Rarity { get { int o = __p.__offset(12); return o != 0 ? (FlatData.Rarity)__p.bb.GetInt(o + __p.bb_pos) : FlatData.Rarity.N; } }
  ...
  public static Offset<FlatData.GachaElementExcel> CreateGachaElementExcel(FlatBufferBuilder builder,
      long ID = 0,
      long GachaGroupID = 0,
  ...
  public static void AddRarity(FlatBufferBuilder builder, FlatData.Rarity rarity) { builder.AddInt(4, (int)rarity, 0); }
  ...
  public static Offset<FlatData.GachaElementExcel> EndGachaElementExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.GachaElementExcel>(o);
  }
  ...
  public static Offset<FlatData.GachaElementExcel> Pack(FlatBufferBuilder builder, GachaElementExcelT _o) {
    if (_o == null) return default(Offset<FlatData.GachaElementExcel>);
...
static public class GachaElementExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*Rarity*/, 4 /*FlatData.Rarity*/, 4, false)
