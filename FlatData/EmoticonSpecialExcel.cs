...
public struct EmoticonSpecialExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.EmoticonSpecialExcel> CreateEmoticonSpecialExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<FlatData.EmoticonSpecialExcel> EndEmoticonSpecialExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EmoticonSpecialExcel>(o);
  }
  ...
  public void UnPackTo(EmoticonSpecialExcelT _o) {
    ...
    _o.CharacterUniqueId = this.CharacterUniqueId;
    _o.Random = this.Random;
  }
  public static Offset<FlatData.EmoticonSpecialExcel> Pack(FlatBufferBuilder builder, EmoticonSpecialExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EmoticonSpecialExcel>);
...
public class EmoticonSpecialExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("CharacterUniqueId")]
