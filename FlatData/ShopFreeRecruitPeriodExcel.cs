...
public struct ShopFreeRecruitPeriodExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.ShopFreeRecruitPeriodExcel> CreateShopFreeRecruitPeriodExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.ShopFreeRecruitPeriodExcel> EndShopFreeRecruitPeriodExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ShopFreeRecruitPeriodExcel>(o);
  }
  ...
  public void UnPackTo(ShopFreeRecruitPeriodExcelT _o) {
    _o.ShopFreeRecruitId = this.ShopFreeRecruitId;
    _o.ShopFreeRecruitIntervalId = this.ShopFreeRecruitIntervalId;
    _o.IntervalDate = this.IntervalDate;
    _o.FreeRecruitCount = this.FreeRecruitCount;
  }
  public static Offset<FlatData.ShopFreeRecruitPeriodExcel> Pack(FlatBufferBuilder builder, ShopFreeRecruitPeriodExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ShopFreeRecruitPeriodExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("ShopFreeRecruitId")]
  public long ShopFreeRecruitId { get; set; }
  [Newtonsoft.Json.JsonProperty("ShopFreeRecruitIntervalId")]
  public long ShopFreeRecruitIntervalId { get; set; }
  [Newtonsoft.Json.JsonProperty("IntervalDate")]
  public string IntervalDate { get; set; }
  [Newtonsoft.Json.JsonProperty("FreeRecruitCount")]
