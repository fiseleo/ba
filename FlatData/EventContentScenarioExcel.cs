...
public struct EventContentScenarioExcel : IFlatbufferObject
{
  ...
  public FlatData.EventContentScenarioConditionType ScenarioConditionType { get { int o = __p.__offset(22); return o != 0 ? (FlatData.EventContentScenarioConditionType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.EventContentScenarioConditionType.None; } }
  ...
  public FlatData.ParcelType CostParcelType { get { int o = __p.__offset(36); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ParcelType.None; } }
  ...
  public FlatData.ParcelType RewardParcelType(int j) { int o = __p.__offset(42); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatData.ParcelType)0; }
  public int RewardParcelTypeLength { get { int o = __p.__offset(42); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatData.ParcelType> GetRewardParcelTypeBytes() { return __p.__vector_as_span<FlatData.ParcelType>(42, 4); }
#else
  public ArraySegment<byte>? GetRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(42); }
#endif
  public FlatData.ParcelType[] GetRewardParcelTypeArray() { int o = __p.__offset(42); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatData.ParcelType[] a = new FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<FlatData.EventContentScenarioExcel> CreateEventContentScenarioExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      FlatData.EventContentScenarioConditionType ScenarioConditionType = FlatData.EventContentScenarioConditionType.None,
  ...
  public static void AddScenarioConditionType(FlatBufferBuilder builder, FlatData.EventContentScenarioConditionType scenarioConditionType) { builder.AddInt(9, (int)scenarioConditionType, 0); }
  ...
  public static void AddCostParcelType(FlatBufferBuilder builder, FlatData.ParcelType costParcelType) { builder.AddInt(16, (int)costParcelType, 0); }
  ...
  public static Offset<FlatData.EventContentScenarioExcel> EndEventContentScenarioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentScenarioExcel>(o);
  }
  ...
  public void UnPackTo(EventContentScenarioExcelT _o) {
    ...
    _o.ReplayDisplayGroup = this.ReplayDisplayGroup;
    _o.Order = this.Order;
    _o.RecollectionNumber = this.RecollectionNumber;
    _o.IsRecollection = this.IsRecollection;
    _o.IsMeetup = this.IsMeetup;
    _o.IsOmnibus = this.IsOmnibus;
    _o.ScenarioGroupId = new List<long>();
    for (var _j = 0; _j < this.ScenarioGroupIdLength; ++_j) {_o.ScenarioGroupId.Add(this.ScenarioGroupId(_j));}
    _o.ScenarioConditionType = this.ScenarioConditionType;
    _o.ConditionAmount = this.ConditionAmount;
    _o.ConditionEventContentId = this.ConditionEventContentId;
    _o.ClearedScenarioGroupId = this.ClearedScenarioGroupId;
    _o.RecollectionSummaryLocalizeScenarioId = this.RecollectionSummaryLocalizeScenarioId;
    _o.RecollectionResource = this.RecollectionResource;
    _o.IsRecollectionHorizon = this.IsRecollectionHorizon;
    _o.CostParcelType = this.CostParcelType;
    _o.CostId = this.CostId;
    _o.CostAmount = this.CostAmount;
    ...
    for (var _j = 0; _j < this.RewardIdLength; ++_j) {_o.RewardId.Add(this.RewardId(_j));}
    _o.RewardAmount = new List<int>();
    for (var _j = 0; _j < this.RewardAmountLength; ++_j) {_o.RewardAmount.Add(this.RewardAmount(_j));}
  }
  public static Offset<FlatData.EventContentScenarioExcel> Pack(FlatBufferBuilder builder, EventContentScenarioExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EventContentScenarioExcel>);
...
public class EventContentScenarioExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("ReplayDisplayGroup")]
  public int ReplayDisplayGroup { get; set; }
  [Newtonsoft.Json.JsonProperty("Order")]
  public long Order { get; set; }
  [Newtonsoft.Json.JsonProperty("RecollectionNumber")]
  public long RecollectionNumber { get; set; }
  [Newtonsoft.Json.JsonProperty("IsRecollection")]
  public bool IsRecollection { get; set; }
  [Newtonsoft.Json.JsonProperty("IsMeetup")]
  public bool IsMeetup { get; set; }
  [Newtonsoft.Json.JsonProperty("IsOmnibus")]
  public bool IsOmnibus { get; set; }
  [Newtonsoft.Json.JsonProperty("ScenarioGroupId")]
  public List<long> ScenarioGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("ScenarioConditionType")]
  public FlatData.EventContentScenarioConditionType ScenarioConditionType { get; set; }
  [Newtonsoft.Json.JsonProperty("ConditionAmount")]
  public long ConditionAmount { get; set; }
  [Newtonsoft.Json.JsonProperty("ConditionEventContentId")]
  public long ConditionEventContentId { get; set; }
  [Newtonsoft.Json.JsonProperty("ClearedScenarioGroupId")]
  public long ClearedScenarioGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("RecollectionSummaryLocalizeScenarioId")]
  public uint RecollectionSummaryLocalizeScenarioId { get; set; }
  [Newtonsoft.Json.JsonProperty("RecollectionResource")]
  public string RecollectionResource { get; set; }
  [Newtonsoft.Json.JsonProperty("IsRecollectionHorizon")]
  public bool IsRecollectionHorizon { get; set; }
  [Newtonsoft.Json.JsonProperty("CostParcelType")]
  public FlatData.ParcelType CostParcelType { get; set; }
  ...
  public EventContentScenarioExcelT() {
    ...
    this.ScenarioConditionType = FlatData.EventContentScenarioConditionType.None;
    ...
    this.CostParcelType = FlatData.ParcelType.None;
    this.CostId = 0;
    this.CostAmount = 0;
...
static public class EventContentScenarioExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*ScenarioConditionType*/, 4 /*FlatData.EventContentScenarioConditionType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 36 /*CostParcelType*/, 4 /*FlatData.ParcelType*/, 4, false)
      && verifier.VerifyField(tablePos, 38 /*CostId*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 40 /*CostAmount*/, 4 /*int*/, 4, false)
      && verifier.VerifyVectorOfData(tablePos, 42 /*RewardParcelType*/, 4 /*FlatData.ParcelType*/, false)
