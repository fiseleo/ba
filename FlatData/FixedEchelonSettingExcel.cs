...
public struct FixedEchelonSettingExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.FixedEchelonSettingExcel> CreateFixedEchelonSettingExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.FixedEchelonSettingExcel> EndFixedEchelonSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.FixedEchelonSettingExcel>(o);
  }
  ...
  public void UnPackTo(FixedEchelonSettingExcelT _o) {
    ...
    _o.EchelonSceneSkip = this.EchelonSceneSkip;
    _o.MainLeaderSlot = this.MainLeaderSlot;
    _o.MainCharacterID = new List<long>();
    for (var _j = 0; _j < this.MainCharacterIDLength; ++_j) {_o.MainCharacterID.Add(this.MainCharacterID(_j));}
    _o.MainLevel = new List<int>();
    for (var _j = 0; _j < this.MainLevelLength; ++_j) {_o.MainLevel.Add(this.MainLevel(_j));}
    _o.MainGrade = new List<int>();
    for (var _j = 0; _j < this.MainGradeLength; ++_j) {_o.MainGrade.Add(this.MainGrade(_j));}
    _o.MainExSkillLevel = new List<int>();
    for (var _j = 0; _j < this.MainExSkillLevelLength; ++_j) {_o.MainExSkillLevel.Add(this.MainExSkillLevel(_j));}
    _o.MainNoneExSkillLevel = new List<int>();
    for (var _j = 0; _j < this.MainNoneExSkillLevelLength; ++_j) {_o.MainNoneExSkillLevel.Add(this.MainNoneExSkillLevel(_j));}
    _o.MainEquipment1Tier = new List<int>();
    for (var _j = 0; _j < this.MainEquipment1TierLength; ++_j) {_o.MainEquipment1Tier.Add(this.MainEquipment1Tier(_j));}
    _o.MainEquipment1Level = new List<int>();
    for (var _j = 0; _j < this.MainEquipment1LevelLength; ++_j) {_o.MainEquipment1Level.Add(this.MainEquipment1Level(_j));}
    _o.MainEquipment2Tier = new List<int>();
    for (var _j = 0; _j < this.MainEquipment2TierLength; ++_j) {_o.MainEquipment2Tier.Add(this.MainEquipment2Tier(_j));}
    _o.MainEquipment2Level = new List<int>();
    for (var _j = 0; _j < this.MainEquipment2LevelLength; ++_j) {_o.MainEquipment2Level.Add(this.MainEquipment2Level(_j));}
    _o.MainEquipment3Tier = new List<int>();
    for (var _j = 0; _j < this.MainEquipment3TierLength; ++_j) {_o.MainEquipment3Tier.Add(this.MainEquipment3Tier(_j));}
    _o.MainEquipment3Level = new List<int>();
    for (var _j = 0; _j < this.MainEquipment3LevelLength; ++_j) {_o.MainEquipment3Level.Add(this.MainEquipment3Level(_j));}
    _o.MainCharacterWeaponGrade = new List<int>();
    for (var _j = 0; _j < this.MainCharacterWeaponGradeLength; ++_j) {_o.MainCharacterWeaponGrade.Add(this.MainCharacterWeaponGrade(_j));}
    _o.MainCharacterWeaponLevel = new List<int>();
    for (var _j = 0; _j < this.MainCharacterWeaponLevelLength; ++_j) {_o.MainCharacterWeaponLevel.Add(this.MainCharacterWeaponLevel(_j));}
    _o.MainCharacterGearTier = new List<int>();
    for (var _j = 0; _j < this.MainCharacterGearTierLength; ++_j) {_o.MainCharacterGearTier.Add(this.MainCharacterGearTier(_j));}
    _o.MainCharacterGearLevel = new List<int>();
    for (var _j = 0; _j < this.MainCharacterGearLevelLength; ++_j) {_o.MainCharacterGearLevel.Add(this.MainCharacterGearLevel(_j));}
    _o.SupportCharacterID = new List<long>();
    for (var _j = 0; _j < this.SupportCharacterIDLength; ++_j) {_o.SupportCharacterID.Add(this.SupportCharacterID(_j));}
    _o.SupportLevel = new List<int>();
    for (var _j = 0; _j < this.SupportLevelLength; ++_j) {_o.SupportLevel.Add(this.SupportLevel(_j));}
    _o.SupportGrade = new List<int>();
    for (var _j = 0; _j < this.SupportGradeLength; ++_j) {_o.SupportGrade.Add(this.SupportGrade(_j));}
    _o.SupportExSkillLevel = new List<int>();
    for (var _j = 0; _j < this.SupportExSkillLevelLength; ++_j) {_o.SupportExSkillLevel.Add(this.SupportExSkillLevel(_j));}
    _o.SupportNoneExSkillLevel = new List<int>();
    for (var _j = 0; _j < this.SupportNoneExSkillLevelLength; ++_j) {_o.SupportNoneExSkillLevel.Add(this.SupportNoneExSkillLevel(_j));}
    _o.SupportEquipment1Tier = new List<int>();
    for (var _j = 0; _j < this.SupportEquipment1TierLength; ++_j) {_o.SupportEquipment1Tier.Add(this.SupportEquipment1Tier(_j));}
    _o.SupportEquipment1Level = new List<int>();
    for (var _j = 0; _j < this.SupportEquipment1LevelLength; ++_j) {_o.SupportEquipment1Level.Add(this.SupportEquipment1Level(_j));}
    _o.SupportEquipment2Tier = new List<int>();
    for (var _j = 0; _j < this.SupportEquipment2TierLength; ++_j) {_o.SupportEquipment2Tier.Add(this.SupportEquipment2Tier(_j));}
    _o.SupportEquipment2Level = new List<int>();
    for (var _j = 0; _j < this.SupportEquipment2LevelLength; ++_j) {_o.SupportEquipment2Level.Add(this.SupportEquipment2Level(_j));}
    _o.SupportEquipment3Tier = new List<int>();
    for (var _j = 0; _j < this.SupportEquipment3TierLength; ++_j) {_o.SupportEquipment3Tier.Add(this.SupportEquipment3Tier(_j));}
    _o.SupportEquipment3Level = new List<int>();
    for (var _j = 0; _j < this.SupportEquipment3LevelLength; ++_j) {_o.SupportEquipment3Level.Add(this.SupportEquipment3Level(_j));}
    _o.SupportCharacterWeaponGrade = new List<int>();
    for (var _j = 0; _j < this.SupportCharacterWeaponGradeLength; ++_j) {_o.SupportCharacterWeaponGrade.Add(this.SupportCharacterWeaponGrade(_j));}
    _o.SupportCharacterWeaponLevel = new List<int>();
    for (var _j = 0; _j < this.SupportCharacterWeaponLevelLength; ++_j) {_o.SupportCharacterWeaponLevel.Add(this.SupportCharacterWeaponLevel(_j));}
    _o.SupportCharacterGearTier = new List<int>();
    for (var _j = 0; _j < this.SupportCharacterGearTierLength; ++_j) {_o.SupportCharacterGearTier.Add(this.SupportCharacterGearTier(_j));}
    _o.SupportCharacterGearLevel = new List<int>();
    for (var _j = 0; _j < this.SupportCharacterGearLevelLength; ++_j) {_o.SupportCharacterGearLevel.Add(this.SupportCharacterGearLevel(_j));}
    _o.InteractionTSCharacterId = this.InteractionTSCharacterId;
  }
  public static Offset<FlatData.FixedEchelonSettingExcel> Pack(FlatBufferBuilder builder, FixedEchelonSettingExcelT _o) {
    if (_o == null) return default(Offset<FlatData.FixedEchelonSettingExcel>);
...
public class FixedEchelonSettingExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("EchelonSceneSkip")]
  public bool EchelonSceneSkip { get; set; }
  [Newtonsoft.Json.JsonProperty("MainLeaderSlot")]
  public int MainLeaderSlot { get; set; }
  [Newtonsoft.Json.JsonProperty("MainCharacterID")]
  public List<long> MainCharacterID { get; set; }
  [Newtonsoft.Json.JsonProperty("MainLevel")]
  public List<int> MainLevel { get; set; }
  [Newtonsoft.Json.JsonProperty("MainGrade")]
  public List<int> MainGrade { get; set; }
  [Newtonsoft.Json.JsonProperty("MainExSkillLevel")]
  public List<int> MainExSkillLevel { get; set; }
  [Newtonsoft.Json.JsonProperty("MainNoneExSkillLevel")]
  public List<int> MainNoneExSkillLevel { get; set; }
  [Newtonsoft.Json.JsonProperty("MainEquipment1Tier")]
  public List<int> MainEquipment1Tier { get; set; }
  [Newtonsoft.Json.JsonProperty("MainEquipment1Level")]
  public List<int> MainEquipment1Level { get; set; }
  [Newtonsoft.Json.JsonProperty("MainEquipment2Tier")]
  public List<int> MainEquipment2Tier { get; set; }
  [Newtonsoft.Json.JsonProperty("MainEquipment2Level")]
  public List<int> MainEquipment2Level { get; set; }
  [Newtonsoft.Json.JsonProperty("MainEquipment3Tier")]
  public List<int> MainEquipment3Tier { get; set; }
  [Newtonsoft.Json.JsonProperty("MainEquipment3Level")]
  public List<int> MainEquipment3Level { get; set; }
  [Newtonsoft.Json.JsonProperty("MainCharacterWeaponGrade")]
  public List<int> MainCharacterWeaponGrade { get; set; }
  [Newtonsoft.Json.JsonProperty("MainCharacterWeaponLevel")]
  public List<int> MainCharacterWeaponLevel { get; set; }
  [Newtonsoft.Json.JsonProperty("MainCharacterGearTier")]
  public List<int> MainCharacterGearTier { get; set; }
  [Newtonsoft.Json.JsonProperty("MainCharacterGearLevel")]
  public List<int> MainCharacterGearLevel { get; set; }
  [Newtonsoft.Json.JsonProperty("SupportCharacterID")]
  public List<long> SupportCharacterID { get; set; }
  [Newtonsoft.Json.JsonProperty("SupportLevel")]
  public List<int> SupportLevel { get; set; }
  [Newtonsoft.Json.JsonProperty("SupportGrade")]
  public List<int> SupportGrade { get; set; }
  [Newtonsoft.Json.JsonProperty("SupportExSkillLevel")]
  public List<int> SupportExSkillLevel { get; set; }
  [Newtonsoft.Json.JsonProperty("SupportNoneExSkillLevel")]
  public List<int> SupportNoneExSkillLevel { get; set; }
  [Newtonsoft.Json.JsonProperty("SupportEquipment1Tier")]
  public List<int> SupportEquipment1Tier { get; set; }
  [Newtonsoft.Json.JsonProperty("SupportEquipment1Level")]
  public List<int> SupportEquipment1Level { get; set; }
  [Newtonsoft.Json.JsonProperty("SupportEquipment2Tier")]
  public List<int> SupportEquipment2Tier { get; set; }
  [Newtonsoft.Json.JsonProperty("SupportEquipment2Level")]
  public List<int> SupportEquipment2Level { get; set; }
  [Newtonsoft.Json.JsonProperty("SupportEquipment3Tier")]
  public List<int> SupportEquipment3Tier { get; set; }
  [Newtonsoft.Json.JsonProperty("SupportEquipment3Level")]
  public List<int> SupportEquipment3Level { get; set; }
  [Newtonsoft.Json.JsonProperty("SupportCharacterWeaponGrade")]
  public List<int> SupportCharacterWeaponGrade { get; set; }
  [Newtonsoft.Json.JsonProperty("SupportCharacterWeaponLevel")]
  public List<int> SupportCharacterWeaponLevel { get; set; }
  [Newtonsoft.Json.JsonProperty("SupportCharacterGearTier")]
  public List<int> SupportCharacterGearTier { get; set; }
  [Newtonsoft.Json.JsonProperty("SupportCharacterGearLevel")]
  public List<int> SupportCharacterGearLevel { get; set; }
  [Newtonsoft.Json.JsonProperty("InteractionTSCharacterId")]
