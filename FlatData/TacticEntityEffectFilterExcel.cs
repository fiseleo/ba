...
public struct TacticEntityEffectFilterExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.TacticEntityEffectFilterExcel> CreateTacticEntityEffectFilterExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.TacticEntityEffectFilterExcel> EndTacticEntityEffectFilterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.TacticEntityEffectFilterExcel>(o);
  }
  ...
  public void UnPackTo(TacticEntityEffectFilterExcelT _o) {
    _o.TargetEffectName = this.TargetEffectName;
    _o.ShowEffectToVehicle = this.ShowEffectToVehicle;
    _o.ShowEffectToBoss = this.ShowEffectToBoss;
  }
  public static Offset<FlatData.TacticEntityEffectFilterExcel> Pack(FlatBufferBuilder builder, TacticEntityEffectFilterExcelT _o) {
    if (_o == null) return default(Offset<FlatData.TacticEntityEffectFilterExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("TargetEffectName")]
  public string TargetEffectName { get; set; }
  [Newtonsoft.Json.JsonProperty("ShowEffectToVehicle")]
  public bool ShowEffectToVehicle { get; set; }
  [Newtonsoft.Json.JsonProperty("ShowEffectToBoss")]
