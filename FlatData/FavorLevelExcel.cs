...
public struct FavorLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.FavorLevelExcel> CreateFavorLevelExcel(FlatBufferBuilder builder,
      long Level = 0,
  ...
  public static Offset<FlatData.FavorLevelExcel> EndFavorLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.FavorLevelExcel>(o);
  }
  ...
  public void UnPackTo(FavorLevelExcelT _o) {
    ...
    for (var _j = 0; _j < this.ExpTypeLength; ++_j) {_o.ExpType.Add(this.ExpType(_j));}
  }
  public static Offset<FlatData.FavorLevelExcel> Pack(FlatBufferBuilder builder, FavorLevelExcelT _o) {
    if (_o == null) return default(Offset<FlatData.FavorLevelExcel>);
...
public class FavorLevelExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("ExpType")]
