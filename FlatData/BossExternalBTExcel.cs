...
public struct BossExternalBTExcel : IFlatbufferObject
{
  ...
  public FlatData.ExternalBTNodeType ExternalBTNodeType { get { int o = __p.__offset(8); return o != 0 ? (FlatData.ExternalBTNodeType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ExternalBTNodeType.Sequence; } }
  public FlatData.ExternalBTTrigger ExternalBTTrigger { get { int o = __p.__offset(10); return o != 0 ? (FlatData.ExternalBTTrigger)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ExternalBTTrigger.None; } }
  ...
  public FlatData.ExternalBehavior ExternalBehavior { get { int o = __p.__offset(16); return o != 0 ? (FlatData.ExternalBehavior)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ExternalBehavior.UseNextExSkill; } }
  ...
  public static Offset<FlatData.BossExternalBTExcel> CreateBossExternalBTExcel(FlatBufferBuilder builder,
      long ExternalBTId = 0,
      long AIPhase = 0,
      FlatData.ExternalBTNodeType ExternalBTNodeType = FlatData.ExternalBTNodeType.Sequence,
      FlatData.ExternalBTTrigger ExternalBTTrigger = FlatData.ExternalBTTrigger.None,
      StringOffset TriggerArgumentOffset = default(StringOffset),
      long BehaviorRate = 0,
      FlatData.ExternalBehavior ExternalBehavior = FlatData.ExternalBehavior.UseNextExSkill,
  ...
  public static void AddExternalBTNodeType(FlatBufferBuilder builder, FlatData.ExternalBTNodeType externalBTNodeType) { builder.AddInt(2, (int)externalBTNodeType, 0); }
  public static void AddExternalBTTrigger(FlatBufferBuilder builder, FlatData.ExternalBTTrigger externalBTTrigger) { builder.AddInt(3, (int)externalBTTrigger, 0); }
  ...
  public static void AddExternalBehavior(FlatBufferBuilder builder, FlatData.ExternalBehavior externalBehavior) { builder.AddInt(6, (int)externalBehavior, 0); }
  ...
  public static Offset<FlatData.BossExternalBTExcel> EndBossExternalBTExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.BossExternalBTExcel>(o);
  }
  ...
  public void UnPackTo(BossExternalBTExcelT _o) {
    ...
    _o.AIPhase = this.AIPhase;
    _o.ExternalBTNodeType = this.ExternalBTNodeType;
    _o.ExternalBTTrigger = this.ExternalBTTrigger;
    _o.TriggerArgument = this.TriggerArgument;
    _o.BehaviorRate = this.BehaviorRate;
    _o.ExternalBehavior = this.ExternalBehavior;
    _o.BehaviorArgument = this.BehaviorArgument;
  }
  public static Offset<FlatData.BossExternalBTExcel> Pack(FlatBufferBuilder builder, BossExternalBTExcelT _o) {
    if (_o == null) return default(Offset<FlatData.BossExternalBTExcel>);
...
public class BossExternalBTExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("AIPhase")]
  public long AIPhase { get; set; }
  [Newtonsoft.Json.JsonProperty("ExternalBTNodeType")]
  public FlatData.ExternalBTNodeType ExternalBTNodeType { get; set; }
  [Newtonsoft.Json.JsonProperty("ExternalBTTrigger")]
  public FlatData.ExternalBTTrigger ExternalBTTrigger { get; set; }
  [Newtonsoft.Json.JsonProperty("TriggerArgument")]
  public string TriggerArgument { get; set; }
  [Newtonsoft.Json.JsonProperty("BehaviorRate")]
  public long BehaviorRate { get; set; }
  [Newtonsoft.Json.JsonProperty("ExternalBehavior")]
  public FlatData.ExternalBehavior ExternalBehavior { get; set; }
  [Newtonsoft.Json.JsonProperty("BehaviorArgument")]
  public string BehaviorArgument { get; set; }

  public BossExternalBTExcelT() {
    this.ExternalBTId = 0;
    this.AIPhase = 0;
    this.ExternalBTNodeType = FlatData.ExternalBTNodeType.Sequence;
    this.ExternalBTTrigger = FlatData.ExternalBTTrigger.None;
    this.TriggerArgument = null;
    this.BehaviorRate = 0;
    this.ExternalBehavior = FlatData.ExternalBehavior.UseNextExSkill;
...
static public class BossExternalBTExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*ExternalBTNodeType*/, 4 /*FlatData.ExternalBTNodeType*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*ExternalBTTrigger*/, 4 /*FlatData.ExternalBTTrigger*/, 4, false)
      && verifier.VerifyString(tablePos, 12 /*TriggerArgument*/, false)
      && verifier.VerifyField(tablePos, 14 /*BehaviorRate*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 16 /*ExternalBehavior*/, 4 /*FlatData.ExternalBehavior*/, 4, false)
