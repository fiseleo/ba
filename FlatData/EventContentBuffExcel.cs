...
public struct EventContentBuffExcel : IFlatbufferObject
{
  ...
  public FlatData.Tag CharacterTag { get { int o = __p.__offset(8); return o != 0 ? (FlatData.Tag)__p.bb.GetInt(o + __p.bb_pos) : FlatData.Tag.A; } }
  public FlatData.EventContentBuffFindRule EnumType { get { int o = __p.__offset(10); return o != 0 ? (FlatData.EventContentBuffFindRule)__p.bb.GetInt(o + __p.bb_pos) : FlatData.EventContentBuffFindRule.None; } }
  ...
  public static Offset<FlatData.EventContentBuffExcel> CreateEventContentBuffExcel(FlatBufferBuilder builder,
      long EventContentBuffId = 0,
      bool IsBuff = false,
      FlatData.Tag CharacterTag = FlatData.Tag.A,
      FlatData.EventContentBuffFindRule EnumType = FlatData.EventContentBuffFindRule.None,
  ...
  public static void AddCharacterTag(FlatBufferBuilder builder, FlatData.Tag characterTag) { builder.AddInt(2, (int)characterTag, 0); }
  public static void AddEnumType(FlatBufferBuilder builder, FlatData.EventContentBuffFindRule enumType) { builder.AddInt(3, (int)enumType, 0); }
  ...
  public static Offset<FlatData.EventContentBuffExcel> EndEventContentBuffExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentBuffExcel>(o);
  }
  ...
  public void UnPackTo(EventContentBuffExcelT _o) {
    _o.EventContentBuffId = this.EventContentBuffId;
    _o.IsBuff = this.IsBuff;
    _o.CharacterTag = this.CharacterTag;
    _o.EnumType = this.EnumType;
    _o.EnumTypeValue = new List<string>();
    for (var _j = 0; _j < this.EnumTypeValueLength; ++_j) {_o.EnumTypeValue.Add(this.EnumTypeValue(_j));}
    _o.SkillGroupId = this.SkillGroupId;
    _o.IconPath = this.IconPath;
    _o.SpriteName = this.SpriteName;
    _o.BuffDescriptionLocalizeCodeId = this.BuffDescriptionLocalizeCodeId;
  }
  public static Offset<FlatData.EventContentBuffExcel> Pack(FlatBufferBuilder builder, EventContentBuffExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EventContentBuffExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("EventContentBuffId")]
  public long EventContentBuffId { get; set; }
  [Newtonsoft.Json.JsonProperty("IsBuff")]
  public bool IsBuff { get; set; }
  [Newtonsoft.Json.JsonProperty("CharacterTag")]
  public FlatData.Tag CharacterTag { get; set; }
  [Newtonsoft.Json.JsonProperty("EnumType")]
  public FlatData.EventContentBuffFindRule EnumType { get; set; }
  [Newtonsoft.Json.JsonProperty("EnumTypeValue")]
  public List<string> EnumTypeValue { get; set; }
  [Newtonsoft.Json.JsonProperty("SkillGroupId")]
  public string SkillGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("IconPath")]
  public string IconPath { get; set; }
  [Newtonsoft.Json.JsonProperty("SpriteName")]
  public string SpriteName { get; set; }
  [Newtonsoft.Json.JsonProperty("BuffDescriptionLocalizeCodeId")]
  public string BuffDescriptionLocalizeCodeId { get; set; }

  public EventContentBuffExcelT() {
    this.EventContentBuffId = 0;
    this.IsBuff = false;
    this.CharacterTag = FlatData.Tag.A;
    this.EnumType = FlatData.EventContentBuffFindRule.None;
...
static public class EventContentBuffExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*CharacterTag*/, 4 /*FlatData.Tag*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*EnumType*/, 4 /*FlatData.EventContentBuffFindRule*/, 4, false)
