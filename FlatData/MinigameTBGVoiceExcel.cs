...
public struct MinigameTBGVoiceExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(MinigameTBGVoiceExcelT _o) {
    ...
    _o.VoiceCondition = this.VoiceCondition;
    _o.VoiceId = this.VoiceId;
  }
  public static Offset<FlatData.MinigameTBGVoiceExcel> Pack(FlatBufferBuilder builder, MinigameTBGVoiceExcelT _o) {
    if (_o == null) return default(Offset<FlatData.MinigameTBGVoiceExcel>);
...
public class MinigameTBGVoiceExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("VoiceCondition")]
  public FlatData.TBGVoiceCondition VoiceCondition { get; set; }
  ...
  public MinigameTBGVoiceExcelT() {
    ...
    this.UniqueId = 0;
    this.VoiceCondition = FlatData.TBGVoiceCondition.None;
    this.VoiceId = 0;
  }
}
