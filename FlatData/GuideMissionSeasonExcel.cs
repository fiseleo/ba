...
public struct GuideMissionSeasonExcel : IFlatbufferObject
{
  ...
  public FlatData.ParcelType RequirementParcelType { get { int o = __p.__offset(42); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ParcelType.None; } }
  ...
  public FlatData.GuideMissionTabType TabType { get { int o = __p.__offset(48); return o != 0 ? (FlatData.GuideMissionTabType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.GuideMissionTabType.None; } }
  ...
  public static Offset<FlatData.GuideMissionSeasonExcel> CreateGuideMissionSeasonExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      FlatData.ParcelType RequirementParcelType = FlatData.ParcelType.None,
      long RequirementParcelId = 0,
      int RequirementParcelAmount = 0,
      FlatData.GuideMissionTabType TabType = FlatData.GuideMissionTabType.None,
  ...
  public static void AddRequirementParcelType(FlatBufferBuilder builder, FlatData.ParcelType requirementParcelType) { builder.AddInt(19, (int)requirementParcelType, 0); }
  ...
  public static void AddTabType(FlatBufferBuilder builder, FlatData.GuideMissionTabType tabType) { builder.AddInt(22, (int)tabType, 0); }
  ...
  public static Offset<FlatData.GuideMissionSeasonExcel> EndGuideMissionSeasonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.GuideMissionSeasonExcel>(o);
  }
  ...
  public void UnPackTo(GuideMissionSeasonExcelT _o) {
    _o.Id = this.Id;
    _o.TitleLocalizeCode = this.TitleLocalizeCode;
    _o.PermanentInfomationLocalizeCode = this.PermanentInfomationLocalizeCode;
    _o.InfomationLocalizeCode = this.InfomationLocalizeCode;
    _o.AccountType = this.AccountType;
    _o.Enabled = this.Enabled;
    _o.BannerOpenDate = this.BannerOpenDate;
    _o.StartDate = this.StartDate;
    _o.StartableEndDate = this.StartableEndDate;
    _o.EndDate = this.EndDate;
    _o.CloseBannerAfterCompletion = this.CloseBannerAfterCompletion;
    _o.MaximumLoginCount = this.MaximumLoginCount;
    _o.ExpiryDate = this.ExpiryDate;
    _o.SpineCharacterId = this.SpineCharacterId;
    _o.RequirementParcelImage = this.RequirementParcelImage;
    _o.RewardImage = this.RewardImage;
    _o.LobbyBannerImage = this.LobbyBannerImage;
    _o.BackgroundImage = this.BackgroundImage;
    _o.TitleImage = this.TitleImage;
    _o.RequirementParcelType = this.RequirementParcelType;
    _o.RequirementParcelId = this.RequirementParcelId;
    _o.RequirementParcelAmount = this.RequirementParcelAmount;
    _o.TabType = this.TabType;
    _o.IsPermanent = this.IsPermanent;
    _o.PreSeasonId = this.PreSeasonId;
  }
  public static Offset<FlatData.GuideMissionSeasonExcel> Pack(FlatBufferBuilder builder, GuideMissionSeasonExcelT _o) {
    if (_o == null) return default(Offset<FlatData.GuideMissionSeasonExcel>);
...
public class GuideMissionSeasonExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("TitleLocalizeCode")]
  public string TitleLocalizeCode { get; set; }
  [Newtonsoft.Json.JsonProperty("PermanentInfomationLocalizeCode")]
  ...
  [Newtonsoft.Json.JsonProperty("BannerOpenDate")]
  ...
  [Newtonsoft.Json.JsonProperty("CloseBannerAfterCompletion")]
  public bool CloseBannerAfterCompletion { get; set; }
  [Newtonsoft.Json.JsonProperty("MaximumLoginCount")]
  public long MaximumLoginCount { get; set; }
  [Newtonsoft.Json.JsonProperty("ExpiryDate")]
  public long ExpiryDate { get; set; }
  [Newtonsoft.Json.JsonProperty("SpineCharacterId")]
  public long SpineCharacterId { get; set; }
  [Newtonsoft.Json.JsonProperty("RequirementParcelImage")]
  public string RequirementParcelImage { get; set; }
  [Newtonsoft.Json.JsonProperty("RewardImage")]
  public string RewardImage { get; set; }
  [Newtonsoft.Json.JsonProperty("LobbyBannerImage")]
  public string LobbyBannerImage { get; set; }
  [Newtonsoft.Json.JsonProperty("BackgroundImage")]
  public string BackgroundImage { get; set; }
  [Newtonsoft.Json.JsonProperty("TitleImage")]
  public string TitleImage { get; set; }
  [Newtonsoft.Json.JsonProperty("RequirementParcelType")]
  public FlatData.ParcelType RequirementParcelType { get; set; }
  [Newtonsoft.Json.JsonProperty("RequirementParcelId")]
  public long RequirementParcelId { get; set; }
  [Newtonsoft.Json.JsonProperty("RequirementParcelAmount")]
  public int RequirementParcelAmount { get; set; }
  [Newtonsoft.Json.JsonProperty("TabType")]
  public FlatData.GuideMissionTabType TabType { get; set; }
  [Newtonsoft.Json.JsonProperty("IsPermanent")]
  public bool IsPermanent { get; set; }
  [Newtonsoft.Json.JsonProperty("PreSeasonId")]
  ...
  public GuideMissionSeasonExcelT() {
    ...
    this.RequirementParcelType = FlatData.ParcelType.None;
    this.RequirementParcelId = 0;
    this.RequirementParcelAmount = 0;
    this.TabType = FlatData.GuideMissionTabType.None;
...
static public class GuideMissionSeasonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 42 /*RequirementParcelType*/, 4 /*FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 48 /*TabType*/, 4 /*FlatData.GuideMissionTabType*/, 4, false)
