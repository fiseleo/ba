...
public struct MinigameTBGSeasonExcel : IFlatbufferObject
{
  ...
  public FlatData.ParcelType EventUseCostType { get { int o = __p.__offset(28); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ParcelType.None; } }
  public long EventUseCostId { get { int o = __p.__offset(30); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public FlatData.ParcelType EchelonRevivalCostType { get { int o = __p.__offset(32); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ParcelType.None; } }
  ...
  public static Offset<FlatData.MinigameTBGSeasonExcel> CreateMinigameTBGSeasonExcel(FlatBufferBuilder builder,
      ...
      FlatData.ParcelType EventUseCostType = FlatData.ParcelType.None,
      long EventUseCostId = 0,
      FlatData.ParcelType EchelonRevivalCostType = FlatData.ParcelType.None,
  ...
  public static void AddEventUseCostType(FlatBufferBuilder builder, FlatData.ParcelType eventUseCostType) { builder.AddInt(12, (int)eventUseCostType, 0); }
  public static void AddEventUseCostId(FlatBufferBuilder builder, long eventUseCostId) { builder.AddLong(13, eventUseCostId, 0); }
  public static void AddEchelonRevivalCostType(FlatBufferBuilder builder, FlatData.ParcelType echelonRevivalCostType) { builder.AddInt(14, (int)echelonRevivalCostType, 0); }
  ...
  public static Offset<FlatData.MinigameTBGSeasonExcel> EndMinigameTBGSeasonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.MinigameTBGSeasonExcel>(o);
  }
  ...
  public void UnPackTo(MinigameTBGSeasonExcelT _o) {
    ...
    _o.ItemSlot = this.ItemSlot;
    _o.DefaultEchelonHp = this.DefaultEchelonHp;
    _o.DefaultItemDiceId = this.DefaultItemDiceId;
    _o.EchelonSlot1CharacterId = this.EchelonSlot1CharacterId;
    _o.EchelonSlot2CharacterId = this.EchelonSlot2CharacterId;
    _o.EchelonSlot3CharacterId = this.EchelonSlot3CharacterId;
    _o.EchelonSlot4CharacterId = this.EchelonSlot4CharacterId;
    _o.EchelonSlot1Portrait = this.EchelonSlot1Portrait;
    _o.EchelonSlot2Portrait = this.EchelonSlot2Portrait;
    _o.EchelonSlot3Portrait = this.EchelonSlot3Portrait;
    _o.EchelonSlot4Portrait = this.EchelonSlot4Portrait;
    _o.EventUseCostType = this.EventUseCostType;
    _o.EventUseCostId = this.EventUseCostId;
    _o.EchelonRevivalCostType = this.EchelonRevivalCostType;
    _o.EchelonRevivalCostId = this.EchelonRevivalCostId;
    _o.EchelonRevivalCostAmount = this.EchelonRevivalCostAmount;
    _o.EnemyBossHP = this.EnemyBossHP;
    _o.EnemyMinionHP = this.EnemyMinionHP;
    _o.AttackDamage = this.AttackDamage;
    _o.CriticalAttackDamage = this.CriticalAttackDamage;
    _o.RoundItemSelectLimit = this.RoundItemSelectLimit;
    _o.InstantClearRound = this.InstantClearRound;
    _o.MaxHp = this.MaxHp;
    _o.MapImagePath = this.MapImagePath;
    _o.MapNameLocalize = this.MapNameLocalize;
  }
  public static Offset<FlatData.MinigameTBGSeasonExcel> Pack(FlatBufferBuilder builder, MinigameTBGSeasonExcelT _o) {
    if (_o == null) return default(Offset<FlatData.MinigameTBGSeasonExcel>);
...
public class MinigameTBGSeasonExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("DefaultEchelonHp")]
  public int DefaultEchelonHp { get; set; }
  [Newtonsoft.Json.JsonProperty("DefaultItemDiceId")]
  public long DefaultItemDiceId { get; set; }
  [Newtonsoft.Json.JsonProperty("EchelonSlot1CharacterId")]
  public long EchelonSlot1CharacterId { get; set; }
  [Newtonsoft.Json.JsonProperty("EchelonSlot2CharacterId")]
  public long EchelonSlot2CharacterId { get; set; }
  [Newtonsoft.Json.JsonProperty("EchelonSlot3CharacterId")]
  public long EchelonSlot3CharacterId { get; set; }
  [Newtonsoft.Json.JsonProperty("EchelonSlot4CharacterId")]
  public long EchelonSlot4CharacterId { get; set; }
  [Newtonsoft.Json.JsonProperty("EchelonSlot1Portrait")]
  public string EchelonSlot1Portrait { get; set; }
  [Newtonsoft.Json.JsonProperty("EchelonSlot2Portrait")]
  public string EchelonSlot2Portrait { get; set; }
  [Newtonsoft.Json.JsonProperty("EchelonSlot3Portrait")]
  public string EchelonSlot3Portrait { get; set; }
  [Newtonsoft.Json.JsonProperty("EchelonSlot4Portrait")]
  public string EchelonSlot4Portrait { get; set; }
  [Newtonsoft.Json.JsonProperty("EventUseCostType")]
  public FlatData.ParcelType EventUseCostType { get; set; }
  [Newtonsoft.Json.JsonProperty("EventUseCostId")]
  public long EventUseCostId { get; set; }
  [Newtonsoft.Json.JsonProperty("EchelonRevivalCostType")]
  public FlatData.ParcelType EchelonRevivalCostType { get; set; }
  [Newtonsoft.Json.JsonProperty("EchelonRevivalCostId")]
  public long EchelonRevivalCostId { get; set; }
  [Newtonsoft.Json.JsonProperty("EchelonRevivalCostAmount")]
  public int EchelonRevivalCostAmount { get; set; }
  [Newtonsoft.Json.JsonProperty("EnemyBossHP")]
  public int EnemyBossHP { get; set; }
  [Newtonsoft.Json.JsonProperty("EnemyMinionHP")]
  public int EnemyMinionHP { get; set; }
  [Newtonsoft.Json.JsonProperty("AttackDamage")]
  public int AttackDamage { get; set; }
  [Newtonsoft.Json.JsonProperty("CriticalAttackDamage")]
  public int CriticalAttackDamage { get; set; }
  [Newtonsoft.Json.JsonProperty("RoundItemSelectLimit")]
  public int RoundItemSelectLimit { get; set; }
  [Newtonsoft.Json.JsonProperty("InstantClearRound")]
  public int InstantClearRound { get; set; }
  [Newtonsoft.Json.JsonProperty("MaxHp")]
  public int MaxHp { get; set; }
  [Newtonsoft.Json.JsonProperty("MapImagePath")]
  public string MapImagePath { get; set; }
  [Newtonsoft.Json.JsonProperty("MapNameLocalize")]
  ...
  public MinigameTBGSeasonExcelT() {
    ...
    this.EventUseCostType = FlatData.ParcelType.None;
    this.EventUseCostId = 0;
    this.EchelonRevivalCostType = FlatData.ParcelType.None;
...
static public class MinigameTBGSeasonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 28 /*EventUseCostType*/, 4 /*FlatData.ParcelType*/, 4, false)
      && verifier.VerifyField(tablePos, 30 /*EventUseCostId*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 32 /*EchelonRevivalCostType*/, 4 /*FlatData.ParcelType*/, 4, false)
