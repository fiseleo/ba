...
public struct CharacterStatsDetailExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CharacterStatsDetailExcelT _o) {
    _o.Id = this.Id;
    _o.DetailShowStats = new List<FlatData.StatType>();
    for (var _j = 0; _j < this.DetailShowStatsLength; ++_j) {_o.DetailShowStats.Add(this.DetailShowStats(_j));}
    _o.IsStatsPercent = new List<bool>();
    for (var _j = 0; _j < this.IsStatsPercentLength; ++_j) {_o.IsStatsPercent.Add(this.IsStatsPercent(_j));}
  }
  public static Offset<FlatData.CharacterStatsDetailExcel> Pack(FlatBufferBuilder builder, CharacterStatsDetailExcelT _o) {
    if (_o == null) return default(Offset<FlatData.CharacterStatsDetailExcel>);
...
public class CharacterStatsDetailExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("DetailShowStats")]
  public List<FlatData.StatType> DetailShowStats { get; set; }
  [Newtonsoft.Json.JsonProperty("IsStatsPercent")]
