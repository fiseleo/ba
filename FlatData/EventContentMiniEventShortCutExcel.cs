...
public struct EventContentMiniEventShortCutExcel : IFlatbufferObject
{
  ...
  public FlatData.EventTargetType ShorcutContentType { get { int o = __p.__offset(8); return o != 0 ? (FlatData.EventTargetType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.EventTargetType.WeekDungeon; } }

  public static Offset<FlatData.EventContentMiniEventShortCutExcel> CreateEventContentMiniEventShortCutExcel(FlatBufferBuilder builder,
      int Id = 0,
      uint LocalizeEtcId = 0,
      FlatData.EventTargetType ShorcutContentType = FlatData.EventTargetType.WeekDungeon) {
  ...
  public static void AddShorcutContentType(FlatBufferBuilder builder, FlatData.EventTargetType shorcutContentType) { builder.AddInt(2, (int)shorcutContentType, 0); }
  public static Offset<FlatData.EventContentMiniEventShortCutExcel> EndEventContentMiniEventShortCutExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentMiniEventShortCutExcel>(o);
  }
  ...
  public void UnPackTo(EventContentMiniEventShortCutExcelT _o) {
    ...
    _o.ShorcutContentType = this.ShorcutContentType;
  }
  public static Offset<FlatData.EventContentMiniEventShortCutExcel> Pack(FlatBufferBuilder builder, EventContentMiniEventShortCutExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EventContentMiniEventShortCutExcel>);
...
public class EventContentMiniEventShortCutExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("ShorcutContentType")]
  public FlatData.EventTargetType ShorcutContentType { get; set; }

  public EventContentMiniEventShortCutExcelT() {
    this.Id = 0;
    this.LocalizeEtcId = 0;
    this.ShorcutContentType = FlatData.EventTargetType.WeekDungeon;
  }
}
...
static public class EventContentMiniEventShortCutExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*ShorcutContentType*/, 4 /*FlatData.EventTargetType*/, 4, false)
