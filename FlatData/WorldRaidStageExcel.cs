...
public struct WorldRaidStageExcel : IFlatbufferObject
{
  ...
  public FlatData.WorldRaidDifficulty WorldRaidDifficulty { get { int o = __p.__offset(22); return o != 0 ? (FlatData.WorldRaidDifficulty)__p.bb.GetInt(o + __p.bb_pos) : FlatData.WorldRaidDifficulty.None; } }
  ...
  public static Offset<FlatData.WorldRaidStageExcel> CreateWorldRaidStageExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      FlatData.WorldRaidDifficulty WorldRaidDifficulty = FlatData.WorldRaidDifficulty.None,
  ...
  public static void AddWorldRaidDifficulty(FlatBufferBuilder builder, FlatData.WorldRaidDifficulty worldRaidDifficulty) { builder.AddInt(9, (int)worldRaidDifficulty, 0); }
  ...
  public static Offset<FlatData.WorldRaidStageExcel> EndWorldRaidStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.WorldRaidStageExcel>(o);
  }
  ...
  public void UnPackTo(WorldRaidStageExcelT _o) {
    ...
    _o.WorldRaidBossGroupId = this.WorldRaidBossGroupId;
    ...
    _o.AssistCharacterLimitCount = this.AssistCharacterLimitCount;
    _o.WorldRaidDifficulty = this.WorldRaidDifficulty;
    _o.DifficultyOpenCondition = this.DifficultyOpenCondition;
    _o.RaidEnterAmount = this.RaidEnterAmount;
    _o.ReEnterAmount = this.ReEnterAmount;
    _o.BattleDuration = this.BattleDuration;
    _o.GroundId = this.GroundId;
    _o.RaidBattleEndRewardGroupId = this.RaidBattleEndRewardGroupId;
    ...
    _o.UseFixedEchelon = this.UseFixedEchelon;
    _o.FixedEchelonId = this.FixedEchelonId;
    _o.IsRaidScenarioBattle = this.IsRaidScenarioBattle;
    _o.ShowSkillCard = this.ShowSkillCard;
    _o.BossBGInfoKey = this.BossBGInfoKey;
    _o.DamageToWorldBoss = this.DamageToWorldBoss;
    _o.AllyPassiveSkill = new List<string>();
    for (var _j = 0; _j < this.AllyPassiveSkillLength; ++_j) {_o.AllyPassiveSkill.Add(this.AllyPassiveSkill(_j));}
    ...
    _o.SaveCurrentLocalBossHP = this.SaveCurrentLocalBossHP;
    _o.EchelonExtensionType = this.EchelonExtensionType;
  }
  public static Offset<FlatData.WorldRaidStageExcel> Pack(FlatBufferBuilder builder, WorldRaidStageExcelT _o) {
    if (_o == null) return default(Offset<FlatData.WorldRaidStageExcel>);
...
public class WorldRaidStageExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("WorldRaidBossGroupId")]
  ...
  [Newtonsoft.Json.JsonProperty("AssistCharacterLimitCount")]
  public long AssistCharacterLimitCount { get; set; }
  [Newtonsoft.Json.JsonProperty("WorldRaidDifficulty")]
  public FlatData.WorldRaidDifficulty WorldRaidDifficulty { get; set; }
  [Newtonsoft.Json.JsonProperty("DifficultyOpenCondition")]
  public bool DifficultyOpenCondition { get; set; }
  [Newtonsoft.Json.JsonProperty("RaidEnterAmount")]
  public long RaidEnterAmount { get; set; }
  [Newtonsoft.Json.JsonProperty("ReEnterAmount")]
  ...
  [Newtonsoft.Json.JsonProperty("RaidBattleEndRewardGroupId")]
  ...
  [Newtonsoft.Json.JsonProperty("DamageToWorldBoss")]
  public long DamageToWorldBoss { get; set; }
  [Newtonsoft.Json.JsonProperty("AllyPassiveSkill")]
  ...
  [Newtonsoft.Json.JsonProperty("SaveCurrentLocalBossHP")]
  ...
  public WorldRaidStageExcelT() {
    ...
    this.WorldRaidDifficulty = FlatData.WorldRaidDifficulty.None;
...
static public class WorldRaidStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*WorldRaidDifficulty*/, 4 /*FlatData.WorldRaidDifficulty*/, 4, false)
