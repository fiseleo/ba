...
public struct EventContentDiceRaceProbExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.EventContentDiceRaceProbExcel> CreateEventContentDiceRaceProbExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.EventContentDiceRaceProbExcel> EndEventContentDiceRaceProbExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentDiceRaceProbExcel>(o);
  }
  ...
  public void UnPackTo(EventContentDiceRaceProbExcelT _o) {
    ...
    _o.CostItemAmount = this.CostItemAmount;
    _o.DiceResult = this.DiceResult;
    _o.Prob = this.Prob;
  }
  public static Offset<FlatData.EventContentDiceRaceProbExcel> Pack(FlatBufferBuilder builder, EventContentDiceRaceProbExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EventContentDiceRaceProbExcel>);
...
public class EventContentDiceRaceProbExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("CostItemId")]
  public long CostItemId { get; set; }
  [Newtonsoft.Json.JsonProperty("CostItemAmount")]
