...
public struct FieldEvidenceExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(FieldEvidenceExcelT _o) {
    ...
    _o.DetailLocalizeKey = this.DetailLocalizeKey;
    _o.ImagePath = this.ImagePath;
  }
  public static Offset<FlatData.FieldEvidenceExcel> Pack(FlatBufferBuilder builder, FieldEvidenceExcelT _o) {
    if (_o == null) return default(Offset<FlatData.FieldEvidenceExcel>);
...
public class FieldEvidenceExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("DetailLocalizeKey")]
