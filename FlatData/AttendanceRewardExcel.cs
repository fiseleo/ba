...
public struct AttendanceRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.AttendanceRewardExcel> CreateAttendanceRewardExcel(FlatBufferBuilder builder,
      long AttendanceId = 0,
      long Day = 0,
  ...
  public static Offset<FlatData.AttendanceRewardExcel> EndAttendanceRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.AttendanceRewardExcel>(o);
  }
  ...
  public static Offset<FlatData.AttendanceRewardExcel> Pack(FlatBufferBuilder builder, AttendanceRewardExcelT _o) {
    if (_o == null) return default(Offset<FlatData.AttendanceRewardExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("AttendanceId")]
