...
public struct FieldMasteryManageExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.FieldMasteryManageExcel> CreateFieldMasteryManageExcel(FlatBufferBuilder builder,
      long FieldSeason = 0,
      uint LocalizeEtc = 0,
  ...
  public static Offset<FlatData.FieldMasteryManageExcel> EndFieldMasteryManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.FieldMasteryManageExcel>(o);
  }
  ...
  public void UnPackTo(FieldMasteryManageExcelT _o) {
    _o.FieldSeason = this.FieldSeason;
    _o.LocalizeEtc = this.LocalizeEtc;
    _o.ImagePath = this.ImagePath;
    _o.LevelId = this.LevelId;
  }
  public static Offset<FlatData.FieldMasteryManageExcel> Pack(FlatBufferBuilder builder, FieldMasteryManageExcelT _o) {
    if (_o == null) return default(Offset<FlatData.FieldMasteryManageExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("FieldSeason")]
  public long FieldSeason { get; set; }
  [Newtonsoft.Json.JsonProperty("LocalizeEtc")]
  public uint LocalizeEtc { get; set; }
  [Newtonsoft.Json.JsonProperty("ImagePath")]
  public string ImagePath { get; set; }
  [Newtonsoft.Json.JsonProperty("LevelId")]
