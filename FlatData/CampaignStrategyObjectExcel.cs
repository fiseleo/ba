...
public struct CampaignStrategyObjectExcel : IFlatbufferObject
{
  ...
  public FlatData.StrategyObjectType StrategyObjectType { get { int o = __p.__offset(12); return o != 0 ? (FlatData.StrategyObjectType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.StrategyObjectType.None; } }
  public FlatData.ParcelType StrategyRewardParcelType { get { int o = __p.__offset(14); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ParcelType.None; } }
  ...
  public static Offset<FlatData.CampaignStrategyObjectExcel> CreateCampaignStrategyObjectExcel(FlatBufferBuilder builder,
      long Id = 0,
      uint Key = 0,
      StringOffset NameOffset = default(StringOffset),
      StringOffset PrefabNameOffset = default(StringOffset),
      FlatData.StrategyObjectType StrategyObjectType = FlatData.StrategyObjectType.None,
      FlatData.ParcelType StrategyRewardParcelType = FlatData.ParcelType.None,
  ...
  public static void AddStrategyObjectType(FlatBufferBuilder builder, FlatData.StrategyObjectType strategyObjectType) { builder.AddInt(4, (int)strategyObjectType, 0); }
  public static void AddStrategyRewardParcelType(FlatBufferBuilder builder, FlatData.ParcelType strategyRewardParcelType) { builder.AddInt(5, (int)strategyRewardParcelType, 0); }
  ...
  public static Offset<FlatData.CampaignStrategyObjectExcel> EndCampaignStrategyObjectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.CampaignStrategyObjectExcel>(o);
  }
  ...
  public void UnPackTo(CampaignStrategyObjectExcelT _o) {
    ...
    _o.StrategyObjectType = this.StrategyObjectType;
    _o.StrategyRewardParcelType = this.StrategyRewardParcelType;
    _o.StrategyRewardID = this.StrategyRewardID;
    _o.StrategyRewardName = this.StrategyRewardName;
    _o.StrategyRewardAmount = this.StrategyRewardAmount;
    _o.StrategySightRange = this.StrategySightRange;
    _o.PortalId = this.PortalId;
    _o.HealValue = this.HealValue;
    _o.SwithId = this.SwithId;
    _o.BuffId = this.BuffId;
    _o.Disposable = this.Disposable;
  }
  public static Offset<FlatData.CampaignStrategyObjectExcel> Pack(FlatBufferBuilder builder, CampaignStrategyObjectExcelT _o) {
    if (_o == null) return default(Offset<FlatData.CampaignStrategyObjectExcel>);
...
public class CampaignStrategyObjectExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("StrategyObjectType")]
  public FlatData.StrategyObjectType StrategyObjectType { get; set; }
  [Newtonsoft.Json.JsonProperty("StrategyRewardParcelType")]
  public FlatData.ParcelType StrategyRewardParcelType { get; set; }
  [Newtonsoft.Json.JsonProperty("StrategyRewardID")]
  public long StrategyRewardID { get; set; }
  [Newtonsoft.Json.JsonProperty("StrategyRewardName")]
  public string StrategyRewardName { get; set; }
  [Newtonsoft.Json.JsonProperty("StrategyRewardAmount")]
  ...
  [Newtonsoft.Json.JsonProperty("PortalId")]
  public int PortalId { get; set; }
  [Newtonsoft.Json.JsonProperty("HealValue")]
  public int HealValue { get; set; }
  [Newtonsoft.Json.JsonProperty("SwithId")]
  public int SwithId { get; set; }
  [Newtonsoft.Json.JsonProperty("BuffId")]
  ...
  public CampaignStrategyObjectExcelT() {
    ...
    this.StrategyObjectType = FlatData.StrategyObjectType.None;
    this.StrategyRewardParcelType = FlatData.ParcelType.None;
...
static public class CampaignStrategyObjectExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*StrategyObjectType*/, 4 /*FlatData.StrategyObjectType*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*StrategyRewardParcelType*/, 4 /*FlatData.ParcelType*/, 4, false)
