...
public struct CharacterDialogFieldExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(CharacterDialogFieldExcelT _o) {
    ...
    _o.IsInteractionDialog = this.IsInteractionDialog;
    _o.HideUI = this.HideUI;
    _o.LocalizeKR = this.LocalizeKR;
    _o.LocalizeJP = this.LocalizeJP;
  }
  public static Offset<FlatData.CharacterDialogFieldExcel> Pack(FlatBufferBuilder builder, CharacterDialogFieldExcelT _o) {
    if (_o == null) return default(Offset<FlatData.CharacterDialogFieldExcel>);
...
public class CharacterDialogFieldExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("DialogType")]
  public FlatData.FieldDialogType DialogType { get; set; }
  [Newtonsoft.Json.JsonProperty("Duration")]
  public long Duration { get; set; }
  [Newtonsoft.Json.JsonProperty("MotionName")]
  public string MotionName { get; set; }
  [Newtonsoft.Json.JsonProperty("IsInteractionDialog")]
  public bool IsInteractionDialog { get; set; }
  [Newtonsoft.Json.JsonProperty("HideUI")]
  public bool HideUI { get; set; }
  [Newtonsoft.Json.JsonProperty("LocalizeKR")]
  public string LocalizeKR { get; set; }
  [Newtonsoft.Json.JsonProperty("LocalizeJP")]
  ...
  public CharacterDialogFieldExcelT() {
    ...
    this.Phase = 0;
    this.TargetIndex = 0;
    this.DialogType = FlatData.FieldDialogType.None;
    this.Duration = 0;
