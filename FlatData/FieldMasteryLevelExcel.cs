...
public struct FieldMasteryLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.FieldMasteryLevelExcel> CreateFieldMasteryLevelExcel(FlatBufferBuilder builder,
      int Level = 0,
  ...
  public static Offset<FlatData.FieldMasteryLevelExcel> EndFieldMasteryLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.FieldMasteryLevelExcel>(o);
  }
  ...
  public void UnPackTo(FieldMasteryLevelExcelT _o) {
    ...
    for (var _j = 0; _j < this.ExpLength; ++_j) {_o.Exp.Add(this.Exp(_j));}
  ...
  public static Offset<FlatData.FieldMasteryLevelExcel> Pack(FlatBufferBuilder builder, FieldMasteryLevelExcelT _o) {
    if (_o == null) return default(Offset<FlatData.FieldMasteryLevelExcel>);
