...
public struct PickupDuplicateBonusExcel : IFlatbufferObject
{
  ...
  public FlatData.ShopCategoryType ShopCategoryType { get { int o = __p.__offset(6); return o != 0 ? (FlatData.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ShopCategoryType.General; } }
  ...
  public FlatData.ParcelType RewardParcelType { get { int o = __p.__offset(12); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ParcelType.None; } }
  ...
  public static Offset<FlatData.PickupDuplicateBonusExcel> CreatePickupDuplicateBonusExcel(FlatBufferBuilder builder,
      long Id = 0,
      FlatData.ShopCategoryType ShopCategoryType = FlatData.ShopCategoryType.General,
      long ShopId = 0,
  ...
  public static void AddShopCategoryType(FlatBufferBuilder builder, FlatData.ShopCategoryType shopCategoryType) { builder.AddInt(1, (int)shopCategoryType, 0); }
  ...
  public static void AddRewardParcelType(FlatBufferBuilder builder, FlatData.ParcelType rewardParcelType) { builder.AddInt(4, (int)rewardParcelType, 0); }
  ...
  public static Offset<FlatData.PickupDuplicateBonusExcel> EndPickupDuplicateBonusExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.PickupDuplicateBonusExcel>(o);
  }
  ...
  public void UnPackTo(PickupDuplicateBonusExcelT _o) {
    _o.Id = this.Id;
    _o.ShopCategoryType = this.ShopCategoryType;
    _o.ShopId = this.ShopId;
    _o.PickupCharacterId = this.PickupCharacterId;
  ...
  public static Offset<FlatData.PickupDuplicateBonusExcel> Pack(FlatBufferBuilder builder, PickupDuplicateBonusExcelT _o) {
    if (_o == null) return default(Offset<FlatData.PickupDuplicateBonusExcel>);
...
public class PickupDuplicateBonusExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("ShopCategoryType")]
  public FlatData.ShopCategoryType ShopCategoryType { get; set; }
  [Newtonsoft.Json.JsonProperty("ShopId")]
  public long ShopId { get; set; }
  [Newtonsoft.Json.JsonProperty("PickupCharacterId")]
  ...
  public PickupDuplicateBonusExcelT() {
    this.Id = 0;
    this.ShopCategoryType = FlatData.ShopCategoryType.General;
    this.ShopId = 0;
...
static public class PickupDuplicateBonusExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ShopCategoryType*/, 4 /*FlatData.ShopCategoryType*/, 4, false)
      && verifier.VerifyField(tablePos, 8 /*ShopId*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 10 /*PickupCharacterId*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 12 /*RewardParcelType*/, 4 /*FlatData.ParcelType*/, 4, false)
