...
public struct LocalizeGachaShopExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(LocalizeGachaShopExcelT _o) {
    _o.GachaShopId = this.GachaShopId;
    _o.TabNameKr = this.TabNameKr;
    _o.TabNameJp = this.TabNameJp;
    _o.TitleNameKr = this.TitleNameKr;
    _o.TitleNameJp = this.TitleNameJp;
    _o.SubTitleKr = this.SubTitleKr;
    _o.SubTitleJp = this.SubTitleJp;
    _o.GachaDescriptionKr = this.GachaDescriptionKr;
    _o.GachaDescriptionJp = this.GachaDescriptionJp;
  }
  public static Offset<FlatData.LocalizeGachaShopExcel> Pack(FlatBufferBuilder builder, LocalizeGachaShopExcelT _o) {
    if (_o == null) return default(Offset<FlatData.LocalizeGachaShopExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("GachaShopId")]
  public long GachaShopId { get; set; }
  [Newtonsoft.Json.JsonProperty("TabNameKr")]
  public string TabNameKr { get; set; }
  [Newtonsoft.Json.JsonProperty("TabNameJp")]
  public string TabNameJp { get; set; }
  [Newtonsoft.Json.JsonProperty("TitleNameKr")]
  public string TitleNameKr { get; set; }
  [Newtonsoft.Json.JsonProperty("TitleNameJp")]
  public string TitleNameJp { get; set; }
  [Newtonsoft.Json.JsonProperty("SubTitleKr")]
  public string SubTitleKr { get; set; }
  [Newtonsoft.Json.JsonProperty("SubTitleJp")]
  public string SubTitleJp { get; set; }
  [Newtonsoft.Json.JsonProperty("GachaDescriptionKr")]
  public string GachaDescriptionKr { get; set; }
  [Newtonsoft.Json.JsonProperty("GachaDescriptionJp")]
