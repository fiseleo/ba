...
public struct WorldRaidConditionExcel : IFlatbufferObject
{
  ...
  public FlatData.MultipleConditionCheckType MultipleConditionCheckType { get { int o = __p.__offset(16); return o != 0 ? (FlatData.MultipleConditionCheckType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.MultipleConditionCheckType.And; } }
  ...
  public static Offset<FlatData.WorldRaidConditionExcel> CreateWorldRaidConditionExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddMultipleConditionCheckType(FlatBufferBuilder builder, FlatData.MultipleConditionCheckType multipleConditionCheckType) { builder.AddInt(6, (int)multipleConditionCheckType, 0); }
  ...
  public static Offset<FlatData.WorldRaidConditionExcel> EndWorldRaidConditionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.WorldRaidConditionExcel>(o);
  }
  ...
  public void UnPackTo(WorldRaidConditionExcelT _o) {
    ...
    for (var _j = 0; _j < this.ScenarioModeIdLength; ++_j) {_o.ScenarioModeId.Add(this.ScenarioModeId(_j));}
    _o.CampaignStageID = new List<long>();
    for (var _j = 0; _j < this.CampaignStageIDLength; ++_j) {_o.CampaignStageID.Add(this.CampaignStageID(_j));}
    _o.MultipleConditionCheckType = this.MultipleConditionCheckType;
    _o.AfterWhenDate = this.AfterWhenDate;
    _o.WorldRaidBossKill = new List<long>();
    for (var _j = 0; _j < this.WorldRaidBossKillLength; ++_j) {_o.WorldRaidBossKill.Add(this.WorldRaidBossKill(_j));}
  }
  public static Offset<FlatData.WorldRaidConditionExcel> Pack(FlatBufferBuilder builder, WorldRaidConditionExcelT _o) {
    if (_o == null) return default(Offset<FlatData.WorldRaidConditionExcel>);
...
public class WorldRaidConditionExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("AfterWhenDate")]
  public string AfterWhenDate { get; set; }
  [Newtonsoft.Json.JsonProperty("WorldRaidBossKill")]
...
static public class WorldRaidConditionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*MultipleConditionCheckType*/, 4 /*FlatData.MultipleConditionCheckType*/, 4, false)
