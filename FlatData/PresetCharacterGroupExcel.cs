...
public struct PresetCharacterGroupExcel : IFlatbufferObject
{
  ...
  public FlatData.PotentialStatBonusRateType PotentialType01 { get { int o = __p.__offset(58); return o != 0 ? (FlatData.PotentialStatBonusRateType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.PotentialStatBonusRateType.None; } }
  public int PotentialLevel01 { get { int o = __p.__offset(60); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public FlatData.PotentialStatBonusRateType PotentialType02 { get { int o = __p.__offset(62); return o != 0 ? (FlatData.PotentialStatBonusRateType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.PotentialStatBonusRateType.None; } }
  public int PotentialLevel02 { get { int o = __p.__offset(64); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public FlatData.PotentialStatBonusRateType PotentialType03 { get { int o = __p.__offset(66); return o != 0 ? (FlatData.PotentialStatBonusRateType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.PotentialStatBonusRateType.None; } }
  public int PotentialLevel03 { get { int o = __p.__offset(68); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }

  public static Offset<FlatData.PresetCharacterGroupExcel> CreatePresetCharacterGroupExcel(FlatBufferBuilder builder,
      ...
      FlatData.PotentialStatBonusRateType PotentialType01 = FlatData.PotentialStatBonusRateType.None,
      int PotentialLevel01 = 0,
      FlatData.PotentialStatBonusRateType PotentialType02 = FlatData.PotentialStatBonusRateType.None,
      int PotentialLevel02 = 0,
      FlatData.PotentialStatBonusRateType PotentialType03 = FlatData.PotentialStatBonusRateType.None,
  ...
  public static void AddPotentialType01(FlatBufferBuilder builder, FlatData.PotentialStatBonusRateType potentialType01) { builder.AddInt(27, (int)potentialType01, 0); }
  ...
  public static void AddPotentialType02(FlatBufferBuilder builder, FlatData.PotentialStatBonusRateType potentialType02) { builder.AddInt(29, (int)potentialType02, 0); }
  ...
  public static void AddPotentialType03(FlatBufferBuilder builder, FlatData.PotentialStatBonusRateType potentialType03) { builder.AddInt(31, (int)potentialType03, 0); }
  ...
  public static Offset<FlatData.PresetCharacterGroupExcel> EndPresetCharacterGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.PresetCharacterGroupExcel>(o);
  }
  ...
  public void UnPackTo(PresetCharacterGroupExcelT _o) {
    _o.PresetCharacterGroupId = this.PresetCharacterGroupId;
    _o.GetPresetType = this.GetPresetType;
    _o.Level = this.Level;
    _o.Exp = this.Exp;
    _o.FavorExp = this.FavorExp;
    _o.FavorRank = this.FavorRank;
    _o.StarGrade = this.StarGrade;
    _o.ExSkillLevel = this.ExSkillLevel;
    _o.PassiveSkillLevel = this.PassiveSkillLevel;
    _o.ExtraPassiveSkillLevel = this.ExtraPassiveSkillLevel;
    _o.CommonSkillLevel = this.CommonSkillLevel;
    _o.LeaderSkillLevel = this.LeaderSkillLevel;
    _o.EquipSlot01 = this.EquipSlot01;
    _o.EquipSlotTier01 = this.EquipSlotTier01;
    _o.EquipSlotLevel01 = this.EquipSlotLevel01;
    _o.EquipSlot02 = this.EquipSlot02;
    _o.EquipSlotTier02 = this.EquipSlotTier02;
    _o.EquipSlotLevel02 = this.EquipSlotLevel02;
    _o.EquipSlot03 = this.EquipSlot03;
    _o.EquipSlotTier03 = this.EquipSlotTier03;
    _o.EquipSlotLevel03 = this.EquipSlotLevel03;
    _o.EquipCharacterWeapon = this.EquipCharacterWeapon;
    _o.EquipCharacterWeaponTier = this.EquipCharacterWeaponTier;
    _o.EquipCharacterWeaponLevel = this.EquipCharacterWeaponLevel;
    _o.EquipCharacterGear = this.EquipCharacterGear;
    _o.EquipCharacterGearTier = this.EquipCharacterGearTier;
    _o.EquipCharacterGearLevel = this.EquipCharacterGearLevel;
    _o.PotentialType01 = this.PotentialType01;
    _o.PotentialLevel01 = this.PotentialLevel01;
    _o.PotentialType02 = this.PotentialType02;
    _o.PotentialLevel02 = this.PotentialLevel02;
    _o.PotentialType03 = this.PotentialType03;
    _o.PotentialLevel03 = this.PotentialLevel03;
  }
  public static Offset<FlatData.PresetCharacterGroupExcel> Pack(FlatBufferBuilder builder, PresetCharacterGroupExcelT _o) {
    if (_o == null) return default(Offset<FlatData.PresetCharacterGroupExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("PresetCharacterGroupId")]
  public long PresetCharacterGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("GetPresetType")]
  ...
  [Newtonsoft.Json.JsonProperty("FavorRank")]
  public int FavorRank { get; set; }
  [Newtonsoft.Json.JsonProperty("StarGrade")]
  public int StarGrade { get; set; }
  [Newtonsoft.Json.JsonProperty("ExSkillLevel")]
  public int ExSkillLevel { get; set; }
  [Newtonsoft.Json.JsonProperty("PassiveSkillLevel")]
  public int PassiveSkillLevel { get; set; }
  [Newtonsoft.Json.JsonProperty("ExtraPassiveSkillLevel")]
  public int ExtraPassiveSkillLevel { get; set; }
  [Newtonsoft.Json.JsonProperty("CommonSkillLevel")]
  public int CommonSkillLevel { get; set; }
  [Newtonsoft.Json.JsonProperty("LeaderSkillLevel")]
  public int LeaderSkillLevel { get; set; }
  [Newtonsoft.Json.JsonProperty("EquipSlot01")]
  public bool EquipSlot01 { get; set; }
  [Newtonsoft.Json.JsonProperty("EquipSlotTier01")]
  public int EquipSlotTier01 { get; set; }
  [Newtonsoft.Json.JsonProperty("EquipSlotLevel01")]
  public int EquipSlotLevel01 { get; set; }
  [Newtonsoft.Json.JsonProperty("EquipSlot02")]
  public bool EquipSlot02 { get; set; }
  [Newtonsoft.Json.JsonProperty("EquipSlotTier02")]
  public int EquipSlotTier02 { get; set; }
  [Newtonsoft.Json.JsonProperty("EquipSlotLevel02")]
  public int EquipSlotLevel02 { get; set; }
  [Newtonsoft.Json.JsonProperty("EquipSlot03")]
  public bool EquipSlot03 { get; set; }
  [Newtonsoft.Json.JsonProperty("EquipSlotTier03")]
  public int EquipSlotTier03 { get; set; }
  [Newtonsoft.Json.JsonProperty("EquipSlotLevel03")]
  public int EquipSlotLevel03 { get; set; }
  [Newtonsoft.Json.JsonProperty("EquipCharacterWeapon")]
  public bool EquipCharacterWeapon { get; set; }
  [Newtonsoft.Json.JsonProperty("EquipCharacterWeaponTier")]
  public int EquipCharacterWeaponTier { get; set; }
  [Newtonsoft.Json.JsonProperty("EquipCharacterWeaponLevel")]
  public int EquipCharacterWeaponLevel { get; set; }
  [Newtonsoft.Json.JsonProperty("EquipCharacterGear")]
  public bool EquipCharacterGear { get; set; }
  [Newtonsoft.Json.JsonProperty("EquipCharacterGearTier")]
  public int EquipCharacterGearTier { get; set; }
  [Newtonsoft.Json.JsonProperty("EquipCharacterGearLevel")]
  public int EquipCharacterGearLevel { get; set; }
  [Newtonsoft.Json.JsonProperty("PotentialType01")]
  public FlatData.PotentialStatBonusRateType PotentialType01 { get; set; }
  [Newtonsoft.Json.JsonProperty("PotentialLevel01")]
  public int PotentialLevel01 { get; set; }
  [Newtonsoft.Json.JsonProperty("PotentialType02")]
  public FlatData.PotentialStatBonusRateType PotentialType02 { get; set; }
  [Newtonsoft.Json.JsonProperty("PotentialLevel02")]
  public int PotentialLevel02 { get; set; }
  [Newtonsoft.Json.JsonProperty("PotentialType03")]
  public FlatData.PotentialStatBonusRateType PotentialType03 { get; set; }
  [Newtonsoft.Json.JsonProperty("PotentialLevel03")]
  ...
  public PresetCharacterGroupExcelT() {
    ...
    this.PotentialType01 = FlatData.PotentialStatBonusRateType.None;
    this.PotentialLevel01 = 0;
    this.PotentialType02 = FlatData.PotentialStatBonusRateType.None;
    this.PotentialLevel02 = 0;
    this.PotentialType03 = FlatData.PotentialStatBonusRateType.None;
...
static public class PresetCharacterGroupExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 58 /*PotentialType01*/, 4 /*FlatData.PotentialStatBonusRateType*/, 4, false)
      && verifier.VerifyField(tablePos, 60 /*PotentialLevel01*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 62 /*PotentialType02*/, 4 /*FlatData.PotentialStatBonusRateType*/, 4, false)
      && verifier.VerifyField(tablePos, 64 /*PotentialLevel02*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 66 /*PotentialType03*/, 4 /*FlatData.PotentialStatBonusRateType*/, 4, false)
