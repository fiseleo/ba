...
public struct ShopExcel : IFlatbufferObject
{
  ...
  public FlatData.ShopCategoryType CategoryType { get { int o = __p.__offset(8); return o != 0 ? (FlatData.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ShopCategoryType.General; } }
  ...
  public FlatData.PurchaseCountResetType PurchaseCountResetType { get { int o = __p.__offset(24); return o != 0 ? (FlatData.PurchaseCountResetType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.PurchaseCountResetType.None; } }
  ...
  public FlatData.ProductDisplayTag DisplayTag { get { int o = __p.__offset(30); return o != 0 ? (FlatData.ProductDisplayTag)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ProductDisplayTag.None; } }
  public int ShopUpdateGroupId { get { int o = __p.__offset(32); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }

  public static Offset<FlatData.ShopExcel> CreateShopExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddCategoryType(FlatBufferBuilder builder, FlatData.ShopCategoryType categoryType) { builder.AddInt(2, (int)categoryType, 0); }
  ...
  public static void AddPurchaseCountResetType(FlatBufferBuilder builder, FlatData.PurchaseCountResetType purchaseCountResetType) { builder.AddInt(10, (int)purchaseCountResetType, 0); }
  ...
  public static void AddDisplayTag(FlatBufferBuilder builder, FlatData.ProductDisplayTag displayTag) { builder.AddInt(13, (int)displayTag, 0); }
  ...
  public static Offset<FlatData.ShopExcel> EndShopExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ShopExcel>(o);
  }
  ...
  public void UnPackTo(ShopExcelT _o) {
    ...
    _o.BuyReportEventName = this.BuyReportEventName;
    _o.RestrictBuyWhenInventoryFull = this.RestrictBuyWhenInventoryFull;
    _o.DisplayTag = this.DisplayTag;
    _o.ShopUpdateGroupId = this.ShopUpdateGroupId;
  }
  public static Offset<FlatData.ShopExcel> Pack(FlatBufferBuilder builder, ShopExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ShopExcel>);
...
public class ShopExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("BuyReportEventName")]
  public string BuyReportEventName { get; set; }
  [Newtonsoft.Json.JsonProperty("RestrictBuyWhenInventoryFull")]
  ...
  [Newtonsoft.Json.JsonProperty("ShopUpdateGroupId")]
...
static public class ShopExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*CategoryType*/, 4 /*FlatData.ShopCategoryType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 24 /*PurchaseCountResetType*/, 4 /*FlatData.PurchaseCountResetType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 30 /*DisplayTag*/, 4 /*FlatData.ProductDisplayTag*/, 4, false)
