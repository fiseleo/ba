...
public struct TacticSkipExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.TacticSkipExcel> CreateTacticSkipExcel(FlatBufferBuilder builder,
      int LevelDiff = 0,
      long HPResult = 0) {
  ...
  public static Offset<FlatData.TacticSkipExcel> EndTacticSkipExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.TacticSkipExcel>(o);
  }
  ...
  public void UnPackTo(TacticSkipExcelT _o) {
    ...
    _o.HPResult = this.HPResult;
  }
  public static Offset<FlatData.TacticSkipExcel> Pack(FlatBufferBuilder builder, TacticSkipExcelT _o) {
    if (_o == null) return default(Offset<FlatData.TacticSkipExcel>);
...
public class TacticSkipExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("HPResult")]
