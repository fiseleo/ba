...
public struct TrophyCollectionExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.TrophyCollectionExcel> CreateTrophyCollectionExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<FlatData.TrophyCollectionExcel> EndTrophyCollectionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.TrophyCollectionExcel>(o);
  }
  ...
  public void UnPackTo(TrophyCollectionExcelT _o) {
    ...
    for (var _j = 0; _j < this.FurnitureIdLength; ++_j) {_o.FurnitureId.Add(this.FurnitureId(_j));}
  }
  public static Offset<FlatData.TrophyCollectionExcel> Pack(FlatBufferBuilder builder, TrophyCollectionExcelT _o) {
    if (_o == null) return default(Offset<FlatData.TrophyCollectionExcel>);
