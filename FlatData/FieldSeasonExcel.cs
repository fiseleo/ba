...
public struct FieldSeasonExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(FieldSeasonExcelT _o) {
    ...
    _o.EntryDateId = this.EntryDateId;
    _o.InstantEntryDateId = this.InstantEntryDateId;
    _o.StartDate = this.StartDate;
    _o.EndDate = this.EndDate;
    _o.LobbyBGMChangeStageId = this.LobbyBGMChangeStageId;
    _o.CharacterIconPath = this.CharacterIconPath;
    _o.MasteryImagePath = this.MasteryImagePath;
  }
  public static Offset<FlatData.FieldSeasonExcel> Pack(FlatBufferBuilder builder, FieldSeasonExcelT _o) {
    if (_o == null) return default(Offset<FlatData.FieldSeasonExcel>);
...
public class FieldSeasonExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("EntryDateId")]
  public long EntryDateId { get; set; }
  [Newtonsoft.Json.JsonProperty("InstantEntryDateId")]
  ...
  [Newtonsoft.Json.JsonProperty("LobbyBGMChangeStageId")]
  public long LobbyBGMChangeStageId { get; set; }
  [Newtonsoft.Json.JsonProperty("CharacterIconPath")]
  public string CharacterIconPath { get; set; }
  [Newtonsoft.Json.JsonProperty("MasteryImagePath")]
