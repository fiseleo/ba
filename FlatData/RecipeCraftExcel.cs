...
public struct RecipeCraftExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(RecipeCraftExcelT _o) {
    ...
    _o.RecipeIngredientDevName = this.RecipeIngredientDevName;
    ...
    for (var _j = 0; _j < this.ParcelDevNameLength; ++_j) {_o.ParcelDevName.Add(this.ParcelDevName(_j));}
  ...
  public static Offset<FlatData.RecipeCraftExcel> Pack(FlatBufferBuilder builder, RecipeCraftExcelT _o) {
    if (_o == null) return default(Offset<FlatData.RecipeCraftExcel>);
...
public class RecipeCraftExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("RecipeIngredientDevName")]
  ...
  [Newtonsoft.Json.JsonProperty("ParcelDevName")]
