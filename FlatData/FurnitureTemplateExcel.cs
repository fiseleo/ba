...
public struct FurnitureTemplateExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.FurnitureTemplateExcel> CreateFurnitureTemplateExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.FurnitureTemplateExcel> EndFurnitureTemplateExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.FurnitureTemplateExcel>(o);
  }
  ...
  public void UnPackTo(FurnitureTemplateExcelT _o) {
    ...
    _o.FunitureTemplateTitle = this.FunitureTemplateTitle;
    _o.ThumbnailImagePath = this.ThumbnailImagePath;
    _o.ImagePath = this.ImagePath;
  }
  public static Offset<FlatData.FurnitureTemplateExcel> Pack(FlatBufferBuilder builder, FurnitureTemplateExcelT _o) {
    if (_o == null) return default(Offset<FlatData.FurnitureTemplateExcel>);
...
public class FurnitureTemplateExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("FunitureTemplateTitle")]
  public uint FunitureTemplateTitle { get; set; }
  [Newtonsoft.Json.JsonProperty("ThumbnailImagePath")]
