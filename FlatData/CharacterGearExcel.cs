...
public struct CharacterGearExcel : IFlatbufferObject
{
  ...
  public FlatData.StatLevelUpType StatLevelUpType { get { int o = __p.__offset(8); return o != 0 ? (FlatData.StatLevelUpType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.StatLevelUpType.Standard; } }
  ...
  public FlatData.EquipmentOptionType StatType(int j) { int o = __p.__offset(22); return o != 0 ? (FlatData.EquipmentOptionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatData.EquipmentOptionType)0; }
  public int StatTypeLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatData.EquipmentOptionType> GetStatTypeBytes() { return __p.__vector_as_span<FlatData.EquipmentOptionType>(22, 4); }
#else
  public ArraySegment<byte>? GetStatTypeBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public FlatData.EquipmentOptionType[] GetStatTypeArray() { int o = __p.__offset(22); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatData.EquipmentOptionType[] a = new FlatData.EquipmentOptionType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatData.EquipmentOptionType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public FlatData.Tag Tags(int j) { int o = __p.__offset(32); return o != 0 ? (FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatData.Tag)0; }
  public int TagsLength { get { int o = __p.__offset(32); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatData.Tag> GetTagsBytes() { return __p.__vector_as_span<FlatData.Tag>(32, 4); }
#else
  public ArraySegment<byte>? GetTagsBytes() { return __p.__vector_as_arraysegment(32); }
#endif
  public FlatData.Tag[] GetTagsArray() { int o = __p.__offset(32); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatData.Tag[] a = new FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }

  public static Offset<FlatData.CharacterGearExcel> CreateCharacterGearExcel(FlatBufferBuilder builder,
      long Id = 0,
      long CharacterId = 0,
  ...
  public static void AddStatLevelUpType(FlatBufferBuilder builder, FlatData.StatLevelUpType statLevelUpType) { builder.AddInt(2, (int)statLevelUpType, 0); }
  ...
  public static Offset<FlatData.CharacterGearExcel> EndCharacterGearExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.CharacterGearExcel>(o);
  }
  ...
  public void UnPackTo(CharacterGearExcelT _o) {
    ...
    _o.OpenFavorLevel = this.OpenFavorLevel;
    _o.MaxLevel = this.MaxLevel;
    _o.LearnSkillSlot = this.LearnSkillSlot;
    ...
    for (var _j = 0; _j < this.MinStatValueLength; ++_j) {_o.MinStatValue.Add(this.MinStatValue(_j));}
    _o.MaxStatValue = new List<long>();
    for (var _j = 0; _j < this.MaxStatValueLength; ++_j) {_o.MaxStatValue.Add(this.MaxStatValue(_j));}
    _o.Icon = this.Icon;
  ...
  public static Offset<FlatData.CharacterGearExcel> Pack(FlatBufferBuilder builder, CharacterGearExcelT _o) {
    if (_o == null) return default(Offset<FlatData.CharacterGearExcel>);
...
public class CharacterGearExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("OpenFavorLevel")]
  public long OpenFavorLevel { get; set; }
  [Newtonsoft.Json.JsonProperty("MaxLevel")]
  public long MaxLevel { get; set; }
  [Newtonsoft.Json.JsonProperty("LearnSkillSlot")]
  ...
  [Newtonsoft.Json.JsonProperty("MinStatValue")]
  public List<long> MinStatValue { get; set; }
  [Newtonsoft.Json.JsonProperty("MaxStatValue")]
...
static public class CharacterGearExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*StatLevelUpType*/, 4 /*FlatData.StatLevelUpType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 22 /*StatType*/, 4 /*FlatData.EquipmentOptionType*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 32 /*Tags*/, 4 /*FlatData.Tag*/, false)
