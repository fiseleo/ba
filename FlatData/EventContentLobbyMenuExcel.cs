...
public struct EventContentLobbyMenuExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.EventContentLobbyMenuExcel> CreateEventContentLobbyMenuExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.EventContentLobbyMenuExcel> EndEventContentLobbyMenuExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentLobbyMenuExcel>(o);
  }
  ...
  public void UnPackTo(EventContentLobbyMenuExcelT _o) {
    ...
    _o.IconOffsetX = this.IconOffsetX;
    _o.IconOffsetY = this.IconOffsetY;
    _o.ReddotSpriteName = this.ReddotSpriteName;
  }
  public static Offset<FlatData.EventContentLobbyMenuExcel> Pack(FlatBufferBuilder builder, EventContentLobbyMenuExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EventContentLobbyMenuExcel>);
...
public class EventContentLobbyMenuExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("ButtonText")]
  public string ButtonText { get; set; }
  [Newtonsoft.Json.JsonProperty("DisplayOrder")]
  public int DisplayOrder { get; set; }
  [Newtonsoft.Json.JsonProperty("IconOffsetX")]
  public float IconOffsetX { get; set; }
  [Newtonsoft.Json.JsonProperty("IconOffsetY")]
  public float IconOffsetY { get; set; }
  [Newtonsoft.Json.JsonProperty("ReddotSpriteName")]
