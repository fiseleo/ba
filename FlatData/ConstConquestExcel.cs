...
public struct ConstConquestExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.ConstConquestExcel> CreateConstConquestExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.ConstConquestExcel> EndConstConquestExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ConstConquestExcel>(o);
  }
  ...
  public static Offset<FlatData.ConstConquestExcel> Pack(FlatBufferBuilder builder, ConstConquestExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ConstConquestExcel>);
