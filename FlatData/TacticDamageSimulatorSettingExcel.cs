...
public struct TacticDamageSimulatorSettingExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(TacticDamageSimulatorSettingExcelT _o) {
    ...
    _o.TestPreset = this.TestPreset;
    _o.TestBattleTime = this.TestBattleTime;
    _o.StrikerSquard = this.StrikerSquard;
    _o.SpecialSquard = this.SpecialSquard;
    _o.ReplaceCharacterCostRegen = this.ReplaceCharacterCostRegen;
    _o.ReplaceCostRegenValue = this.ReplaceCostRegenValue;
    _o.UseAutoSkill = this.UseAutoSkill;
    _o.OverrideStreetAdaptation = this.OverrideStreetAdaptation;
    _o.OverrideOutdoorAdaptation = this.OverrideOutdoorAdaptation;
    _o.OverrideIndoorAdaptation = this.OverrideIndoorAdaptation;
    _o.ApplyOverrideAdaptation = this.ApplyOverrideAdaptation;
    _o.GroundId = this.GroundId;
    _o.FixedCharacter = new List<long>();
    for (var _j = 0; _j < this.FixedCharacterLength; ++_j) {_o.FixedCharacter.Add(this.FixedCharacter(_j));}
  }
  public static Offset<FlatData.TacticDamageSimulatorSettingExcel> Pack(FlatBufferBuilder builder, TacticDamageSimulatorSettingExcelT _o) {
    if (_o == null) return default(Offset<FlatData.TacticDamageSimulatorSettingExcel>);
...
public class TacticDamageSimulatorSettingExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("TestPreset")]
  public long TestPreset { get; set; }
  [Newtonsoft.Json.JsonProperty("TestBattleTime")]
  public long TestBattleTime { get; set; }
  [Newtonsoft.Json.JsonProperty("StrikerSquard")]
  public long StrikerSquard { get; set; }
  [Newtonsoft.Json.JsonProperty("SpecialSquard")]
  public long SpecialSquard { get; set; }
  [Newtonsoft.Json.JsonProperty("ReplaceCharacterCostRegen")]
  public bool ReplaceCharacterCostRegen { get; set; }
  [Newtonsoft.Json.JsonProperty("ReplaceCostRegenValue")]
  public int ReplaceCostRegenValue { get; set; }
  [Newtonsoft.Json.JsonProperty("UseAutoSkill")]
  public bool UseAutoSkill { get; set; }
  [Newtonsoft.Json.JsonProperty("OverrideStreetAdaptation")]
  public FlatData.TerrainAdaptationStat OverrideStreetAdaptation { get; set; }
  [Newtonsoft.Json.JsonProperty("OverrideOutdoorAdaptation")]
  public FlatData.TerrainAdaptationStat OverrideOutdoorAdaptation { get; set; }
  [Newtonsoft.Json.JsonProperty("OverrideIndoorAdaptation")]
  public FlatData.TerrainAdaptationStat OverrideIndoorAdaptation { get; set; }
  [Newtonsoft.Json.JsonProperty("ApplyOverrideAdaptation")]
  public bool ApplyOverrideAdaptation { get; set; }
  [Newtonsoft.Json.JsonProperty("GroundId")]
  public long GroundId { get; set; }
  [Newtonsoft.Json.JsonProperty("FixedCharacter")]
  ...
  public TacticDamageSimulatorSettingExcelT() {
    ...
    this.OverrideStreetAdaptation = FlatData.TerrainAdaptationStat.D;
    this.OverrideOutdoorAdaptation = FlatData.TerrainAdaptationStat.D;
    this.OverrideIndoorAdaptation = FlatData.TerrainAdaptationStat.D;
