...
public struct SystemMailExcel : IFlatbufferObject
{
  ...
  public FlatData.MailType MailType { get { int o = __p.__offset(4); return o != 0 ? (FlatData.MailType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.MailType.System; } }
  ...
  public static Offset<FlatData.SystemMailExcel> CreateSystemMailExcel(FlatBufferBuilder builder,
  ...
  public static void AddMailType(FlatBufferBuilder builder, FlatData.MailType mailType) { builder.AddInt(0, (int)mailType, 0); }
  ...
  public static Offset<FlatData.SystemMailExcel> EndSystemMailExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.SystemMailExcel>(o);
  }
  ...
  public void UnPackTo(SystemMailExcelT _o) {
    ...
    _o.ExpiredDay = this.ExpiredDay;
    _o.Sender = this.Sender;
    _o.Comment = this.Comment;
  }
  public static Offset<FlatData.SystemMailExcel> Pack(FlatBufferBuilder builder, SystemMailExcelT _o) {
    if (_o == null) return default(Offset<FlatData.SystemMailExcel>);
...
public class SystemMailExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("ExpiredDay")]
...
static public class SystemMailExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*MailType*/, 4 /*FlatData.MailType*/, 4, false)
