...
public struct ConstAudioExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.ConstAudioExcel> CreateConstAudioExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.ConstAudioExcel> EndConstAudioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ConstAudioExcel>(o);
  }
  ...
  public void UnPackTo(ConstAudioExcelT _o) {
    _o.DefaultSnapShotName = this.DefaultSnapShotName;
    _o.BattleSnapShotName = this.BattleSnapShotName;
    _o.RaidSnapShotName = this.RaidSnapShotName;
    _o.ExSkillCutInSnapShotName = this.ExSkillCutInSnapShotName;
  }
  public static Offset<FlatData.ConstAudioExcel> Pack(FlatBufferBuilder builder, ConstAudioExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ConstAudioExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("DefaultSnapShotName")]
  public string DefaultSnapShotName { get; set; }
  [Newtonsoft.Json.JsonProperty("BattleSnapShotName")]
  public string BattleSnapShotName { get; set; }
  [Newtonsoft.Json.JsonProperty("RaidSnapShotName")]
  public string RaidSnapShotName { get; set; }
  [Newtonsoft.Json.JsonProperty("ExSkillCutInSnapShotName")]
