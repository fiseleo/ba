...
public struct SchoolDungeonStageExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.SchoolDungeonStageExcel> Pack(FlatBufferBuilder builder, SchoolDungeonStageExcelT _o) {
    if (_o == null) return default(Offset<FlatData.SchoolDungeonStageExcel>);
...
public class SchoolDungeonStageExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("DungeonType")]
  public FlatData.SchoolDungeonType DungeonType { get; set; }
  ...
  [Newtonsoft.Json.JsonProperty("StageEnterCostMinimumAmount")]
  ...
  public SchoolDungeonStageExcelT() {
    this.StageId = 0;
    this.DungeonType = FlatData.SchoolDungeonType.SchoolA;
    this.Difficulty = 0;
