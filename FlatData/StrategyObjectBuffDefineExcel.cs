...
public struct StrategyObjectBuffDefineExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.StrategyObjectBuffDefineExcel> CreateStrategyObjectBuffDefineExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.StrategyObjectBuffDefineExcel> EndStrategyObjectBuffDefineExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.StrategyObjectBuffDefineExcel>(o);
  }
  ...
  public void UnPackTo(StrategyObjectBuffDefineExcelT _o) {
    _o.StrategyObjectBuffID = this.StrategyObjectBuffID;
    _o.StrategyObjectTurn = this.StrategyObjectTurn;
    _o.SkillGroupId = this.SkillGroupId;
    _o.LocalizeCodeId = this.LocalizeCodeId;
    _o.IconPath = this.IconPath;
  }
  public static Offset<FlatData.StrategyObjectBuffDefineExcel> Pack(FlatBufferBuilder builder, StrategyObjectBuffDefineExcelT _o) {
    if (_o == null) return default(Offset<FlatData.StrategyObjectBuffDefineExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("StrategyObjectBuffID")]
  public long StrategyObjectBuffID { get; set; }
  [Newtonsoft.Json.JsonProperty("StrategyObjectTurn")]
