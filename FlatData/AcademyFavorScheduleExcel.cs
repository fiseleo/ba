...
public struct AcademyFavorScheduleExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(AcademyFavorScheduleExcelT _o) {
    ...
    _o.LocalizeScenarioId = this.LocalizeScenarioId;
    _o.FavorRank = this.FavorRank;
    _o.SecretStoneAmount = this.SecretStoneAmount;
    _o.ScenarioSriptGroupId = this.ScenarioSriptGroupId;
  ...
  public static Offset<FlatData.AcademyFavorScheduleExcel> Pack(FlatBufferBuilder builder, AcademyFavorScheduleExcelT _o) {
    if (_o == null) return default(Offset<FlatData.AcademyFavorScheduleExcel>);
...
public class AcademyFavorScheduleExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("LocalizeScenarioId")]
  ...
  [Newtonsoft.Json.JsonProperty("ScenarioSriptGroupId")]
