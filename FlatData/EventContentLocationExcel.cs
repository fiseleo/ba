...
public struct EventContentLocationExcel : IFlatbufferObject
{
  ...
  public FlatData.ParcelType ScheduleEventPointCostParcelType { get { int o = __p.__offset(14); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ParcelType.None; } }
  ...
  public static Offset<FlatData.EventContentLocationExcel> CreateEventContentLocationExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long Id = 0,
      uint LocalizeEtcId = 0,
      StringOffset PrefabPathOffset = default(StringOffset),
      int LocationResetScheduleCount = 0,
      FlatData.ParcelType ScheduleEventPointCostParcelType = FlatData.ParcelType.None,
  ...
  public static void AddScheduleEventPointCostParcelType(FlatBufferBuilder builder, FlatData.ParcelType scheduleEventPointCostParcelType) { builder.AddInt(5, (int)scheduleEventPointCostParcelType, 0); }
  ...
  public static Offset<FlatData.EventContentLocationExcel> EndEventContentLocationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentLocationExcel>(o);
  }
  ...
  public void UnPackTo(EventContentLocationExcelT _o) {
    ...
    _o.LocationResetScheduleCount = this.LocationResetScheduleCount;
    _o.ScheduleEventPointCostParcelType = this.ScheduleEventPointCostParcelType;
    _o.ScheduleEventPointCostParcelId = this.ScheduleEventPointCostParcelId;
    _o.ScheduleEventPointCostParcelAmount = this.ScheduleEventPointCostParcelAmount;
    _o.RewardParcelType = this.RewardParcelType;
    _o.RewardParcelId = this.RewardParcelId;
    _o.InformationGroupId = this.InformationGroupId;
  }
  public static Offset<FlatData.EventContentLocationExcel> Pack(FlatBufferBuilder builder, EventContentLocationExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EventContentLocationExcel>);
...
public class EventContentLocationExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("LocationResetScheduleCount")]
  public int LocationResetScheduleCount { get; set; }
  [Newtonsoft.Json.JsonProperty("ScheduleEventPointCostParcelType")]
  public FlatData.ParcelType ScheduleEventPointCostParcelType { get; set; }
  [Newtonsoft.Json.JsonProperty("ScheduleEventPointCostParcelId")]
  public long ScheduleEventPointCostParcelId { get; set; }
  [Newtonsoft.Json.JsonProperty("ScheduleEventPointCostParcelAmount")]
  ...
  [Newtonsoft.Json.JsonProperty("InformationGroupId")]
  ...
  public EventContentLocationExcelT() {
    ...
    this.ScheduleEventPointCostParcelType = FlatData.ParcelType.None;
...
static public class EventContentLocationExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*ScheduleEventPointCostParcelType*/, 4 /*FlatData.ParcelType*/, 4, false)
