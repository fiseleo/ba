...
public struct EventContentDiceRaceTotalRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.EventContentDiceRaceTotalRewardExcel> CreateEventContentDiceRaceTotalRewardExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.EventContentDiceRaceTotalRewardExcel> EndEventContentDiceRaceTotalRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentDiceRaceTotalRewardExcel>(o);
  }
  ...
  public void UnPackTo(EventContentDiceRaceTotalRewardExcelT _o) {
    ...
    _o.RequiredLapFinishCount = this.RequiredLapFinishCount;
    _o.DisplayLapFinishCount = this.DisplayLapFinishCount;
  ...
  public static Offset<FlatData.EventContentDiceRaceTotalRewardExcel> Pack(FlatBufferBuilder builder, EventContentDiceRaceTotalRewardExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EventContentDiceRaceTotalRewardExcel>);
...
public class EventContentDiceRaceTotalRewardExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("RequiredLapFinishCount")]
  public int RequiredLapFinishCount { get; set; }
  [Newtonsoft.Json.JsonProperty("DisplayLapFinishCount")]
