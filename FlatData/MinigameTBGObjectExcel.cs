...
public struct MinigameTBGObjectExcel : IFlatbufferObject
{
  ...
  public FlatData.TBGObjectType ObjectType { get { int o = __p.__offset(10); return o != 0 ? (FlatData.TBGObjectType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.TBGObjectType.None; } }
  public FlatData.ParcelType ObjectCostType { get { int o = __p.__offset(12); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ParcelType.None; } }
  ...
  public static Offset<FlatData.MinigameTBGObjectExcel> CreateMinigameTBGObjectExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      ...
      FlatData.ParcelType ObjectCostType = FlatData.ParcelType.None,
      long ObjectCostId = 0,
  ...
  public static void AddObjectType(FlatBufferBuilder builder, FlatData.TBGObjectType objectType) { builder.AddInt(3, (int)objectType, 0); }
  public static void AddObjectCostType(FlatBufferBuilder builder, FlatData.ParcelType objectCostType) { builder.AddInt(4, (int)objectCostType, 0); }
  ...
  public static Offset<FlatData.MinigameTBGObjectExcel> EndMinigameTBGObjectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.MinigameTBGObjectExcel>(o);
  }
  ...
  public void UnPackTo(MinigameTBGObjectExcelT _o) {
    ...
    _o.ObjectCostType = this.ObjectCostType;
    _o.ObjectCostId = this.ObjectCostId;
    _o.ObjectCostAmount = this.ObjectCostAmount;
    _o.Disposable = this.Disposable;
    _o.ReEncounterCost = this.ReEncounterCost;
  }
  public static Offset<FlatData.MinigameTBGObjectExcel> Pack(FlatBufferBuilder builder, MinigameTBGObjectExcelT _o) {
    if (_o == null) return default(Offset<FlatData.MinigameTBGObjectExcel>);
...
public class MinigameTBGObjectExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("ObjectCostType")]
  public FlatData.ParcelType ObjectCostType { get; set; }
  [Newtonsoft.Json.JsonProperty("ObjectCostId")]
  public long ObjectCostId { get; set; }
  [Newtonsoft.Json.JsonProperty("ObjectCostAmount")]
  public int ObjectCostAmount { get; set; }
  [Newtonsoft.Json.JsonProperty("Disposable")]
  public bool Disposable { get; set; }
  [Newtonsoft.Json.JsonProperty("ReEncounterCost")]
  ...
  public MinigameTBGObjectExcelT() {
    ...
    this.ObjectCostType = FlatData.ParcelType.None;
    this.ObjectCostId = 0;
...
static public class MinigameTBGObjectExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*ObjectType*/, 4 /*FlatData.TBGObjectType*/, 4, false)
      && verifier.VerifyField(tablePos, 12 /*ObjectCostType*/, 4 /*FlatData.ParcelType*/, 4, false)
