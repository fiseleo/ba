...
public struct MinigameTBGThemaExcel : IFlatbufferObject
{
  ...
  public FlatData.TBGThemaType ThemaType { get { int o = __p.__offset(10); return o != 0 ? (FlatData.TBGThemaType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.TBGThemaType.None; } }
  ...
  public FlatData.TBGPortalCondition PortalCondition(int j) { int o = __p.__offset(16); return o != 0 ? (FlatData.TBGPortalCondition)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatData.TBGPortalCondition)0; }
  public int PortalConditionLength { get { int o = __p.__offset(16); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatData.TBGPortalCondition> GetPortalConditionBytes() { return __p.__vector_as_span<FlatData.TBGPortalCondition>(16, 4); }
#else
  public ArraySegment<byte>? GetPortalConditionBytes() { return __p.__vector_as_arraysegment(16); }
#endif
  public FlatData.TBGPortalCondition[] GetPortalConditionArray() { int o = __p.__offset(16); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatData.TBGPortalCondition[] a = new FlatData.TBGPortalCondition[l]; for (int i = 0; i < l; i++) { a[i] = (FlatData.TBGPortalCondition)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<FlatData.MinigameTBGThemaExcel> CreateMinigameTBGThemaExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long UniqueId = 0,
      int ThemaIndex = 0,
      FlatData.TBGThemaType ThemaType = FlatData.TBGThemaType.None,
  ...
  public static void AddThemaType(FlatBufferBuilder builder, FlatData.TBGThemaType themaType) { builder.AddInt(3, (int)themaType, 0); }
  ...
  public static VectorOffset CreatePortalConditionVector(FlatBufferBuilder builder, FlatData.TBGPortalCondition[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreatePortalConditionVectorBlock(FlatBufferBuilder builder, FlatData.TBGPortalCondition[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreatePortalConditionVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatData.TBGPortalCondition> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreatePortalConditionVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatData.TBGPortalCondition>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<FlatData.MinigameTBGThemaExcel> EndMinigameTBGThemaExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.MinigameTBGThemaExcel>(o);
  }
  ...
  public void UnPackTo(MinigameTBGThemaExcelT _o) {
    ...
    _o.ThemaIndex = this.ThemaIndex;
    _o.ThemaType = this.ThemaType;
    _o.ThemaMap = this.ThemaMap;
    _o.ThemaMapBG = this.ThemaMapBG;
    _o.PortalCondition = new List<FlatData.TBGPortalCondition>();
    for (var _j = 0; _j < this.PortalConditionLength; ++_j) {_o.PortalCondition.Add(this.PortalCondition(_j));}
    _o.PortalConditionParameter = new List<string>();
    for (var _j = 0; _j < this.PortalConditionParameterLength; ++_j) {_o.PortalConditionParameter.Add(this.PortalConditionParameter(_j));}
    _o.ThemaNameLocalize = this.ThemaNameLocalize;
    _o.ThemaLoadingImage = this.ThemaLoadingImage;
    _o.ThemaPlayerPrefab = this.ThemaPlayerPrefab;
    _o.ThemaLeaderId = this.ThemaLeaderId;
    _o.ThemaGoalLocalize = this.ThemaGoalLocalize;
    _o.InstantClearCostAmount = this.InstantClearCostAmount;
  }
  public static Offset<FlatData.MinigameTBGThemaExcel> Pack(FlatBufferBuilder builder, MinigameTBGThemaExcelT _o) {
    if (_o == null) return default(Offset<FlatData.MinigameTBGThemaExcel>);
...
public class MinigameTBGThemaExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("ThemaIndex")]
  public int ThemaIndex { get; set; }
  [Newtonsoft.Json.JsonProperty("ThemaType")]
  public FlatData.TBGThemaType ThemaType { get; set; }
  [Newtonsoft.Json.JsonProperty("ThemaMap")]
  public string ThemaMap { get; set; }
  [Newtonsoft.Json.JsonProperty("ThemaMapBG")]
  public string ThemaMapBG { get; set; }
  [Newtonsoft.Json.JsonProperty("PortalCondition")]
  public List<FlatData.TBGPortalCondition> PortalCondition { get; set; }
  [Newtonsoft.Json.JsonProperty("PortalConditionParameter")]
  public List<string> PortalConditionParameter { get; set; }
  [Newtonsoft.Json.JsonProperty("ThemaNameLocalize")]
  public string ThemaNameLocalize { get; set; }
  [Newtonsoft.Json.JsonProperty("ThemaLoadingImage")]
  public string ThemaLoadingImage { get; set; }
  [Newtonsoft.Json.JsonProperty("ThemaPlayerPrefab")]
  public string ThemaPlayerPrefab { get; set; }
  [Newtonsoft.Json.JsonProperty("ThemaLeaderId")]
  public long ThemaLeaderId { get; set; }
  [Newtonsoft.Json.JsonProperty("ThemaGoalLocalize")]
  public string ThemaGoalLocalize { get; set; }
  [Newtonsoft.Json.JsonProperty("InstantClearCostAmount")]
  ...
  public MinigameTBGThemaExcelT() {
    ...
    this.UniqueId = 0;
    this.ThemaIndex = 0;
    this.ThemaType = FlatData.TBGThemaType.None;
    this.ThemaMap = null;
...
static public class MinigameTBGThemaExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*ThemaType*/, 4 /*FlatData.TBGThemaType*/, 4, false)
      && verifier.VerifyString(tablePos, 12 /*ThemaMap*/, false)
      && verifier.VerifyString(tablePos, 14 /*ThemaMapBG*/, false)
      && verifier.VerifyVectorOfData(tablePos, 16 /*PortalCondition*/, 4 /*FlatData.TBGPortalCondition*/, false)
