...
public struct GachaCraftNodeGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.GachaCraftNodeGroupExcel> CreateGachaCraftNodeGroupExcel(FlatBufferBuilder builder,
      long NodeId = 0,
      long GachaGroupId = 0,
      long ProbWeight = 0) {
  ...
  public static Offset<FlatData.GachaCraftNodeGroupExcel> EndGachaCraftNodeGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.GachaCraftNodeGroupExcel>(o);
  }
  ...
  public void UnPackTo(GachaCraftNodeGroupExcelT _o) {
    ...
    _o.ProbWeight = this.ProbWeight;
  }
  public static Offset<FlatData.GachaCraftNodeGroupExcel> Pack(FlatBufferBuilder builder, GachaCraftNodeGroupExcelT _o) {
    if (_o == null) return default(Offset<FlatData.GachaCraftNodeGroupExcel>);
...
public class GachaCraftNodeGroupExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("ProbWeight")]
