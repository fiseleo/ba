...
public struct LimitedStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.LimitedStageRewardExcel> Pack(FlatBufferBuilder builder, LimitedStageRewardExcelT _o) {
    if (_o == null) return default(Offset<FlatData.LimitedStageRewardExcel>);
