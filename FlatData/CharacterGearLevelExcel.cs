...
public struct CharacterGearLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.CharacterGearLevelExcel> CreateCharacterGearLevelExcel(FlatBufferBuilder builder,
      int Level = 0,
  ...
  public static Offset<FlatData.CharacterGearLevelExcel> EndCharacterGearLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.CharacterGearLevelExcel>(o);
  }
  ...
  public void UnPackTo(CharacterGearLevelExcelT _o) {
    ...
    for (var _j = 0; _j < this.TierLevelExpLength; ++_j) {_o.TierLevelExp.Add(this.TierLevelExp(_j));}
    _o.TotalExp = new List<long>();
    for (var _j = 0; _j < this.TotalExpLength; ++_j) {_o.TotalExp.Add(this.TotalExp(_j));}
  }
  public static Offset<FlatData.CharacterGearLevelExcel> Pack(FlatBufferBuilder builder, CharacterGearLevelExcelT _o) {
    if (_o == null) return default(Offset<FlatData.CharacterGearLevelExcel>);
...
public class CharacterGearLevelExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("TierLevelExp")]
