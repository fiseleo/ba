...
public struct ParcelAutoSynthExcel : IFlatbufferObject
{
  ...
  public FlatData.ParcelType RequireParcelType { get { int o = __p.__offset(4); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ParcelType.None; } }
  ...
  public FlatData.ParcelType ResultParcelType { get { int o = __p.__offset(16); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ParcelType.None; } }
  ...
  public static Offset<FlatData.ParcelAutoSynthExcel> CreateParcelAutoSynthExcel(FlatBufferBuilder builder,
      FlatData.ParcelType RequireParcelType = FlatData.ParcelType.None,
      long RequireParcelId = 0,
      long RequireParcelAmount = 0,
      long SynthStartAmount = 0,
      long SynthEndAmount = 0,
      bool SynthMaxItem = false,
      FlatData.ParcelType ResultParcelType = FlatData.ParcelType.None,
  ...
  public static void AddRequireParcelType(FlatBufferBuilder builder, FlatData.ParcelType requireParcelType) { builder.AddInt(0, (int)requireParcelType, 0); }
  ...
  public static void AddResultParcelType(FlatBufferBuilder builder, FlatData.ParcelType resultParcelType) { builder.AddInt(6, (int)resultParcelType, 0); }
  ...
  public static Offset<FlatData.ParcelAutoSynthExcel> EndParcelAutoSynthExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ParcelAutoSynthExcel>(o);
  }
  ...
  public void UnPackTo(ParcelAutoSynthExcelT _o) {
    _o.RequireParcelType = this.RequireParcelType;
    _o.RequireParcelId = this.RequireParcelId;
    _o.RequireParcelAmount = this.RequireParcelAmount;
    _o.SynthStartAmount = this.SynthStartAmount;
    _o.SynthEndAmount = this.SynthEndAmount;
    _o.SynthMaxItem = this.SynthMaxItem;
    _o.ResultParcelType = this.ResultParcelType;
    _o.ResultParcelId = this.ResultParcelId;
    _o.ResultParcelAmount = this.ResultParcelAmount;
  }
  public static Offset<FlatData.ParcelAutoSynthExcel> Pack(FlatBufferBuilder builder, ParcelAutoSynthExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ParcelAutoSynthExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("RequireParcelType")]
  public FlatData.ParcelType RequireParcelType { get; set; }
  [Newtonsoft.Json.JsonProperty("RequireParcelId")]
  public long RequireParcelId { get; set; }
  [Newtonsoft.Json.JsonProperty("RequireParcelAmount")]
  public long RequireParcelAmount { get; set; }
  [Newtonsoft.Json.JsonProperty("SynthStartAmount")]
  public long SynthStartAmount { get; set; }
  [Newtonsoft.Json.JsonProperty("SynthEndAmount")]
  public long SynthEndAmount { get; set; }
  [Newtonsoft.Json.JsonProperty("SynthMaxItem")]
  public bool SynthMaxItem { get; set; }
  [Newtonsoft.Json.JsonProperty("ResultParcelType")]
  public FlatData.ParcelType ResultParcelType { get; set; }
  [Newtonsoft.Json.JsonProperty("ResultParcelId")]
  public long ResultParcelId { get; set; }
  [Newtonsoft.Json.JsonProperty("ResultParcelAmount")]
  public long ResultParcelAmount { get; set; }

  public ParcelAutoSynthExcelT() {
    this.RequireParcelType = FlatData.ParcelType.None;
    this.RequireParcelId = 0;
    this.RequireParcelAmount = 0;
    this.SynthStartAmount = 0;
    this.SynthEndAmount = 0;
    this.SynthMaxItem = false;
    this.ResultParcelType = FlatData.ParcelType.None;
...
static public class ParcelAutoSynthExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*RequireParcelType*/, 4 /*FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 16 /*ResultParcelType*/, 4 /*FlatData.ParcelType*/, 4, false)
