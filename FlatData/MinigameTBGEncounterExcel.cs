...
public struct MinigameTBGEncounterExcel : IFlatbufferObject
{
  ...
  public FlatData.TBGThemaType ThemaType { get { int o = __p.__offset(12); return o != 0 ? (FlatData.TBGThemaType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.TBGThemaType.None; } }
  public FlatData.TBGObjectType ObjectType { get { int o = __p.__offset(14); return o != 0 ? (FlatData.TBGObjectType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.TBGObjectType.None; } }
  ...
  public static Offset<FlatData.MinigameTBGEncounterExcel> CreateMinigameTBGEncounterExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long UniqueId = 0,
      bool AllThema = false,
      int ThemaIndex = 0,
      FlatData.TBGThemaType ThemaType = FlatData.TBGThemaType.None,
      FlatData.TBGObjectType ObjectType = FlatData.TBGObjectType.None,
  ...
  public static void AddThemaType(FlatBufferBuilder builder, FlatData.TBGThemaType themaType) { builder.AddInt(4, (int)themaType, 0); }
  public static void AddObjectType(FlatBufferBuilder builder, FlatData.TBGObjectType objectType) { builder.AddInt(5, (int)objectType, 0); }
  ...
  public static Offset<FlatData.MinigameTBGEncounterExcel> EndMinigameTBGEncounterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.MinigameTBGEncounterExcel>(o);
  }
  ...
  public void UnPackTo(MinigameTBGEncounterExcelT _o) {
    ...
    _o.AllThema = this.AllThema;
    _o.ThemaIndex = this.ThemaIndex;
    _o.ThemaType = this.ThemaType;
    _o.ObjectType = this.ObjectType;
    _o.EnemyImagePath = this.EnemyImagePath;
    _o.EnemyPrefabName = this.EnemyPrefabName;
    _o.EnemyNameLocalize = this.EnemyNameLocalize;
    _o.OptionGroupId = this.OptionGroupId;
    _o.RewardHide = this.RewardHide;
    _o.EncounterTitleLocalize = this.EncounterTitleLocalize;
    _o.StoryImagePath = this.StoryImagePath;
    _o.BeforeStoryLocalize = this.BeforeStoryLocalize;
    _o.BeforeStoryOption1Localize = this.BeforeStoryOption1Localize;
    _o.BeforeStoryOption2Localize = this.BeforeStoryOption2Localize;
    _o.BeforeStoryOption3Localize = this.BeforeStoryOption3Localize;
    _o.AllyAttackLocalize = this.AllyAttackLocalize;
    _o.EnemyAttackLocalize = this.EnemyAttackLocalize;
    _o.AttackDefenceLocalize = this.AttackDefenceLocalize;
    _o.ClearStoryLocalize = this.ClearStoryLocalize;
    _o.DefeatStoryLocalize = this.DefeatStoryLocalize;
    _o.RunawayStoryLocalize = this.RunawayStoryLocalize;
  }
  public static Offset<FlatData.MinigameTBGEncounterExcel> Pack(FlatBufferBuilder builder, MinigameTBGEncounterExcelT _o) {
    if (_o == null) return default(Offset<FlatData.MinigameTBGEncounterExcel>);
...
public class MinigameTBGEncounterExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("AllThema")]
  ...
  public FlatData.TBGObjectType ObjectType { get; set; }
  [Newtonsoft.Json.JsonProperty("EnemyImagePath")]
  public string EnemyImagePath { get; set; }
  [Newtonsoft.Json.JsonProperty("EnemyPrefabName")]
  public string EnemyPrefabName { get; set; }
  [Newtonsoft.Json.JsonProperty("EnemyNameLocalize")]
  ...
  [Newtonsoft.Json.JsonProperty("EncounterTitleLocalize")]
  public string EncounterTitleLocalize { get; set; }
  [Newtonsoft.Json.JsonProperty("StoryImagePath")]
  public string StoryImagePath { get; set; }
  [Newtonsoft.Json.JsonProperty("BeforeStoryLocalize")]
  public string BeforeStoryLocalize { get; set; }
  [Newtonsoft.Json.JsonProperty("BeforeStoryOption1Localize")]
  public string BeforeStoryOption1Localize { get; set; }
  [Newtonsoft.Json.JsonProperty("BeforeStoryOption2Localize")]
  public string BeforeStoryOption2Localize { get; set; }
  [Newtonsoft.Json.JsonProperty("BeforeStoryOption3Localize")]
  public string BeforeStoryOption3Localize { get; set; }
  [Newtonsoft.Json.JsonProperty("AllyAttackLocalize")]
  public string AllyAttackLocalize { get; set; }
  [Newtonsoft.Json.JsonProperty("EnemyAttackLocalize")]
  public string EnemyAttackLocalize { get; set; }
  [Newtonsoft.Json.JsonProperty("AttackDefenceLocalize")]
  public string AttackDefenceLocalize { get; set; }
  [Newtonsoft.Json.JsonProperty("ClearStoryLocalize")]
  public string ClearStoryLocalize { get; set; }
  [Newtonsoft.Json.JsonProperty("DefeatStoryLocalize")]
  public string DefeatStoryLocalize { get; set; }
  [Newtonsoft.Json.JsonProperty("RunawayStoryLocalize")]
  ...
  public MinigameTBGEncounterExcelT() {
    ...
    this.ObjectType = FlatData.TBGObjectType.None;
...
static public class MinigameTBGEncounterExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*ThemaType*/, 4 /*FlatData.TBGThemaType*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*ObjectType*/, 4 /*FlatData.TBGObjectType*/, 4, false)
