...
public struct WeekDungeonGroupBuffExcel : IFlatbufferObject
{
  ...
  public FlatData.School School { get { int o = __p.__offset(6); return o != 0 ? (FlatData.School)__p.bb.GetInt(o + __p.bb_pos) : FlatData.School.None; } }
  ...
  public static Offset<FlatData.WeekDungeonGroupBuffExcel> CreateWeekDungeonGroupBuffExcel(FlatBufferBuilder builder,
  ...
  public static void AddSchool(FlatBufferBuilder builder, FlatData.School school) { builder.AddInt(1, (int)school, 0); }
  ...
  public static Offset<FlatData.WeekDungeonGroupBuffExcel> EndWeekDungeonGroupBuffExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.WeekDungeonGroupBuffExcel>(o);
  }
  ...
  public void UnPackTo(WeekDungeonGroupBuffExcelT _o) {
    _o.WeekDungeonBuffId = this.WeekDungeonBuffId;
    _o.School = this.School;
    _o.RecommandLocalizeEtcId = this.RecommandLocalizeEtcId;
    _o.FormationLocalizeEtcId = this.FormationLocalizeEtcId;
    _o.SkillGroupId = this.SkillGroupId;
  }
  public static Offset<FlatData.WeekDungeonGroupBuffExcel> Pack(FlatBufferBuilder builder, WeekDungeonGroupBuffExcelT _o) {
    if (_o == null) return default(Offset<FlatData.WeekDungeonGroupBuffExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("WeekDungeonBuffId")]
  ...
  [Newtonsoft.Json.JsonProperty("FormationLocalizeEtcId")]
...
static public class WeekDungeonGroupBuffExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*School*/, 4 /*FlatData.School*/, 4, false)
