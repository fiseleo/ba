...
public struct LocalizeFieldExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.LocalizeFieldExcel> CreateLocalizeFieldExcel(FlatBufferBuilder builder,
      uint Key = 0,
  ...
  public static Offset<FlatData.LocalizeFieldExcel> EndLocalizeFieldExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.LocalizeFieldExcel>(o);
  }
  ...
  public static Offset<FlatData.LocalizeFieldExcel> Pack(FlatBufferBuilder builder, LocalizeFieldExcelT _o) {
    if (_o == null) return default(Offset<FlatData.LocalizeFieldExcel>);
...
public class LocalizeFieldExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("Kr")]
  public string Kr { get; set; }
  [Newtonsoft.Json.JsonProperty("Jp")]
