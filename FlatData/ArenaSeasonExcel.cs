...
public struct ArenaSeasonExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.ArenaSeasonExcel> CreateArenaSeasonExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<FlatData.ArenaSeasonExcel> EndArenaSeasonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ArenaSeasonExcel>(o);
  }
  ...
  public void UnPackTo(ArenaSeasonExcelT _o) {
    ...
    _o.SeasonStartDate = this.SeasonStartDate;
    _o.SeasonEndDate = this.SeasonEndDate;
    _o.SeasonGroupLimit = this.SeasonGroupLimit;
    _o.PrevSeasonId = this.PrevSeasonId;
  }
  public static Offset<FlatData.ArenaSeasonExcel> Pack(FlatBufferBuilder builder, ArenaSeasonExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ArenaSeasonExcel>);
...
public class ArenaSeasonExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("SeasonStartDate")]
  public string SeasonStartDate { get; set; }
  [Newtonsoft.Json.JsonProperty("SeasonEndDate")]
  public string SeasonEndDate { get; set; }
  [Newtonsoft.Json.JsonProperty("SeasonGroupLimit")]
  public long SeasonGroupLimit { get; set; }
  [Newtonsoft.Json.JsonProperty("PrevSeasonId")]
