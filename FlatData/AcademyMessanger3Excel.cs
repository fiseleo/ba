...
public struct AcademyMessanger3Excel : IFlatbufferObject
{
  ...
  public FlatData.AcademyMessageConditions MessageCondition { get { int o = __p.__offset(10); return o != 0 ? (FlatData.AcademyMessageConditions)__p.bb.GetInt(o + __p.bb_pos) : FlatData.AcademyMessageConditions.None; } }
  ...
  public FlatData.AcademyMessageTypes MessageType { get { int o = __p.__offset(24); return o != 0 ? (FlatData.AcademyMessageTypes)__p.bb.GetInt(o + __p.bb_pos) : FlatData.AcademyMessageTypes.None; } }
  ...
  public static Offset<FlatData.AcademyMessanger3Excel> CreateAcademyMessanger3Excel(FlatBufferBuilder builder,
      long MessageGroupId = 0,
      long Id = 0,
      long CharacterId = 0,
      FlatData.AcademyMessageConditions MessageCondition = FlatData.AcademyMessageConditions.None,
      ...
      FlatData.AcademyMessageTypes MessageType = FlatData.AcademyMessageTypes.None,
  ...
  public static void AddMessageCondition(FlatBufferBuilder builder, FlatData.AcademyMessageConditions messageCondition) { builder.AddInt(3, (int)messageCondition, 0); }
  ...
  public static void AddMessageType(FlatBufferBuilder builder, FlatData.AcademyMessageTypes messageType) { builder.AddInt(10, (int)messageType, 0); }
  ...
  public static Offset<FlatData.AcademyMessanger3Excel> EndAcademyMessanger3Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.AcademyMessanger3Excel>(o);
  }
  ...
  public void UnPackTo(AcademyMessanger3ExcelT _o) {
    _o.MessageGroupId = this.MessageGroupId;
    _o.Id = this.Id;
    _o.CharacterId = this.CharacterId;
    _o.MessageCondition = this.MessageCondition;
    _o.ConditionValue = this.ConditionValue;
    _o.PreConditionGroupId = this.PreConditionGroupId;
    _o.PreConditionFavorScheduleId = this.PreConditionFavorScheduleId;
    _o.FavorScheduleId = this.FavorScheduleId;
    _o.NextGroupId = this.NextGroupId;
    _o.FeedbackTimeMillisec = this.FeedbackTimeMillisec;
    _o.MessageType = this.MessageType;
    _o.ImagePath = this.ImagePath;
    _o.MessageKR = this.MessageKR;
    _o.MessageJP = this.MessageJP;
  }
  public static Offset<FlatData.AcademyMessanger3Excel> Pack(FlatBufferBuilder builder, AcademyMessanger3ExcelT _o) {
    if (_o == null) return default(Offset<FlatData.AcademyMessanger3Excel>);
...
{
  [Newtonsoft.Json.JsonProperty("MessageGroupId")]
  public long MessageGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("Id")]
  public long Id { get; set; }
  [Newtonsoft.Json.JsonProperty("CharacterId")]
  public long CharacterId { get; set; }
  [Newtonsoft.Json.JsonProperty("MessageCondition")]
  public FlatData.AcademyMessageConditions MessageCondition { get; set; }
  [Newtonsoft.Json.JsonProperty("ConditionValue")]
  public long ConditionValue { get; set; }
  [Newtonsoft.Json.JsonProperty("PreConditionGroupId")]
  public long PreConditionGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("PreConditionFavorScheduleId")]
  public long PreConditionFavorScheduleId { get; set; }
  [Newtonsoft.Json.JsonProperty("FavorScheduleId")]
  public long FavorScheduleId { get; set; }
  [Newtonsoft.Json.JsonProperty("NextGroupId")]
  public long NextGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("FeedbackTimeMillisec")]
  public long FeedbackTimeMillisec { get; set; }
  [Newtonsoft.Json.JsonProperty("MessageType")]
  public FlatData.AcademyMessageTypes MessageType { get; set; }
  [Newtonsoft.Json.JsonProperty("ImagePath")]
  public string ImagePath { get; set; }
  [Newtonsoft.Json.JsonProperty("MessageKR")]
  public string MessageKR { get; set; }
  [Newtonsoft.Json.JsonProperty("MessageJP")]
  ...
  public AcademyMessanger3ExcelT() {
    ...
    this.Id = 0;
    this.CharacterId = 0;
    this.MessageCondition = FlatData.AcademyMessageConditions.None;
    ...
    this.MessageType = FlatData.AcademyMessageTypes.None;
    this.ImagePath = null;
    this.MessageKR = null;
    this.MessageJP = null;
  }
...
static public class AcademyMessanger3ExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*MessageCondition*/, 4 /*FlatData.AcademyMessageConditions*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 24 /*MessageType*/, 4 /*FlatData.AcademyMessageTypes*/, 4, false)
