...
public struct ShiftingCraftRecipeExcel : IFlatbufferObject
{
  ...
  public FlatData.ParcelType ResultParcel { get { int o = __p.__offset(10); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ParcelType.None; } }
  ...
  public FlatData.Tag IngredientTag(int j) { int o = __p.__offset(22); return o != 0 ? (FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatData.Tag)0; }
  public int IngredientTagLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatData.Tag> GetIngredientTagBytes() { return __p.__vector_as_span<FlatData.Tag>(22, 4); }
#else
  public ArraySegment<byte>? GetIngredientTagBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public FlatData.Tag[] GetIngredientTagArray() { int o = __p.__offset(22); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatData.Tag[] a = new FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  public long IngredientExp { get { int o = __p.__offset(24); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }

  public static Offset<FlatData.ShiftingCraftRecipeExcel> CreateShiftingCraftRecipeExcel(FlatBufferBuilder builder,
      long Id = 0,
      long DisplayOrder = 0,
      int NotificationId = 0,
      FlatData.ParcelType ResultParcel = FlatData.ParcelType.None,
      long ResultId = 0,
      long ResultAmount = 0,
  ...
  public static void AddResultParcel(FlatBufferBuilder builder, FlatData.ParcelType resultParcel) { builder.AddInt(3, (int)resultParcel, 0); }
  ...
  public static VectorOffset CreateIngredientTagVector(FlatBufferBuilder builder, FlatData.Tag[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateIngredientTagVectorBlock(FlatBufferBuilder builder, FlatData.Tag[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateIngredientTagVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatData.Tag> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateIngredientTagVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatData.Tag>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<FlatData.ShiftingCraftRecipeExcel> EndShiftingCraftRecipeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ShiftingCraftRecipeExcel>(o);
  }
  ...
  public void UnPackTo(ShiftingCraftRecipeExcelT _o) {
    ...
    _o.NotificationId = this.NotificationId;
    _o.ResultParcel = this.ResultParcel;
    _o.ResultId = this.ResultId;
    _o.ResultAmount = this.ResultAmount;
    _o.RequireItemId = this.RequireItemId;
    _o.RequireItemAmount = this.RequireItemAmount;
    _o.RequireGold = this.RequireGold;
    _o.IngredientTag = new List<FlatData.Tag>();
    for (var _j = 0; _j < this.IngredientTagLength; ++_j) {_o.IngredientTag.Add(this.IngredientTag(_j));}
    _o.IngredientExp = this.IngredientExp;
  }
  public static Offset<FlatData.ShiftingCraftRecipeExcel> Pack(FlatBufferBuilder builder, ShiftingCraftRecipeExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ShiftingCraftRecipeExcel>);
...
public class ShiftingCraftRecipeExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("NotificationId")]
  public int NotificationId { get; set; }
  [Newtonsoft.Json.JsonProperty("ResultParcel")]
  public FlatData.ParcelType ResultParcel { get; set; }
  [Newtonsoft.Json.JsonProperty("ResultId")]
  public long ResultId { get; set; }
  [Newtonsoft.Json.JsonProperty("ResultAmount")]
  public long ResultAmount { get; set; }
  [Newtonsoft.Json.JsonProperty("RequireItemId")]
  public long RequireItemId { get; set; }
  [Newtonsoft.Json.JsonProperty("RequireItemAmount")]
  public long RequireItemAmount { get; set; }
  [Newtonsoft.Json.JsonProperty("RequireGold")]
  public long RequireGold { get; set; }
  [Newtonsoft.Json.JsonProperty("IngredientTag")]
  public List<FlatData.Tag> IngredientTag { get; set; }
  [Newtonsoft.Json.JsonProperty("IngredientExp")]
  ...
  public ShiftingCraftRecipeExcelT() {
    ...
    this.ResultParcel = FlatData.ParcelType.None;
    this.ResultId = 0;
    this.ResultAmount = 0;
...
static public class ShiftingCraftRecipeExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*ResultParcel*/, 4 /*FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 22 /*IngredientTag*/, 4 /*FlatData.Tag*/, false)
