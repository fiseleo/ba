...
public struct EventContentSeasonExcel : IFlatbufferObject
{
  ...
  public FlatData.EventContentType EventContentType { get { int o = __p.__offset(12); return o != 0 ? (FlatData.EventContentType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.EventContentType.Stage; } }
  public FlatData.OpenConditionContent OpenConditionContent { get { int o = __p.__offset(14); return o != 0 ? (FlatData.OpenConditionContent)__p.bb.GetInt(o + __p.bb_pos) : FlatData.OpenConditionContent.Shop; } }
  ...
  public FlatData.SubEventType SubEventType { get { int o = __p.__offset(20); return o != 0 ? (FlatData.SubEventType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.SubEventType.None; } }
  ...
  public FlatData.EventContentReleaseType EventContentReleaseType { get { int o = __p.__offset(68); return o != 0 ? (FlatData.EventContentReleaseType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.EventContentReleaseType.None; } }
  public long EventContentStageRewardIdPermanent { get { int o = __p.__offset(70); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public FlatData.RewardTag RewardTagPermanent { get { int o = __p.__offset(72); return o != 0 ? (FlatData.RewardTag)__p.bb.GetInt(o + __p.bb_pos) : FlatData.RewardTag.Default; } }
  public long MiniEventShortCutScenarioModeId { get { int o = __p.__offset(74); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }

  public static Offset<FlatData.EventContentSeasonExcel> CreateEventContentSeasonExcel(FlatBufferBuilder builder,
      ...
      int IconOrder = 0,
      FlatData.SubEventType SubEventType = FlatData.SubEventType.None,
      bool SubEvent = false,
      long EventItemId = 0,
      long MainEventId = 0,
      ...
      FlatData.EventContentReleaseType EventContentReleaseType = FlatData.EventContentReleaseType.None,
      long EventContentStageRewardIdPermanent = 0,
      FlatData.RewardTag RewardTagPermanent = FlatData.RewardTag.Default,
  ...
  public static void AddEventContentType(FlatBufferBuilder builder, FlatData.EventContentType eventContentType) { builder.AddInt(4, (int)eventContentType, 0); }
  public static void AddOpenConditionContent(FlatBufferBuilder builder, FlatData.OpenConditionContent openConditionContent) { builder.AddInt(5, (int)openConditionContent, 0); }
  ...
  public static void AddSubEventType(FlatBufferBuilder builder, FlatData.SubEventType subEventType) { builder.AddInt(8, (int)subEventType, 0); }
  ...
  public static void AddEventContentReleaseType(FlatBufferBuilder builder, FlatData.EventContentReleaseType eventContentReleaseType) { builder.AddInt(32, (int)eventContentReleaseType, 0); }
  ...
  public static void AddRewardTagPermanent(FlatBufferBuilder builder, FlatData.RewardTag rewardTagPermanent) { builder.AddInt(34, (int)rewardTagPermanent, 0); }
  ...
  public static Offset<FlatData.EventContentSeasonExcel> EndEventContentSeasonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentSeasonExcel>(o);
  }
  ...
  public void UnPackTo(EventContentSeasonExcelT _o) {
    ...
    _o.OriginalEventContentId = this.OriginalEventContentId;
    _o.IsReturn = this.IsReturn;
    _o.Name = this.Name;
    _o.EventContentType = this.EventContentType;
    _o.OpenConditionContent = this.OpenConditionContent;
    _o.EventDisplay = this.EventDisplay;
    _o.IconOrder = this.IconOrder;
    _o.SubEventType = this.SubEventType;
    _o.SubEvent = this.SubEvent;
    _o.EventItemId = this.EventItemId;
    _o.MainEventId = this.MainEventId;
    _o.EventChangeOpenCondition = this.EventChangeOpenCondition;
    _o.BeforehandExposedTime = this.BeforehandExposedTime;
    _o.EventContentOpenTime = this.EventContentOpenTime;
    _o.EventContentCloseTime = this.EventContentCloseTime;
    _o.ExtensionTime = this.ExtensionTime;
    _o.MainIconParcelPath = this.MainIconParcelPath;
    _o.SubIconParcelPath = this.SubIconParcelPath;
    _o.BeforehandBgImagePath = this.BeforehandBgImagePath;
    _o.MinigamePrologScenarioGroupId = this.MinigamePrologScenarioGroupId;
    _o.BeforehandScenarioGroupId = new List<long>();
    for (var _j = 0; _j < this.BeforehandScenarioGroupIdLength; ++_j) {_o.BeforehandScenarioGroupId.Add(this.BeforehandScenarioGroupId(_j));}
    _o.MainBannerImagePath = this.MainBannerImagePath;
    _o.MainBgImagePath = this.MainBgImagePath;
    _o.ShiftTriggerStageId = this.ShiftTriggerStageId;
    _o.ShiftMainBgImagePath = this.ShiftMainBgImagePath;
    _o.MinigameLobbyPrefabName = this.MinigameLobbyPrefabName;
    _o.MinigameVictoryPrefabName = this.MinigameVictoryPrefabName;
    _o.MinigameMissionBgPrefabName = this.MinigameMissionBgPrefabName;
    _o.MinigameMissionBgImagePath = this.MinigameMissionBgImagePath;
    _o.CardBgImagePath = this.CardBgImagePath;
    _o.EventAssist = this.EventAssist;
    _o.EventContentReleaseType = this.EventContentReleaseType;
    _o.EventContentStageRewardIdPermanent = this.EventContentStageRewardIdPermanent;
    _o.RewardTagPermanent = this.RewardTagPermanent;
    _o.MiniEventShortCutScenarioModeId = this.MiniEventShortCutScenarioModeId;
  }
  public static Offset<FlatData.EventContentSeasonExcel> Pack(FlatBufferBuilder builder, EventContentSeasonExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EventContentSeasonExcel>);
...
public class EventContentSeasonExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("OriginalEventContentId")]
  public long OriginalEventContentId { get; set; }
  [Newtonsoft.Json.JsonProperty("IsReturn")]
  ...
  [Newtonsoft.Json.JsonProperty("EventDisplay")]
  public bool EventDisplay { get; set; }
  [Newtonsoft.Json.JsonProperty("IconOrder")]
  public int IconOrder { get; set; }
  [Newtonsoft.Json.JsonProperty("SubEventType")]
  public FlatData.SubEventType SubEventType { get; set; }
  [Newtonsoft.Json.JsonProperty("SubEvent")]
  public bool SubEvent { get; set; }
  [Newtonsoft.Json.JsonProperty("EventItemId")]
  public long EventItemId { get; set; }
  [Newtonsoft.Json.JsonProperty("MainEventId")]
  public long MainEventId { get; set; }
  [Newtonsoft.Json.JsonProperty("EventChangeOpenCondition")]
  public long EventChangeOpenCondition { get; set; }
  [Newtonsoft.Json.JsonProperty("BeforehandExposedTime")]
  public string BeforehandExposedTime { get; set; }
  [Newtonsoft.Json.JsonProperty("EventContentOpenTime")]
  public string EventContentOpenTime { get; set; }
  [Newtonsoft.Json.JsonProperty("EventContentCloseTime")]
  public string EventContentCloseTime { get; set; }
  [Newtonsoft.Json.JsonProperty("ExtensionTime")]
  public string ExtensionTime { get; set; }
  [Newtonsoft.Json.JsonProperty("MainIconParcelPath")]
  public string MainIconParcelPath { get; set; }
  [Newtonsoft.Json.JsonProperty("SubIconParcelPath")]
  public string SubIconParcelPath { get; set; }
  [Newtonsoft.Json.JsonProperty("BeforehandBgImagePath")]
  public string BeforehandBgImagePath { get; set; }
  [Newtonsoft.Json.JsonProperty("MinigamePrologScenarioGroupId")]
  public long MinigamePrologScenarioGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("BeforehandScenarioGroupId")]
  public List<long> BeforehandScenarioGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("MainBannerImagePath")]
  public string MainBannerImagePath { get; set; }
  [Newtonsoft.Json.JsonProperty("MainBgImagePath")]
  public string MainBgImagePath { get; set; }
  [Newtonsoft.Json.JsonProperty("ShiftTriggerStageId")]
  public long ShiftTriggerStageId { get; set; }
  [Newtonsoft.Json.JsonProperty("ShiftMainBgImagePath")]
  public string ShiftMainBgImagePath { get; set; }
  [Newtonsoft.Json.JsonProperty("MinigameLobbyPrefabName")]
  public string MinigameLobbyPrefabName { get; set; }
  [Newtonsoft.Json.JsonProperty("MinigameVictoryPrefabName")]
  public string MinigameVictoryPrefabName { get; set; }
  [Newtonsoft.Json.JsonProperty("MinigameMissionBgPrefabName")]
  public string MinigameMissionBgPrefabName { get; set; }
  [Newtonsoft.Json.JsonProperty("MinigameMissionBgImagePath")]
  public string MinigameMissionBgImagePath { get; set; }
  [Newtonsoft.Json.JsonProperty("CardBgImagePath")]
  public string CardBgImagePath { get; set; }
  [Newtonsoft.Json.JsonProperty("EventAssist")]
  public bool EventAssist { get; set; }
  [Newtonsoft.Json.JsonProperty("EventContentReleaseType")]
  public FlatData.EventContentReleaseType EventContentReleaseType { get; set; }
  [Newtonsoft.Json.JsonProperty("EventContentStageRewardIdPermanent")]
  public long EventContentStageRewardIdPermanent { get; set; }
  [Newtonsoft.Json.JsonProperty("RewardTagPermanent")]
  public FlatData.RewardTag RewardTagPermanent { get; set; }
  [Newtonsoft.Json.JsonProperty("MiniEventShortCutScenarioModeId")]
  ...
  public EventContentSeasonExcelT() {
    ...
    this.IconOrder = 0;
    this.SubEventType = FlatData.SubEventType.None;
    this.SubEvent = false;
    this.EventItemId = 0;
    this.MainEventId = 0;
    ...
    this.EventContentReleaseType = FlatData.EventContentReleaseType.None;
    this.EventContentStageRewardIdPermanent = 0;
    this.RewardTagPermanent = FlatData.RewardTag.Default;
...
static public class EventContentSeasonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*EventContentType*/, 4 /*FlatData.EventContentType*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*OpenConditionContent*/, 4 /*FlatData.OpenConditionContent*/, 4, false)
      && verifier.VerifyField(tablePos, 16 /*EventDisplay*/, 1 /*bool*/, 1, false)
      && verifier.VerifyField(tablePos, 18 /*IconOrder*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 20 /*SubEventType*/, 4 /*FlatData.SubEventType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 68 /*EventContentReleaseType*/, 4 /*FlatData.EventContentReleaseType*/, 4, false)
      && verifier.VerifyField(tablePos, 70 /*EventContentStageRewardIdPermanent*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 72 /*RewardTagPermanent*/, 4 /*FlatData.RewardTag*/, 4, false)
