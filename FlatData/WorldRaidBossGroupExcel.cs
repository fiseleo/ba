...
public struct WorldRaidBossGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.WorldRaidBossGroupExcel> CreateWorldRaidBossGroupExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatData.WorldRaidBossGroupExcel> EndWorldRaidBossGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.WorldRaidBossGroupExcel>(o);
  }
  ...
  public void UnPackTo(WorldRaidBossGroupExcelT _o) {
    ...
    _o.WorldBossName = this.WorldBossName;
    _o.WorldBossPopupPortrait = this.WorldBossPopupPortrait;
    _o.WorldBossPopupBG = this.WorldBossPopupBG;
    _o.WorldBossParcelPortrait = this.WorldBossParcelPortrait;
    _o.WorldBossListParcel = this.WorldBossListParcel;
    _o.WorldBossHP = this.WorldBossHP;
    _o.UIHideBeforeSpawn = this.UIHideBeforeSpawn;
    _o.HideAnotherBossKilled = this.HideAnotherBossKilled;
    _o.WorldBossClearRewardGroupId = this.WorldBossClearRewardGroupId;
    _o.AnotherBossKilled = new List<long>();
    for (var _j = 0; _j < this.AnotherBossKilledLength; ++_j) {_o.AnotherBossKilled.Add(this.AnotherBossKilled(_j));}
    _o.EchelonConstraintGroupId = this.EchelonConstraintGroupId;
    _o.ExclusiveOperatorBossSpawn = this.ExclusiveOperatorBossSpawn;
    _o.ExclusiveOperatorBossKill = this.ExclusiveOperatorBossKill;
    _o.ExclusiveOperatorScenarioBattle = this.ExclusiveOperatorScenarioBattle;
    _o.ExclusiveOperatorBossDamaged = this.ExclusiveOperatorBossDamaged;
    _o.BossGroupOpenCondition = this.BossGroupOpenCondition;
  }
  public static Offset<FlatData.WorldRaidBossGroupExcel> Pack(FlatBufferBuilder builder, WorldRaidBossGroupExcelT _o) {
    if (_o == null) return default(Offset<FlatData.WorldRaidBossGroupExcel>);
...
public class WorldRaidBossGroupExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("WorldBossName")]
  public string WorldBossName { get; set; }
  [Newtonsoft.Json.JsonProperty("WorldBossPopupPortrait")]
  public string WorldBossPopupPortrait { get; set; }
  [Newtonsoft.Json.JsonProperty("WorldBossPopupBG")]
  public string WorldBossPopupBG { get; set; }
  [Newtonsoft.Json.JsonProperty("WorldBossParcelPortrait")]
  public string WorldBossParcelPortrait { get; set; }
  [Newtonsoft.Json.JsonProperty("WorldBossListParcel")]
  public string WorldBossListParcel { get; set; }
  [Newtonsoft.Json.JsonProperty("WorldBossHP")]
  public long WorldBossHP { get; set; }
  [Newtonsoft.Json.JsonProperty("UIHideBeforeSpawn")]
  public bool UIHideBeforeSpawn { get; set; }
  [Newtonsoft.Json.JsonProperty("HideAnotherBossKilled")]
  public bool HideAnotherBossKilled { get; set; }
  [Newtonsoft.Json.JsonProperty("WorldBossClearRewardGroupId")]
  public long WorldBossClearRewardGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("AnotherBossKilled")]
  public List<long> AnotherBossKilled { get; set; }
  [Newtonsoft.Json.JsonProperty("EchelonConstraintGroupId")]
  public long EchelonConstraintGroupId { get; set; }
  [Newtonsoft.Json.JsonProperty("ExclusiveOperatorBossSpawn")]
  public string ExclusiveOperatorBossSpawn { get; set; }
  [Newtonsoft.Json.JsonProperty("ExclusiveOperatorBossKill")]
  public string ExclusiveOperatorBossKill { get; set; }
  [Newtonsoft.Json.JsonProperty("ExclusiveOperatorScenarioBattle")]
  public string ExclusiveOperatorScenarioBattle { get; set; }
  [Newtonsoft.Json.JsonProperty("ExclusiveOperatorBossDamaged")]
  public string ExclusiveOperatorBossDamaged { get; set; }
  [Newtonsoft.Json.JsonProperty("BossGroupOpenCondition")]
