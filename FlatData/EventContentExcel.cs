...
public struct EventContentExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.EventContentExcel> CreateEventContentExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatData.EventContentExcel> EndEventContentExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentExcel>(o);
  }
  ...
  public void UnPackTo(EventContentExcelT _o) {
    ...
    _o.BgImagePath = this.BgImagePath;
  }
  public static Offset<FlatData.EventContentExcel> Pack(FlatBufferBuilder builder, EventContentExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EventContentExcel>);
...
public class EventContentExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("BgImagePath")]
