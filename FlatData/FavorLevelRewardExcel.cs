...
public struct FavorLevelRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.FavorLevelRewardExcel> CreateFavorLevelRewardExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
      long FavorLevel = 0,
  ...
  public static Offset<FlatData.FavorLevelRewardExcel> EndFavorLevelRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.FavorLevelRewardExcel>(o);
  }
  ...
  public static Offset<FlatData.FavorLevelRewardExcel> Pack(FlatBufferBuilder builder, FavorLevelRewardExcelT _o) {
    if (_o == null) return default(Offset<FlatData.FavorLevelRewardExcel>);
...
public class FavorLevelRewardExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("FavorLevel")]
