...
public struct ConquestErosionExcel : IFlatbufferObject
{
  ...
  public FlatData.ConquestErosionType ErosionType { get { int o = __p.__offset(8); return o != 0 ? (FlatData.ConquestErosionType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ConquestErosionType.None; } }
  ...
  public FlatData.ConquestConditionType PhaseStartConditionType(int j) { int o = __p.__offset(16); return o != 0 ? (FlatData.ConquestConditionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatData.ConquestConditionType)0; }
  public int PhaseStartConditionTypeLength { get { int o = __p.__offset(16); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatData.ConquestConditionType> GetPhaseStartConditionTypeBytes() { return __p.__vector_as_span<FlatData.ConquestConditionType>(16, 4); }
#else
  public ArraySegment<byte>? GetPhaseStartConditionTypeBytes() { return __p.__vector_as_arraysegment(16); }
#endif
  public FlatData.ConquestConditionType[] GetPhaseStartConditionTypeArray() { int o = __p.__offset(16); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatData.ConquestConditionType[] a = new FlatData.ConquestConditionType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatData.ConquestConditionType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public FlatData.ConquestConditionType PhaseBeforeExposeConditionType(int j) { int o = __p.__offset(20); return o != 0 ? (FlatData.ConquestConditionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatData.ConquestConditionType)0; }
  public int PhaseBeforeExposeConditionTypeLength { get { int o = __p.__offset(20); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatData.ConquestConditionType> GetPhaseBeforeExposeConditionTypeBytes() { return __p.__vector_as_span<FlatData.ConquestConditionType>(20, 4); }
#else
  public ArraySegment<byte>? GetPhaseBeforeExposeConditionTypeBytes() { return __p.__vector_as_arraysegment(20); }
#endif
  public FlatData.ConquestConditionType[] GetPhaseBeforeExposeConditionTypeArray() { int o = __p.__offset(20); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatData.ConquestConditionType[] a = new FlatData.ConquestConditionType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatData.ConquestConditionType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public FlatData.ParcelType ErosionBattleConditionParcelType { get { int o = __p.__offset(24); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ParcelType.None; } }
  ...
  public static Offset<FlatData.ConquestErosionExcel> CreateConquestErosionExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long Id = 0,
      FlatData.ConquestErosionType ErosionType = FlatData.ConquestErosionType.None,
      int Phase = 0,
      ...
      FlatData.ParcelType ErosionBattleConditionParcelType = FlatData.ParcelType.None,
  ...
  public static void AddErosionType(FlatBufferBuilder builder, FlatData.ConquestErosionType erosionType) { builder.AddInt(2, (int)erosionType, 0); }
  ...
  public static VectorOffset CreatePhaseStartConditionTypeVector(FlatBufferBuilder builder, FlatData.ConquestConditionType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreatePhaseStartConditionTypeVectorBlock(FlatBufferBuilder builder, FlatData.ConquestConditionType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreatePhaseStartConditionTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatData.ConquestConditionType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreatePhaseStartConditionTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatData.ConquestConditionType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreatePhaseBeforeExposeConditionTypeVector(FlatBufferBuilder builder, FlatData.ConquestConditionType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreatePhaseBeforeExposeConditionTypeVectorBlock(FlatBufferBuilder builder, FlatData.ConquestConditionType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreatePhaseBeforeExposeConditionTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatData.ConquestConditionType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreatePhaseBeforeExposeConditionTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatData.ConquestConditionType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddErosionBattleConditionParcelType(FlatBufferBuilder builder, FlatData.ParcelType erosionBattleConditionParcelType) { builder.AddInt(10, (int)erosionBattleConditionParcelType, 0); }
  ...
  public static Offset<FlatData.ConquestErosionExcel> EndConquestErosionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ConquestErosionExcel>(o);
  }
  ...
  public void UnPackTo(ConquestErosionExcelT _o) {
    ...
    _o.Id = this.Id;
    _o.ErosionType = this.ErosionType;
    _o.Phase = this.Phase;
    _o.PhaseAlarm = this.PhaseAlarm;
    _o.StepIndex = this.StepIndex;
    _o.PhaseStartConditionType = new List<FlatData.ConquestConditionType>();
    for (var _j = 0; _j < this.PhaseStartConditionTypeLength; ++_j) {_o.PhaseStartConditionType.Add(this.PhaseStartConditionType(_j));}
    _o.PhaseStartConditionParameter = new List<string>();
    for (var _j = 0; _j < this.PhaseStartConditionParameterLength; ++_j) {_o.PhaseStartConditionParameter.Add(this.PhaseStartConditionParameter(_j));}
    _o.PhaseBeforeExposeConditionType = new List<FlatData.ConquestConditionType>();
    for (var _j = 0; _j < this.PhaseBeforeExposeConditionTypeLength; ++_j) {_o.PhaseBeforeExposeConditionType.Add(this.PhaseBeforeExposeConditionType(_j));}
    _o.PhaseBeforeExposeConditionParameter = new List<string>();
    for (var _j = 0; _j < this.PhaseBeforeExposeConditionParameterLength; ++_j) {_o.PhaseBeforeExposeConditionParameter.Add(this.PhaseBeforeExposeConditionParameter(_j));}
    _o.ErosionBattleConditionParcelType = this.ErosionBattleConditionParcelType;
    _o.ErosionBattleConditionParcelUniqueId = this.ErosionBattleConditionParcelUniqueId;
    _o.ErosionBattleConditionParcelAmount = this.ErosionBattleConditionParcelAmount;
    _o.ConquestRewardId = this.ConquestRewardId;
  }
  public static Offset<FlatData.ConquestErosionExcel> Pack(FlatBufferBuilder builder, ConquestErosionExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ConquestErosionExcel>);
...
public class ConquestErosionExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("ErosionType")]
  public FlatData.ConquestErosionType ErosionType { get; set; }
  [Newtonsoft.Json.JsonProperty("Phase")]
  public int Phase { get; set; }
  [Newtonsoft.Json.JsonProperty("PhaseAlarm")]
  public bool PhaseAlarm { get; set; }
  [Newtonsoft.Json.JsonProperty("StepIndex")]
  public int StepIndex { get; set; }
  [Newtonsoft.Json.JsonProperty("PhaseStartConditionType")]
  public List<FlatData.ConquestConditionType> PhaseStartConditionType { get; set; }
  [Newtonsoft.Json.JsonProperty("PhaseStartConditionParameter")]
  public List<string> PhaseStartConditionParameter { get; set; }
  [Newtonsoft.Json.JsonProperty("PhaseBeforeExposeConditionType")]
  public List<FlatData.ConquestConditionType> PhaseBeforeExposeConditionType { get; set; }
  [Newtonsoft.Json.JsonProperty("PhaseBeforeExposeConditionParameter")]
  public List<string> PhaseBeforeExposeConditionParameter { get; set; }
  [Newtonsoft.Json.JsonProperty("ErosionBattleConditionParcelType")]
  public FlatData.ParcelType ErosionBattleConditionParcelType { get; set; }
  [Newtonsoft.Json.JsonProperty("ErosionBattleConditionParcelUniqueId")]
  public long ErosionBattleConditionParcelUniqueId { get; set; }
  [Newtonsoft.Json.JsonProperty("ErosionBattleConditionParcelAmount")]
  ...
  public ConquestErosionExcelT() {
    ...
    this.Id = 0;
    this.ErosionType = FlatData.ConquestErosionType.None;
    this.Phase = 0;
    ...
    this.ErosionBattleConditionParcelType = FlatData.ParcelType.None;
...
static public class ConquestErosionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*ErosionType*/, 4 /*FlatData.ConquestErosionType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 16 /*PhaseStartConditionType*/, 4 /*FlatData.ConquestConditionType*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 18 /*PhaseStartConditionParameter*/, false)
      && verifier.VerifyVectorOfData(tablePos, 20 /*PhaseBeforeExposeConditionType*/, 4 /*FlatData.ConquestConditionType*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 22 /*PhaseBeforeExposeConditionParameter*/, false)
      && verifier.VerifyField(tablePos, 24 /*ErosionBattleConditionParcelType*/, 4 /*FlatData.ParcelType*/, 4, false)
