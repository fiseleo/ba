...
public struct EventContentPlayGuideExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.EventContentPlayGuideExcel> CreateEventContentPlayGuideExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatData.EventContentPlayGuideExcel> EndEventContentPlayGuideExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentPlayGuideExcel>(o);
  }
  ...
  public void UnPackTo(EventContentPlayGuideExcelT _o) {
    ...
    _o.GuideTitle = this.GuideTitle;
    _o.GuideImagePath = this.GuideImagePath;
    _o.GuideText = this.GuideText;
  }
  public static Offset<FlatData.EventContentPlayGuideExcel> Pack(FlatBufferBuilder builder, EventContentPlayGuideExcelT _o) {
    if (_o == null) return default(Offset<FlatData.EventContentPlayGuideExcel>);
...
public class EventContentPlayGuideExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("GuideTitle")]
  public string GuideTitle { get; set; }
  [Newtonsoft.Json.JsonProperty("GuideImagePath")]
  public string GuideImagePath { get; set; }
  [Newtonsoft.Json.JsonProperty("GuideText")]
