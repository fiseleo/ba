...
public struct ConquestErosionUnitExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.ConquestErosionUnitExcel> CreateConquestErosionUnitExcel(FlatBufferBuilder builder,
      long TilePrefabId = 0,
  ...
  public static Offset<FlatData.ConquestErosionUnitExcel> EndConquestErosionUnitExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ConquestErosionUnitExcel>(o);
  }
  ...
  public void UnPackTo(ConquestErosionUnitExcelT _o) {
    _o.TilePrefabId = this.TilePrefabId;
    _o.MassErosionUnitId = this.MassErosionUnitId;
    _o.MassErosionUnitRotationY = this.MassErosionUnitRotationY;
    _o.IndividualErosionUnitId = this.IndividualErosionUnitId;
    _o.IndividualErosionUnitRotationY = this.IndividualErosionUnitRotationY;
  }
  public static Offset<FlatData.ConquestErosionUnitExcel> Pack(FlatBufferBuilder builder, ConquestErosionUnitExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ConquestErosionUnitExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("TilePrefabId")]
  public long TilePrefabId { get; set; }
  [Newtonsoft.Json.JsonProperty("MassErosionUnitId")]
  public long MassErosionUnitId { get; set; }
  [Newtonsoft.Json.JsonProperty("MassErosionUnitRotationY")]
  public float MassErosionUnitRotationY { get; set; }
  [Newtonsoft.Json.JsonProperty("IndividualErosionUnitId")]
  public long IndividualErosionUnitId { get; set; }
  [Newtonsoft.Json.JsonProperty("IndividualErosionUnitRotationY")]
