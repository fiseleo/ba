...
public struct ArenaRewardExcel : IFlatbufferObject
{
  ...
  public FlatData.ArenaRewardType ArenaRewardType { get { int o = __p.__offset(6); return o != 0 ? (FlatData.ArenaRewardType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ArenaRewardType.None; } }
  ...
  public static Offset<FlatData.ArenaRewardExcel> CreateArenaRewardExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      FlatData.ArenaRewardType ArenaRewardType = FlatData.ArenaRewardType.None,
      long RankStart = 0,
      long RankEnd = 0,
  ...
  public static void AddArenaRewardType(FlatBufferBuilder builder, FlatData.ArenaRewardType arenaRewardType) { builder.AddInt(1, (int)arenaRewardType, 0); }
  ...
  public static Offset<FlatData.ArenaRewardExcel> EndArenaRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ArenaRewardExcel>(o);
  }
  ...
  public void UnPackTo(ArenaRewardExcelT _o) {
    ...
    _o.ArenaRewardType = this.ArenaRewardType;
    _o.RankStart = this.RankStart;
    _o.RankEnd = this.RankEnd;
    _o.RankIconPath = this.RankIconPath;
  ...
  public static Offset<FlatData.ArenaRewardExcel> Pack(FlatBufferBuilder builder, ArenaRewardExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ArenaRewardExcel>);
...
public class ArenaRewardExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("ArenaRewardType")]
  public FlatData.ArenaRewardType ArenaRewardType { get; set; }
  ...
  [Newtonsoft.Json.JsonProperty("RankIconPath")]
  ...
  public ArenaRewardExcelT() {
    this.UniqueId = 0;
    this.ArenaRewardType = FlatData.ArenaRewardType.None;
    this.RankStart = 0;
    this.RankEnd = 0;
...
static public class ArenaRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ArenaRewardType*/, 4 /*FlatData.ArenaRewardType*/, 4, false)
