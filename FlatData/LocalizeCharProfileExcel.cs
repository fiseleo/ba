...
public struct LocalizeCharProfileExcel : IFlatbufferObject
{
  ...
  public void UnPackTo(LocalizeCharProfileExcelT _o) {
    ...
    _o.StatusMessageKr = this.StatusMessageKr;
    _o.StatusMessageJp = this.StatusMessageJp;
    _o.FullNameKr = this.FullNameKr;
    _o.FullNameJp = this.FullNameJp;
    _o.FamilyNameKr = this.FamilyNameKr;
    _o.FamilyNameRubyKr = this.FamilyNameRubyKr;
    _o.PersonalNameKr = this.PersonalNameKr;
    _o.PersonalNameRubyKr = this.PersonalNameRubyKr;
    _o.FamilyNameJp = this.FamilyNameJp;
    _o.FamilyNameRubyJp = this.FamilyNameRubyJp;
    _o.PersonalNameJp = this.PersonalNameJp;
    _o.PersonalNameRubyJp = this.PersonalNameRubyJp;
    _o.SchoolYearKr = this.SchoolYearKr;
    _o.SchoolYearJp = this.SchoolYearJp;
    _o.CharacterAgeKr = this.CharacterAgeKr;
    _o.CharacterAgeJp = this.CharacterAgeJp;
    _o.BirthDay = this.BirthDay;
    _o.BirthdayKr = this.BirthdayKr;
    _o.BirthdayJp = this.BirthdayJp;
    _o.CharHeightKr = this.CharHeightKr;
    _o.CharHeightJp = this.CharHeightJp;
    _o.DesignerNameKr = this.DesignerNameKr;
    _o.DesignerNameJp = this.DesignerNameJp;
    _o.IllustratorNameKr = this.IllustratorNameKr;
    _o.IllustratorNameJp = this.IllustratorNameJp;
    _o.CharacterVoiceKr = this.CharacterVoiceKr;
    _o.CharacterVoiceJp = this.CharacterVoiceJp;
    _o.HobbyKr = this.HobbyKr;
    _o.HobbyJp = this.HobbyJp;
    _o.WeaponNameKr = this.WeaponNameKr;
    _o.WeaponDescKr = this.WeaponDescKr;
    _o.WeaponNameJp = this.WeaponNameJp;
    _o.WeaponDescJp = this.WeaponDescJp;
    _o.ProfileIntroductionKr = this.ProfileIntroductionKr;
    _o.ProfileIntroductionJp = this.ProfileIntroductionJp;
    _o.CharacterSSRNewKr = this.CharacterSSRNewKr;
    _o.CharacterSSRNewJp = this.CharacterSSRNewJp;
  }
  public static Offset<FlatData.LocalizeCharProfileExcel> Pack(FlatBufferBuilder builder, LocalizeCharProfileExcelT _o) {
    if (_o == null) return default(Offset<FlatData.LocalizeCharProfileExcel>);
...
public class LocalizeCharProfileExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("StatusMessageKr")]
  public string StatusMessageKr { get; set; }
  [Newtonsoft.Json.JsonProperty("StatusMessageJp")]
  public string StatusMessageJp { get; set; }
  [Newtonsoft.Json.JsonProperty("FullNameKr")]
  public string FullNameKr { get; set; }
  [Newtonsoft.Json.JsonProperty("FullNameJp")]
  public string FullNameJp { get; set; }
  [Newtonsoft.Json.JsonProperty("FamilyNameKr")]
  public string FamilyNameKr { get; set; }
  [Newtonsoft.Json.JsonProperty("FamilyNameRubyKr")]
  public string FamilyNameRubyKr { get; set; }
  [Newtonsoft.Json.JsonProperty("PersonalNameKr")]
  public string PersonalNameKr { get; set; }
  [Newtonsoft.Json.JsonProperty("PersonalNameRubyKr")]
  public string PersonalNameRubyKr { get; set; }
  [Newtonsoft.Json.JsonProperty("FamilyNameJp")]
  public string FamilyNameJp { get; set; }
  [Newtonsoft.Json.JsonProperty("FamilyNameRubyJp")]
  public string FamilyNameRubyJp { get; set; }
  [Newtonsoft.Json.JsonProperty("PersonalNameJp")]
  public string PersonalNameJp { get; set; }
  [Newtonsoft.Json.JsonProperty("PersonalNameRubyJp")]
  public string PersonalNameRubyJp { get; set; }
  [Newtonsoft.Json.JsonProperty("SchoolYearKr")]
  public string SchoolYearKr { get; set; }
  [Newtonsoft.Json.JsonProperty("SchoolYearJp")]
  public string SchoolYearJp { get; set; }
  [Newtonsoft.Json.JsonProperty("CharacterAgeKr")]
  public string CharacterAgeKr { get; set; }
  [Newtonsoft.Json.JsonProperty("CharacterAgeJp")]
  public string CharacterAgeJp { get; set; }
  [Newtonsoft.Json.JsonProperty("BirthDay")]
  public string BirthDay { get; set; }
  [Newtonsoft.Json.JsonProperty("BirthdayKr")]
  public string BirthdayKr { get; set; }
  [Newtonsoft.Json.JsonProperty("BirthdayJp")]
  public string BirthdayJp { get; set; }
  [Newtonsoft.Json.JsonProperty("CharHeightKr")]
  public string CharHeightKr { get; set; }
  [Newtonsoft.Json.JsonProperty("CharHeightJp")]
  public string CharHeightJp { get; set; }
  [Newtonsoft.Json.JsonProperty("DesignerNameKr")]
  public string DesignerNameKr { get; set; }
  [Newtonsoft.Json.JsonProperty("DesignerNameJp")]
  public string DesignerNameJp { get; set; }
  [Newtonsoft.Json.JsonProperty("IllustratorNameKr")]
  public string IllustratorNameKr { get; set; }
  [Newtonsoft.Json.JsonProperty("IllustratorNameJp")]
  public string IllustratorNameJp { get; set; }
  [Newtonsoft.Json.JsonProperty("CharacterVoiceKr")]
  public string CharacterVoiceKr { get; set; }
  [Newtonsoft.Json.JsonProperty("CharacterVoiceJp")]
  public string CharacterVoiceJp { get; set; }
  [Newtonsoft.Json.JsonProperty("HobbyKr")]
  public string HobbyKr { get; set; }
  [Newtonsoft.Json.JsonProperty("HobbyJp")]
  public string HobbyJp { get; set; }
  [Newtonsoft.Json.JsonProperty("WeaponNameKr")]
  public string WeaponNameKr { get; set; }
  [Newtonsoft.Json.JsonProperty("WeaponDescKr")]
  public string WeaponDescKr { get; set; }
  [Newtonsoft.Json.JsonProperty("WeaponNameJp")]
  public string WeaponNameJp { get; set; }
  [Newtonsoft.Json.JsonProperty("WeaponDescJp")]
  public string WeaponDescJp { get; set; }
  [Newtonsoft.Json.JsonProperty("ProfileIntroductionKr")]
  public string ProfileIntroductionKr { get; set; }
  [Newtonsoft.Json.JsonProperty("ProfileIntroductionJp")]
  public string ProfileIntroductionJp { get; set; }
  [Newtonsoft.Json.JsonProperty("CharacterSSRNewKr")]
  public string CharacterSSRNewKr { get; set; }
  [Newtonsoft.Json.JsonProperty("CharacterSSRNewJp")]
