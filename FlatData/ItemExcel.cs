...
public struct ItemExcel : IFlatbufferObject
{
  ...
  public FlatData.ItemCategory ItemCategory { get { int o = __p.__offset(14); return o != 0 ? (FlatData.ItemCategory)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ItemCategory.Coin; } }
  ...
  public FlatData.ParcelType UsingResultParcelType { get { int o = __p.__offset(28); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ParcelType.None; } }
  ...
  public FlatData.ParcelType ExpiryChangeParcelType { get { int o = __p.__offset(36); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ParcelType.None; } }
  ...
  public FlatData.Tag Tags(int j) { int o = __p.__offset(46); return o != 0 ? (FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatData.Tag)0; }
  public int TagsLength { get { int o = __p.__offset(46); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatData.Tag> GetTagsBytes() { return __p.__vector_as_span<FlatData.Tag>(46, 4); }
#else
  public ArraySegment<byte>? GetTagsBytes() { return __p.__vector_as_arraysegment(46); }
#endif
  public FlatData.Tag[] GetTagsArray() { int o = __p.__offset(46); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatData.Tag[] a = new FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public FlatData.ShopCategoryType ShopCategory(int j) { int o = __p.__offset(58); return o != 0 ? (FlatData.ShopCategoryType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatData.ShopCategoryType)0; }
  public int ShopCategoryLength { get { int o = __p.__offset(58); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatData.ShopCategoryType> GetShopCategoryBytes() { return __p.__vector_as_span<FlatData.ShopCategoryType>(58, 4); }
#else
  public ArraySegment<byte>? GetShopCategoryBytes() { return __p.__vector_as_arraysegment(58); }
#endif
  public FlatData.ShopCategoryType[] GetShopCategoryArray() { int o = __p.__offset(58); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatData.ShopCategoryType[] a = new FlatData.ShopCategoryType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatData.ShopCategoryType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public FlatData.GachaTicketType GachaTicket { get { int o = __p.__offset(66); return o != 0 ? (FlatData.GachaTicketType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.GachaTicketType.None; } }

  public static Offset<FlatData.ItemExcel> CreateItemExcel(FlatBufferBuilder builder,
      long Id = 0,
      long GroupId = 0,
      FlatData.Rarity Rarity = FlatData.Rarity.N,
      FlatData.ProductionStep ProductionStep = FlatData.ProductionStep.ToDo,
      uint LocalizeEtcId = 0,
      FlatData.ItemCategory ItemCategory = FlatData.ItemCategory.Coin,
      long Quality = 0,
      ...
      FlatData.ParcelType UsingResultParcelType = FlatData.ParcelType.None,
      ...
      FlatData.GachaTicketType GachaTicket = FlatData.GachaTicketType.None) {
  ...
  public static void AddItemCategory(FlatBufferBuilder builder, FlatData.ItemCategory itemCategory) { builder.AddInt(5, (int)itemCategory, 0); }
  ...
  public static void AddUsingResultParcelType(FlatBufferBuilder builder, FlatData.ParcelType usingResultParcelType) { builder.AddInt(12, (int)usingResultParcelType, 0); }
  ...
  public static void AddExpiryChangeParcelType(FlatBufferBuilder builder, FlatData.ParcelType expiryChangeParcelType) { builder.AddInt(16, (int)expiryChangeParcelType, 0); }
  ...
  public static void AddGachaTicket(FlatBufferBuilder builder, FlatData.GachaTicketType gachaTicket) { builder.AddInt(31, (int)gachaTicket, 0); }
  public static Offset<FlatData.ItemExcel> EndItemExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ItemExcel>(o);
  }
  ...
  public void UnPackTo(ItemExcelT _o) {
    ...
    _o.ItemCategory = this.ItemCategory;
    _o.Quality = this.Quality;
    _o.Icon = this.Icon;
    _o.SpriteName = this.SpriteName;
    _o.StackableMax = this.StackableMax;
    _o.StackableFunction = this.StackableFunction;
    _o.ImmediateUse = this.ImmediateUse;
    _o.UsingResultParcelType = this.UsingResultParcelType;
    _o.UsingResultId = this.UsingResultId;
    _o.UsingResultAmount = this.UsingResultAmount;
    _o.MailType = this.MailType;
    _o.ExpiryChangeParcelType = this.ExpiryChangeParcelType;
    _o.ExpiryChangeId = this.ExpiryChangeId;
    _o.ExpiryChangeAmount = this.ExpiryChangeAmount;
    _o.CanTierUpgrade = this.CanTierUpgrade;
    _o.TierUpgradeRecipeCraftId = this.TierUpgradeRecipeCraftId;
    ...
    _o.MaxGiftTags = this.MaxGiftTags;
    ...
    _o.ExpirationDateTime = this.ExpirationDateTime;
    _o.ExpirationNotifyDateIn = this.ExpirationNotifyDateIn;
    _o.ShortcutTypeId = this.ShortcutTypeId;
    _o.GachaTicket = this.GachaTicket;
  }
  public static Offset<FlatData.ItemExcel> Pack(FlatBufferBuilder builder, ItemExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ItemExcel>);
...
public class ItemExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("ItemCategory")]
  public FlatData.ItemCategory ItemCategory { get; set; }
  ...
  [Newtonsoft.Json.JsonProperty("StackableFunction")]
  public int StackableFunction { get; set; }
  [Newtonsoft.Json.JsonProperty("ImmediateUse")]
  public bool ImmediateUse { get; set; }
  [Newtonsoft.Json.JsonProperty("UsingResultParcelType")]
  public FlatData.ParcelType UsingResultParcelType { get; set; }
  [Newtonsoft.Json.JsonProperty("UsingResultId")]
  public long UsingResultId { get; set; }
  [Newtonsoft.Json.JsonProperty("UsingResultAmount")]
  public long UsingResultAmount { get; set; }
  [Newtonsoft.Json.JsonProperty("MailType")]
  public FlatData.MailType MailType { get; set; }
  [Newtonsoft.Json.JsonProperty("ExpiryChangeParcelType")]
  public FlatData.ParcelType ExpiryChangeParcelType { get; set; }
  [Newtonsoft.Json.JsonProperty("ExpiryChangeId")]
  public long ExpiryChangeId { get; set; }
  [Newtonsoft.Json.JsonProperty("ExpiryChangeAmount")]
  public long ExpiryChangeAmount { get; set; }
  [Newtonsoft.Json.JsonProperty("CanTierUpgrade")]
  public bool CanTierUpgrade { get; set; }
  [Newtonsoft.Json.JsonProperty("TierUpgradeRecipeCraftId")]
  ...
  [Newtonsoft.Json.JsonProperty("MaxGiftTags")]
  ...
  [Newtonsoft.Json.JsonProperty("ExpirationNotifyDateIn")]
  public int ExpirationNotifyDateIn { get; set; }
  [Newtonsoft.Json.JsonProperty("ShortcutTypeId")]
  public long ShortcutTypeId { get; set; }
  [Newtonsoft.Json.JsonProperty("GachaTicket")]
  public FlatData.GachaTicketType GachaTicket { get; set; }
  ...
  public ItemExcelT() {
    ...
    this.ItemCategory = FlatData.ItemCategory.Coin;
    this.Quality = 0;
    this.Icon = null;
    ...
    this.UsingResultParcelType = FlatData.ParcelType.None;
    this.UsingResultId = 0;
    this.UsingResultAmount = 0;
    this.MailType = FlatData.MailType.System;
    this.ExpiryChangeParcelType = FlatData.ParcelType.None;
    ...
    this.GachaTicket = FlatData.GachaTicketType.None;
  }
}
...
static public class ItemExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*ItemCategory*/, 4 /*FlatData.ItemCategory*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 28 /*UsingResultParcelType*/, 4 /*FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 36 /*ExpiryChangeParcelType*/, 4 /*FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 46 /*Tags*/, 4 /*FlatData.Tag*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 58 /*ShopCategory*/, 4 /*FlatData.ShopCategoryType*/, false)
      ...
      && verifier.VerifyField(tablePos, 66 /*GachaTicket*/, 4 /*FlatData.GachaTicketType*/, 4, false)
