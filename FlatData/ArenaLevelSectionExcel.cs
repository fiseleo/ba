...
public struct ArenaLevelSectionExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.ArenaLevelSectionExcel> CreateArenaLevelSectionExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.ArenaLevelSectionExcel> EndArenaLevelSectionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ArenaLevelSectionExcel>(o);
  }
  ...
  public void UnPackTo(ArenaLevelSectionExcelT _o) {
    _o.ArenaSeasonId = this.ArenaSeasonId;
    _o.StartLevel = this.StartLevel;
    _o.LastLevel = this.LastLevel;
    _o.UserCount = this.UserCount;
  }
  public static Offset<FlatData.ArenaLevelSectionExcel> Pack(FlatBufferBuilder builder, ArenaLevelSectionExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ArenaLevelSectionExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("ArenaSeasonId")]
  public long ArenaSeasonId { get; set; }
  [Newtonsoft.Json.JsonProperty("StartLevel")]
  public long StartLevel { get; set; }
  [Newtonsoft.Json.JsonProperty("LastLevel")]
  public long LastLevel { get; set; }
  [Newtonsoft.Json.JsonProperty("UserCount")]
