...
public struct CharacterWeaponExpBonusExcel : IFlatbufferObject
{
  ...
  public FlatData.WeaponType WeaponType { get { int o = __p.__offset(4); return o != 0 ? (FlatData.WeaponType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.WeaponType.None; } }
  ...
  public static Offset<FlatData.CharacterWeaponExpBonusExcel> CreateCharacterWeaponExpBonusExcel(FlatBufferBuilder builder,
  ...
  public static void AddWeaponType(FlatBufferBuilder builder, FlatData.WeaponType weaponType) { builder.AddInt(0, (int)weaponType, 0); }
  ...
  public static Offset<FlatData.CharacterWeaponExpBonusExcel> EndCharacterWeaponExpBonusExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.CharacterWeaponExpBonusExcel>(o);
  }
  ...
  public void UnPackTo(CharacterWeaponExpBonusExcelT _o) {
    ...
    _o.WeaponExpGrowthA = this.WeaponExpGrowthA;
    _o.WeaponExpGrowthB = this.WeaponExpGrowthB;
    _o.WeaponExpGrowthC = this.WeaponExpGrowthC;
    _o.WeaponExpGrowthZ = this.WeaponExpGrowthZ;
  }
  public static Offset<FlatData.CharacterWeaponExpBonusExcel> Pack(FlatBufferBuilder builder, CharacterWeaponExpBonusExcelT _o) {
    if (_o == null) return default(Offset<FlatData.CharacterWeaponExpBonusExcel>);
...
public class CharacterWeaponExpBonusExcelT
{
  ...
  [Newtonsoft.Json.JsonProperty("WeaponExpGrowthA")]
  public int WeaponExpGrowthA { get; set; }
  [Newtonsoft.Json.JsonProperty("WeaponExpGrowthB")]
  public int WeaponExpGrowthB { get; set; }
  [Newtonsoft.Json.JsonProperty("WeaponExpGrowthC")]
  public int WeaponExpGrowthC { get; set; }
  [Newtonsoft.Json.JsonProperty("WeaponExpGrowthZ")]
...
static public class CharacterWeaponExpBonusExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*WeaponType*/, 4 /*FlatData.WeaponType*/, 4, false)
