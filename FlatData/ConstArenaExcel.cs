...
public struct ConstArenaExcel : IFlatbufferObject
{
  ...
  public FlatData.ParcelType EnterCostType { get { int o = __p.__offset(16); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ParcelType.None; } }
  ...
  public FlatData.StatType ModifiedStatType(int j) { int o = __p.__offset(34); return o != 0 ? (FlatData.StatType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatData.StatType)0; }
  public int ModifiedStatTypeLength { get { int o = __p.__offset(34); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatData.StatType> GetModifiedStatTypeBytes() { return __p.__vector_as_span<FlatData.StatType>(34, 4); }
#else
  public ArraySegment<byte>? GetModifiedStatTypeBytes() { return __p.__vector_as_arraysegment(34); }
#endif
  public FlatData.StatType[] GetModifiedStatTypeArray() { int o = __p.__offset(34); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatData.StatType[] a = new FlatData.StatType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatData.StatType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<FlatData.ConstArenaExcel> CreateConstArenaExcel(FlatBufferBuilder builder,
      ...
      FlatData.ParcelType EnterCostType = FlatData.ParcelType.None,
      long EnterCostId = 0,
      long TicketCost = 0,
  ...
  public static void AddEnterCostType(FlatBufferBuilder builder, FlatData.ParcelType enterCostType) { builder.AddInt(6, (int)enterCostType, 0); }
  ...
  public static VectorOffset CreateModifiedStatTypeVector(FlatBufferBuilder builder, FlatData.StatType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateModifiedStatTypeVectorBlock(FlatBufferBuilder builder, FlatData.StatType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateModifiedStatTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatData.StatType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateModifiedStatTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatData.StatType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<FlatData.ConstArenaExcel> EndConstArenaExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ConstArenaExcel>(o);
  }
  ...
  public void UnPackTo(ConstArenaExcelT _o) {
    _o.AttackCoolTime = this.AttackCoolTime;
    _o.BattleDuration = this.BattleDuration;
    _o.DefenseCoolTime = this.DefenseCoolTime;
    _o.TSSStartCoolTime = this.TSSStartCoolTime;
    _o.EndAlarm = this.EndAlarm;
    _o.TimeRewardMaxAmount = this.TimeRewardMaxAmount;
    _o.EnterCostType = this.EnterCostType;
    _o.EnterCostId = this.EnterCostId;
    _o.TicketCost = this.TicketCost;
    _o.DailyRewardResetTime = this.DailyRewardResetTime;
    _o.OpenScenarioId = this.OpenScenarioId;
    _o.CharacterSlotHideRank = new List<long>();
    for (var _j = 0; _j < this.CharacterSlotHideRankLength; ++_j) {_o.CharacterSlotHideRank.Add(this.CharacterSlotHideRank(_j));}
    _o.MapSlotHideRank = this.MapSlotHideRank;
    _o.RelativeOpponentRankStart = new List<long>();
    for (var _j = 0; _j < this.RelativeOpponentRankStartLength; ++_j) {_o.RelativeOpponentRankStart.Add(this.RelativeOpponentRankStart(_j));}
    _o.RelativeOpponentRankEnd = new List<long>();
    for (var _j = 0; _j < this.RelativeOpponentRankEndLength; ++_j) {_o.RelativeOpponentRankEnd.Add(this.RelativeOpponentRankEnd(_j));}
    _o.ModifiedStatType = new List<FlatData.StatType>();
    for (var _j = 0; _j < this.ModifiedStatTypeLength; ++_j) {_o.ModifiedStatType.Add(this.ModifiedStatType(_j));}
    _o.StatMulFactor = new List<long>();
    for (var _j = 0; _j < this.StatMulFactorLength; ++_j) {_o.StatMulFactor.Add(this.StatMulFactor(_j));}
    _o.StatSumFactor = new List<long>();
    for (var _j = 0; _j < this.StatSumFactorLength; ++_j) {_o.StatSumFactor.Add(this.StatSumFactor(_j));}
    _o.NPCName = new List<string>();
    for (var _j = 0; _j < this.NPCNameLength; ++_j) {_o.NPCName.Add(this.NPCName(_j));}
    _o.NPCMainCharacterCount = this.NPCMainCharacterCount;
    _o.NPCSupportCharacterCount = this.NPCSupportCharacterCount;
    _o.NPCCharacterSkillLevel = this.NPCCharacterSkillLevel;
    _o.TimeSpanInDaysForBattleHistory = this.TimeSpanInDaysForBattleHistory;
    _o.HiddenCharacterImagePath = this.HiddenCharacterImagePath;
    _o.DefenseVictoryRewardMaxCount = this.DefenseVictoryRewardMaxCount;
    _o.TopRankerCountLimit = this.TopRankerCountLimit;
    _o.AutoRefreshIntervalMilliSeconds = this.AutoRefreshIntervalMilliSeconds;
    _o.EchelonSettingIntervalMilliSeconds = this.EchelonSettingIntervalMilliSeconds;
    _o.SkipAllowedTimeMilliSeconds = this.SkipAllowedTimeMilliSeconds;
    _o.ShowSeasonChangeInfoStartTime = this.ShowSeasonChangeInfoStartTime;
    _o.ShowSeasonChangeInfoEndTime = this.ShowSeasonChangeInfoEndTime;
    _o.ShowSeasonId = this.ShowSeasonId;
  }
  public static Offset<FlatData.ConstArenaExcel> Pack(FlatBufferBuilder builder, ConstArenaExcelT _o) {
    if (_o == null) return default(Offset<FlatData.ConstArenaExcel>);
...
{
  [Newtonsoft.Json.JsonProperty("AttackCoolTime")]
  public long AttackCoolTime { get; set; }
  [Newtonsoft.Json.JsonProperty("BattleDuration")]
  public long BattleDuration { get; set; }
  [Newtonsoft.Json.JsonProperty("DefenseCoolTime")]
  public long DefenseCoolTime { get; set; }
  [Newtonsoft.Json.JsonProperty("TSSStartCoolTime")]
  public long TSSStartCoolTime { get; set; }
  [Newtonsoft.Json.JsonProperty("EndAlarm")]
  public long EndAlarm { get; set; }
  [Newtonsoft.Json.JsonProperty("TimeRewardMaxAmount")]
  public long TimeRewardMaxAmount { get; set; }
  [Newtonsoft.Json.JsonProperty("EnterCostType")]
  public FlatData.ParcelType EnterCostType { get; set; }
  [Newtonsoft.Json.JsonProperty("EnterCostId")]
  public long EnterCostId { get; set; }
  [Newtonsoft.Json.JsonProperty("TicketCost")]
  public long TicketCost { get; set; }
  [Newtonsoft.Json.JsonProperty("DailyRewardResetTime")]
  public string DailyRewardResetTime { get; set; }
  [Newtonsoft.Json.JsonProperty("OpenScenarioId")]
  public string OpenScenarioId { get; set; }
  [Newtonsoft.Json.JsonProperty("CharacterSlotHideRank")]
  public List<long> CharacterSlotHideRank { get; set; }
  [Newtonsoft.Json.JsonProperty("MapSlotHideRank")]
  public long MapSlotHideRank { get; set; }
  [Newtonsoft.Json.JsonProperty("RelativeOpponentRankStart")]
  public List<long> RelativeOpponentRankStart { get; set; }
  [Newtonsoft.Json.JsonProperty("RelativeOpponentRankEnd")]
  public List<long> RelativeOpponentRankEnd { get; set; }
  [Newtonsoft.Json.JsonProperty("ModifiedStatType")]
  public List<FlatData.StatType> ModifiedStatType { get; set; }
  [Newtonsoft.Json.JsonProperty("StatMulFactor")]
  public List<long> StatMulFactor { get; set; }
  [Newtonsoft.Json.JsonProperty("StatSumFactor")]
  public List<long> StatSumFactor { get; set; }
  [Newtonsoft.Json.JsonProperty("NPCName")]
  public List<string> NPCName { get; set; }
  [Newtonsoft.Json.JsonProperty("NPCMainCharacterCount")]
  public long NPCMainCharacterCount { get; set; }
  [Newtonsoft.Json.JsonProperty("NPCSupportCharacterCount")]
  public long NPCSupportCharacterCount { get; set; }
  [Newtonsoft.Json.JsonProperty("NPCCharacterSkillLevel")]
  public long NPCCharacterSkillLevel { get; set; }
  [Newtonsoft.Json.JsonProperty("TimeSpanInDaysForBattleHistory")]
  public long TimeSpanInDaysForBattleHistory { get; set; }
  [Newtonsoft.Json.JsonProperty("HiddenCharacterImagePath")]
  public string HiddenCharacterImagePath { get; set; }
  [Newtonsoft.Json.JsonProperty("DefenseVictoryRewardMaxCount")]
  public long DefenseVictoryRewardMaxCount { get; set; }
  [Newtonsoft.Json.JsonProperty("TopRankerCountLimit")]
  public long TopRankerCountLimit { get; set; }
  [Newtonsoft.Json.JsonProperty("AutoRefreshIntervalMilliSeconds")]
  public long AutoRefreshIntervalMilliSeconds { get; set; }
  [Newtonsoft.Json.JsonProperty("EchelonSettingIntervalMilliSeconds")]
  public long EchelonSettingIntervalMilliSeconds { get; set; }
  [Newtonsoft.Json.JsonProperty("SkipAllowedTimeMilliSeconds")]
  public long SkipAllowedTimeMilliSeconds { get; set; }
  [Newtonsoft.Json.JsonProperty("ShowSeasonChangeInfoStartTime")]
  public string ShowSeasonChangeInfoStartTime { get; set; }
  [Newtonsoft.Json.JsonProperty("ShowSeasonChangeInfoEndTime")]
  public string ShowSeasonChangeInfoEndTime { get; set; }
  [Newtonsoft.Json.JsonProperty("ShowSeasonId")]
  ...
  public ConstArenaExcelT() {
    ...
    this.EnterCostType = FlatData.ParcelType.None;
    this.EnterCostId = 0;
    this.TicketCost = 0;
...
static public class ConstArenaExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*EnterCostType*/, 4 /*FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 34 /*ModifiedStatType*/, 4 /*FlatData.StatType*/, false)
